(function(B) {
    ...
    B.register("module", ["private", "modules.renderer.js-charts", function() {
        ...
        B.register("module", ["private", "modules.renderer.js-bar2d", function() {
            var a = this.hcLib,
                b = a.chartAPI,
        ...
        B.register("module", ["private", "modules.renderer.js-pareto2d", function() {
            ...
            m("pareto2d", {
                ...
                _createDatasets: function() {
                    ...
                    if (l) {
                        for (q = 0; q < f; q++)
                            k = l[q], t = x.getCleanValue(k.value), null !== t && "true" !== k.vline && !0 !== k.vline && 1 !== k.vline && "1" !== k.vline && L.push(k);
                        ...
                        l.chart = this;
                        l.init();
                        if (f = h ? B.get("component", ["dataset", "Column3d"]) : B.get("component", ["dataset", "Column"]))
                            (h = x[0]) ? (y = L.length, l = h.components.data.length, y < l && h.removeData(y, l - y), h.JSONData = {
                                data: L
                            }, b.configure.call(h)) : (h = new f, x.push(h), h.chart = this, h.index = q, l && l.addDataSet(h, 0, 0), b.init(h, L, y));
                        a = a.yAxis[1];
                        if (G)
                            a && a.setAxisConfig({
                                drawLabels: !0,
                                ...
                                drawTrendLines: !0,
                                drawTrendLabels: !0
                            }), a.show(), f = B.get("component", ["dataset", "line"]), (h = x[1]) ? (y = L.length, l = h.components.data.length, y < l && h.removeData(y, l - y), h.JSONData = {
                                data: L
                            }, b.configure.call(h)) : (h = new f, x.push(h), h.chart = this, h.index = q, b.init(h, L, "line"));
                        else {
                            if (h = x[1])
                                K.call(h), x.pop();
                            a && (a.setAxisConfig({
                ...
                _setCategories: function() {
                    ...
                    for (q = 0; q < f; q++) {
                        ...
                        if ("true" === l.vline || "1" === l.vline || 1 === l.vline || !0 === l.vline)
                            y[G] = l;
                        else if (null === L)
                            continue;
                        else
        ...
        B.register("module", ["private", "modules.renderer.js-pie2d", function() {
            ...
            B("pie2d", {
                ...
                _plotDragMove: function(f, r) {
                    ...
                    isNaN(e) || isNaN(c) || !T.enableRotation || g.singletonCase || g.isRightClicked || (e = xa.call(f, d, n, g.pieCenter, g.chartPosition, 1), g.isRotating || (g.dragStartAngle !== e && (g.isRotating = !0), a.raiseEvent("RotationStart", {
                        startingAngle: g._rotationalStartAngle = ga._startingAngle()
                    }, ga.chartInstance)), T.startAngle += e - g.dragStartAngle, g.dragStartAngle = e, g.moveDuration = 0, T.updateInited || (T.updateInited = !0, setTimeout(ga._batchRotate || (ga._batchRotate = function() {
                        ga._rotate();
                        T.updateInited = !1
                    }), 50)))
                },
                _plotDragStart: function(a, r) {
                    ...
                    if (g.enableRotation && !d.isRightClicked) {
                        ...
                        if (g.getBoundingClientRect)
                            g = g.getBoundingClientRect(), n.top = g.top + (C.pageYOffset || p.scrollTop || 0) - (p.clientTop || 0), n.left = g.left + (C.pageXOffset || p.scrollLeft || 0) - (p.clientLeft || 0);
                        else
                            for (; g;)
                                n.left += g.offsetLeft || 0, n.top += g.offsetTop || 0, g !== p.body && g !== p.documentElement && (n.left -= g.scrollLeft || 0, n.top -= g.scrollTop || 0), g = g.offsetParent;
                        d.chartPosition = n;
                ...
                _plotDragEnd: function(f) {
                    var r,
                        e = this.data("plotItem"),
                        c = e.chart,
                        d = c.config,
                        n = d.linkedChartOpened,
                        g = e.seriesData;
                    g.isRightClicked || (d.clicked = !0, c.disposed || n || c._rotate(), !g.isRotating && c._plotGraphicClick.call(e.graphic, f), delete d.clicked, g.isRotating && (setTimeout(function() {
                        g.isRotating = !1
                ...
                _plotRollOver: function(a) {
                    ...
                    c.isHovered = !0;
                    (a = r.innerDiameter) && (d = r.centerLabelConfig) && (n = d.label) && e.drawDoughnutCenterLabel(n, r.center[0], r.center[1], a, a, d, !1)
                },
                ...
                _rotate: function() {
                    ...
                    for (u = 0; u < d.length; u += 1)
                        F = d[u].config, f = d[u].graphics, a = F.y, null !== a && void 0 !== a && (ca = S, S -= e.singletonCase ? ba : a * ga, a = .5 * (S + ca), F.angle = a, F.transX = E(a) * g, F.transY = t(a) * g, F.slicedTranslation = "t" + E(a) * g + qa + t(a) * g, (r = F._rotateAttrs) || (r = F._rotateAttrs = {
                            ringpath: [],
                            transform: K
                ...
                getPlotData: function(a, r) {
                    ...
                    if (e[a])
                        ...
                        e = e[a] = {};
                        for (n in c)
                            "object" !== typeof (d = c[n]) && "function" !== typeof d && 0 !== n.indexOf("_") && (e[n] = d);
                        e.value = e.y;
                ...
                _plotGraphicClick: function(f) {
                    ...
                    if (!(w.isRotating || w.singletonCase || b))
                        if ("newchart" === A || "newmap" === A)
                            T.linkedChartOpened = !0, ca && y.removeJob(ca);
                        else if (T.linkedChartOpened = !1, f = !V && n.sliceInOtherPies(g), !(u = S.sliced) || !f) {
                            if (x && !l) {
                                f = (new Date).getTime();
                                if (c.lastSliceTimeStamp && 400 > f - c.lastSliceTimeStamp)
                                    return;
                            ...
                            V && (r = V.slice(0), r[1] += F, r[2] += f, r[4] += F, r[6] += F, c.animateWith(G, L, {
                                path: r
                            }, ga, k), S.connectorPath = r);
                            return e.isSliced = u = S.sliced = !u
                        }
                },
                sliceInOtherPies: function(a) {
                    var r = this.components.dataset[0],
                        e = r.components.data,
                        c = e.length,
                        d = 0,
                        n;
                    for (r.enableMultiSlicing = !0; c--;)
                        c !== a && (n = e[c]).config.sliced && ++d && this._plotGraphicClick.call(n.graphics);
                ...
                placeDataLabels: function() {
                    ...
                    return function(n, g, ga, T) {
                        ...
                        T = .5 * J[2];
                        var b = [[], [], [], []],
                            A = ga.labelsRadius = T + ya.distance,
                        ...
                        n || Ba.setStyle(v);
                        if (1 == g.length && !H && N)
                            O = g[0], (da = O.config._textAttrs).text && (pa = O.graphics, ja = O.config, I = pa.label, O.slicedTranslation = [G, y], da["text-anchor"] = "middle", da.x = 0, da.y = 0, da.transform = ["t", z, M], I ? I.animateWith(qa, sa, da, na, ua) : I = pa.label = wa.text(da, Ga, xa).drag(ta, Sa, Ka).hover(za, aa), I.x = z, I.data("textPos", {
                                x: z,
                                y: M
                            }).data("plotItem", da.plotItem).data("eventArgs", da.eventArgs), null !== ja.y && void 0 !== ja.y && I.show(), pa.connector && pa.connector.attr({
                                path: []
                            }));
                        else if (N)
                            fa = H + (T - H) / 2, f(g, function(e) {
                                ja = e.config;
                                (da = ja._textAttrs).text && (pa = e.graphics, I = pa.label, null !== ja.y && void 0 !== ja.y && ((Ea = pa.connector) && Ea.show(), I && I.show()), da.transform = "t0,0", ha = ja.angle, P = M + fa * t(ha), p = z + fa * E(ha), da._x = p, da._y = P, e.sliced && (va = e.slicedTranslation, oa = va[0] - G, la = va[1] - y, p += oa, P += la), da["text-anchor"] = "middle", da.x = 0, da.y = 0, da.transform = ["t", p, P], I ? I.animateWith(qa, sa, da, na, ua) : I = pa.label = wa.text(da, Ga, xa).drag(ta, Sa, Ka).hover(za, aa), I.x = da._x, I.x = da._x, I.y = da._y, I.data("plotItem", da.plotItem).data("eventArgs", da.eventArgs), da.visibility === L && I.show())
                            });
                        else {
                            for (n = g.length - 1; 0 <= n; n--)
                                if (O = g[n], ja = O.config, da = ja._textAttrs, da.text = ja.displayValue)
                                    pa = O.graphics, null !== ja.y && void 0 !== ja.y && (I = pa.label, (Ea = pa.connector) && Ea.show(), I && I.show()), da.text = ja.displayValue, da.transform = "t0,0", ha = ja.angle % ba, 0 > ha && (ha = ba + ha), V = 0 <= ha && ha < U ? 1 : ha < ma ? 2 : ha < Aa ? 3 : 0, b[V].push({
                                        point: O,
                                        angle: ha
                                    });
                            for (n = g = 4; n--;) {
                                if (x && (V = b[n].length - ga, 0 < V))
                                    for (b[n].sort(a), u = b[n].splice(0, V), V = 0, N = u.length; V < N; V += 1)
                                        O = u[V].point, da = O.config._textAttrs, pa = O.graphics, pa.label && pa.label.attr("visibility", "hidden"), pa.connector && pa.connector.attr({
                                            visibility: "hidden"
                                        });
                                b[n].sort(r)
                            }
                            ...
                            for (n = K.length - 1; 0 <= n; n--)
                                u = K[n].point.config, delete u.clearance, delete u.clearanceShift, H = ea(V * t(u.angle)), Math.abs(J - H) < 2 * h && (u.clearance = 0, K[n + 1].point.clearanceShift = h / 2), J = H;
                            J = Number.POSITIVE_INFINITY;
                            n = 0;
                            for (N = O.length; n < N; n++)
                                u = O[n].point.config, delete u.clearance, delete u.clearanceShift, H = ea(V * t(u.angle)), Math.abs(J - H) < 2 * h && (u.clearance = 0, O[n - 1].point.clearanceShift = h / 2), J = H;
                            b[1].reverse();
                            for (b[3].reverse(); g--;) {
                                u = b[g];
                                N = u.length;
                                ...
                                J = V;
                                for (n = 0; n < N; n += 1, h -= Z)
                                    H = ea(V * t(u[n].angle)), J < H ? H = J : H < h && (H = h), J = (u[n].oriY = H) - Z;
                                v = e[g];
                                N = V - (N - 1) * Z;
                                J = 0;
                                for (n = u.length - 1; 0 <= n; --n, N += Z)
                                    if (O = u[n].point, ha = u[n].angle, ja = O.config, da = ja._textAttrs, da.text && (Ga = ja._textCss, pa = O.graphics, O = ja.sliced, I = pa.label, H = ea(V * t(ha)), H < J ? H = J : H > N && (H = N), J = H + Z, h = void 0 === ja.clearance ? 2 * ia(Q(parseFloat(ja.style.border), 12), 12) : 2 * ia(Q(parseFloat(ja.style.border), ja.clearance)), m = (H + u[n].oriY) / 2, H = z + d[g] * A * E(k.asin(m / V)), m *= c[g], m += M, B = M + T * t(ha), K = z + T * E(ha), (2 > g && H < K || 1 < g && H > K) && (H = K), p = H + D[g], P = m - W - 2, C = p + D[g], da._x = C, R && (X = 1 < g ? C - w.canvasLeft : w.canvasLeft + S - C, Ba.setStyle(ja.style), h = Q(ia(parseFloat(ja.style.lineHeight)), 12) + h, "right" === q && 0 < ja.transX && (X -= F + 2 * ca), h = Ba.getSmartText(ja.displayValue, X, h), void 0 === ja.clearance && h.height > Z && (m += Z), "right" !== q && 0 < ja.transY && (m -= Z), da.text = h.text, da.tooltip = h.tooltext), da._y = P, O && (oa = ja.transX, la = ja.transY, p += oa, H += oa, K += oa, B += la, C += oa), da["text-anchor"] = v, da.vAlign = "middle", da.x = C, da.y = m, (h = I && I.data("textPos")) ? I.attr({
                                        x: h.x,
                                        y: h.y
                                        ...
                                        x: C,
                                        y: m
                                    }).data("plotItem", da.plotItem).data("eventArgs", da.eventArgs), Ea = pa.connector))
                                        ja.connectorPath = h = ["M", K, B, "L", ya ? H : K, m, p, m], (O = Ea.data("connectorPath")) ? w.clicked || Ea.attr({
                                            path: O.path
                                        }).animateWith(qa, sa, {
                                            path: h
                                        }, na) : Ea.attr({
                                            path: h
                                        }), Ea.data("connectorPath", {
                                            path: h
                                        })
                            }
                        }
                ...
                _spaceManager: function() {
                    var a = this.config,
                        ...
                        ca = d.preSliced || a.allPlotSliceEnabled !== wa || f.showlegend === ta && f.interactivelegend !== wa ? ea(Q(S, 20)) : 0,
                        F = Q(f.pieradius, 0),
                    ...
                    d.showLegend && (this.hasLegend = !0, N(f.legendposition, P).toLowerCase() !== fa ? (v = n._manageLegendPosition(A / 2), A -= v.bottom) : (v = n._manageLegendPosition(A / 2), G -= v.right));
                    this._allocateSpace(v);
                    ga.useEllipsesOnOverflow(a.useEllipsesWhenOverflow);
                    if (1 !== T)
                        for (; T--;)
                            ga.setStyle(c[T].config.style || a.dataLabelStyle), n = ga.getOriSize(c[T].config.displayValue), w = ka(w, n.width);
                ...
                _stubRadius: function(a, r, e, c, d, n, g) {
                    var ga = this.components.dataset[0],
                        f = ga.config,
                ...
                _startingAngle: function(a, r) {
                    var e,
                        c = this.components.dataset[0].config,
                        d = (e = c.startAngle) * -na + (0 > -1 * e ? 360 : 0);
                    isNaN(a) || (c.singletonCase || c.isRotating ? d = c.startAngle : (a += r ? d : 0, c.startAngle = -a * sa, this._rotate(a), d = a));
                ...
                eiMethods: {
                    ...
                    removeData: function() {
                        var a,
                            r = this.apiInstance;
                        return r && r.components.dataset && (a = r.components.dataset[0]) && a.removeData.apply(a, arguments)
                    },
                    updateData: function() {
                        var a,
                            r = this.apiInstance;
                    ...
                    slicePlotItem: function(a, r, e) {
                        var c,
                            ...
                            S = w.getJobList();
                        if (e || V)
                            S.eiMethods.push(y.addJob(function() {
                                ga = w && w.components.dataset && (c = w.components.dataset[0]) && (d = c.components.data) && (g = d.length) && d[a = c.config.reversePlotOrder ? g - a - 1 : a] && (n = d[a].config) && ((f !== n.sliced || void 0 === r) && w._plotGraphicClick.call(d[a].graphics.element) || n.sliced);
                                "function" === typeof e && e(ga)
                            }, G.postRender));
                        else
                            return w && w.components.dataset && (c = w.components.dataset[0]) && (d = c.components.data) && (g = d.length) && d[a = c.config.reversePlotOrder ? g - a - 1 : a] && (n = d[a].config) && ((f !== n.sliced || void 0 === r) && w._plotGraphicClick.call(d[a].graphics.element) || n.sliced)
                    },
                    ...
                    startingAngle: function(a, r, e) {
                        var c = this.apiInstance,
                            ...
                            g;
                        if (e || d)
                            n.eiMethods.push(y.addJob(function() {
                                g = c._startingAngle(a, r);
                                "function" === typeof e && e(g)
                            }, G.postRender));
                        else
                            return c._startingAngle(a, r)
                    }
                }
            }, B.guageBase, {
        ...
        B.register("module", ["private", "modules.renderer.js-pie3d", function() {
            ...
            var b = this,
                ...
                qa = m.hasSVG,
                wa = function(r, e) {
                    for (var c = [], d = 0, n = r.length; d < n; d++)
                        c[d] = e.call(r[d], r[d], d, r);
                    return c
                },
                ta = function(r, e) {
                    var c = e ? 360 : ia;
            ...
            sa("pie3d", {
                ...
                _preDrawCalculate: function() {
                    ...
                    for (r = c.length - 1; 0 <= r; --r)
                        e = c[r], e = e.config, f = n, k = d ? e.y / d : 0, n = L(1E3 * (n + k * ia)) / 1E3, n > ga && (n = ga), b = n, e.shapeArgs = {
                            start: L(1E3 * f) / 1E3,
                            end: L(1E3 * b) / 1E3
                        }, e.centerAngle = u = (b + f) / 2 % ia, e.slicedTranslation = [L(G(u) * V), L(y(u) * v)], f = G(u) * F[2], g.radiusY = b = y(u) * F[4], e.tooltipPos = [F[0] + .7 * f, F[1] + b], e.percentage = 100 * k, e.total = d
                },
                placeDataLabels: function() {
                    var r = function(e, c) {
                            return e.point.value - c.point.value
                    ...
                    return function(g) {
                        ...
                        if (ca.dataLabelCounter)
                            if (g || K.setStyle(ya), 1 == F.length)
                                H = F[0], oa = H.graphics, I = H.config, aa = I._textAttrs, za = I._textCss, ha = oa.label, la = oa.connector, I.slicedTranslation = [u, k], null !== I.y && void 0 !== I.y && (aa.visibility = f, aa["text-anchor"] = "middle", aa.x = ja, aa.y = na + Q - 2, aa._x = ja), ha ? ha.animateWith(ta, wa, aa, ua, xa) : ha = oa.label = Ma.text(aa, za, Ua).drag(Ta, Fa, da).hover(Ga, La), aa._x && (ha.x = aa._x, delete aa.x), ha.data("plotItem", aa.plotItem).data("eventArgs", aa.eventArgs), aa.visibility === f && ha.show(), la && la.hide();
                            else if (a)
                                x(F, function(e) {
                                    oa = e.graphics;
                                    I = e.config;
                                ...
                                x(F, function(e) {
                                    ...
                                    za = I._textCss;
                                    aa = I._textAttrs;
                                    if (aa.text = I.displayValue)
                                        oa = e.graphics, null !== I.y && void 0 !== I.y && (ha = oa.label, (la = oa.connector) && la.show(), ha && ha.show()), ha = oa.label, U = I.angle, 0 > U && (U = ia + U), Ea = 0 <= U && U < va ? 1 : U < ea ? 2 : U < ra ? 3 : 0, D[Ea].push({
                                            point: e,
                                            angle: U
                                        })
                                });
                                for (V = w = 4; V--;) {
                                    if (z && (S = D[V].length - qa, 0 < S))
                                        for (D[V].sort(r), ca = D[V].splice(0, S), S = 0, a = ca.length; S < a; S += 1)
                                            H = ca[S].point, oa = H.graphics, oa.label && oa.label.attr("visibility", "hidden"), oa.connector && oa.connector.attr({
                                                visibility: "hidden"
                                            });
                                    D[V].sort(e)
                                }
                                ...
                                for (K.setStyle(ya); w--;) {
                                    ...
                                    ca = a * M;
                                    ya = pa;
                                    for (V = 0; V < a; V += 1, ca -= M)
                                        H = v(pa * y(S[V].angle)), ya < H ? H = ya : H < ca && (H = ca), ya = (S[V].oriY = H) - M;
                                    ca = c[w];
                                    F = pa - (a - 1) * M;
                                    ya = 0;
                                    for (V = S.length - 1; 0 <= V; --V, F += M)
                                        H = S[V].point, oa = H.graphics, I = H.config, aa = I._textAttrs, za = I._textCss, null !== I.y && aa.text && (U = S[V].angle, X = I.sliced, ha = oa.label, H = v(pa * y(U)), H < ya ? H = ya : H > F && (H = F), ya = H + M, Da = (H + S[V].oriY) / 2, H = ja + n[w] * A * G(q.asin(Da / pa)), Da *= d[w], Da += na, Ra = na + N * y(U), O = ja + b * G(U), (2 > w && H < O || 1 < w && H > O) && (H = O), ka = H + p[w], fa = Da + Q - 2, P = ka + p[w], aa._x = P, m && (W = 1 < w ? P - u : u + l - P, K.setStyle(I.style), a = h(B(parseFloat(I.style.lineHeight)), 12) + (2 * B(parseFloat(I.style.border), 12) || 0), a = K.getSmartText(I.displayValue, W, a), aa.text = a.text, aa.tooltip = a.tooltext), U < ea && (Da += ma, Ra += ma, fa += ma), aa._y = fa, X && (a = I.transX, X = I.transY, ka += a, H += a, O += a, Ra += X, P += a), aa.visibility = f, aa["text-anchor"] = ca, (a = ha && ha.data("textPos")) && ha.attr({
                                            x: a.x,
                                            y: a.y
                                            ...
                                            x: P,
                                            y: Da
                                        }).data("plotItem", aa.plotItem).data("eventArgs", aa.eventArgs), ha.x = aa._x, ha._x = aa._x, ha.y = aa._y, aa.tooltip && (ha.tooltip(aa.tooltip), delete aa.tooltip), C && R && sa && (la = oa.connector, I.connectorPath || (T = !0), I.connectorPath = a = ["M", O, Ra, "L", Z ? H : O, Da, ka, Da], a = {
                                            path: a,
                                            "stroke-width": R,
                ...
                animate: function() {
                    ...
                    if (e)
                        ...
                        for (r = 0; r < T; r++)
                            if (e = f[r], c = e.graphics, e = e.config, d = e.shapeArgs, e = 2 * z, c = c.element)
                                c.attr({
                                    start: e,
                                    end: e
                                }), c = d.start, d = d.end, (void 0).animateWith(V, S, {
                                    cx: c - e,
                                    cy: d - e
                                }, a, w)
                },
                ...
                _plotDragMove: function(a, e) {
                    ...
                    isNaN(e[0]) || isNaN(d) || !c.enableRotation || c.singletonCase || c.isRightClicked || (d = ma.call(a, n, g, c.center, c.chartPosition, c.pieYScale), c.isRotating || (c.dragStartAngle !== d && (c.isRotating = !0), b.raiseEvent("rotationStart", {
                        startingAngle: ta(c.startAngle, !0)
                    }, f.chartInstance)), n = d - c.dragStartAngle, c.dragStartAngle = d, c.moveDuration = 0, c._lastAngle += 180 * n / z, d = (new Date).getTime(), c._lastTime && !(c._lastTime + c.timerThreshold < d)) || (c._lastTime || f._rotate(), c.timerId = setTimeout(function() {
                        f.disposed && f.disposing || f._rotate()
                    }, c.timerThreshold), c._lastTime = d)
                },
                _stubRadius: function(a, e, c, d, n, g, f) {
                    var T = this.components.dataset[0],
                        w = T.config,
                ...
                _startingAngle: function(a, e) {
                    var c,
                        d = this.components.dataset[0].config,
                        n = (c = d.startAngle) + (0 > c ? 360 : 0);
                    isNaN(a) || d.singletonCase || d.isRotating || (a += e ? n : 0, this._rotate(a), n = a);
            ...
            a.prototype = {
                configure: function(a, e, c, d) {
                    ...
                    "object" === typeof a && (a = a.depth, e = a.hasOnePoint, c = a.use3DLighting, d = a.isDoughnut);
                    ...
                    !this.topGroup && (this.topGroup = g.group("top-Side", n));
                ...
                _parseSliceColor: function(a, e, c) {
                    ...
                    if (A.cx !== E || A.cy !== t || A.rx !== h || A.radiusYFactor !== L || A.innerRx !== v)
                        qa && (A.top.FCcolor.cx = E, A.top.FCcolor.cy = t, A.top.FCcolor.r = h, A.top.FCcolor.fx = E - .3 * h, A.top.FCcolor.fy = t + 1.2 * l), A.topBorder.FCcolor.x1 = A.backOuter.FCcolor.x1 = A.frontOuter.FCcolor.x1 = K, A.topBorder.FCcolor.x2 = A.backOuter.FCcolor.x2 = A.frontOuter.FCcolor.x2 = N, A.topInnerBorder.FCcolor.x1 = A.backInner.FCcolor.x1 = A.frontInner.FCcolor.x1 = J, A.topInnerBorder.FCcolor.x2 = A.backInner.FCcolor.x2 = A.frontInner.FCcolor.x2 = D, A.cx = E, A.cy = t, A.rx = h, A.radiusYFactor = L, A.innerRx = v;
                    return A
                },
                rotate: function(a) {
                    ...
                    if (!this.hasOnePoint) {
                        for (; c < d; c += 1)
                            n = e[c], n = n._confObject, n.start += a, n.end += a, this._setSliceShape(n);
                        this.refreshDrawing()
                    }
                },
                removeSlice: function(a) {
                    ...
                    var g;
                    for (--n; 0 <= n; --n)
                        g = e[n], g === a && e.splice(n, 1);
                    n = d.length;
                    for (--n; 0 <= n; --n)
                        e = d[n], e !== c.startSlice && e !== c.frontOuter1 && e !== c.frontOuter && e !== c.backInner && e !== c.endSlice || d.splice(n, 1);
                    a.hide && a.hide();
                ...
                useSliceFromPool: function() {
                    var a = this._slicePool || (this._slicePool = []),
                ...
                refreshDrawing: function() {
                    ...
                    return function() {
                        var e = this.slicingWallsArr,
                            ...
                            T,
                            w,
                            b = this.slicingWallsFrontGroup,
                            S = this.slicingWallsBackGroup;
                        e.sort(a);
                        a:
                        {
                            var ca = e[0] && e[0]._conf.index,
                                F,
                                k;
                            w = ca <= ea;
                            g = 1;
                            for (d = e.length; g < d; g += 1)
                                if (k = e[g]._conf.index, F = k <= ea, F != w || k < ca)
                                    break a;
                            g = 0
                        }for (; c < n; c += 1, g += 1)
                            g === n && (g = 0), d = e[g], w = d._conf.index, w < va ? b.appendChild(d) : w <= ea ? (f ? d.insertBefore(f) : b.appendChild(d), f = d) : w <= ra ? (T ? d.insertBefore(T) : S.appendChild(d), T = d) : S.appendChild(d)
                    }
                }(),
                ...
                createSlice: function() {
                    var a = {
                        ...
                        e = function(e, c) {
                            var d,
                                ...
                                ga = f.Pie3DManager,
                                G;
                            "string" === typeof e && void 0 !== c && null !== c && (d = e, e = {}, e[d] = c);
                            if (e && "string" !== typeof e) {
                                for (d in e)
                                    if (n = e[d], a[d])
                                        if (f[d] = n, "ishot" === d || "cursor" === d || "transform" === d)
                                            w[d] = n, G = !0;
                                        else if ("start" === d || "end" === d || "cx" === d || "cy" === d || "radiusYFactor" === d || "r" === d || "innerR" === d)
                                            T = !0;
                                        else {
                                            if ("color" === d || "alpha" === d || "borderColor" === d || "borderAlpha" === d || "borderWidth" === d)
                                                q = !0
                                        }
                                    else
                                        g._attr(d, n);
                        ...
                        d = function(a, e, c) {
                            ...
                            for (d in n)
                                g ? "topBorder" !== d && "frontOuter" !== d && "startSlice" !== d && "endSlice" !== d || n[d].drag(a, e, c) : n[d].drag(a, e, c);
                    ...
                    return function() {
                        ...
                        u.frontOuter = a[h](this.slicingWallsFrontGroup).attr({
                            "stroke-width": 0
                        });
                        u.backOuter = a[h](this.slicingWallsFrontGroup).attr({
                            "stroke-width": 0
                        });
                        u.startSlice = a[h](this.slicingWallsFrontGroup);
                        u.endSlice = a[h](this.slicingWallsFrontGroup);
                        u.frontOuter1 = a[h](this.slicingWallsFrontGroup).attr({
                            "stroke-width": 0
                        });
                        u.frontOuter._conf = {
                            si: k,
                        ...
                        this.isDoughnut && (u.frontInner = a[h](this.slicingWallsFrontGroup).attr({
                            "stroke-width": 0
                        }), u.backInner = a[h](this.slicingWallsFrontGroup).attr({
                            "stroke-width": 0
                        }), u.backInner._conf = {
                            si: k,
                            isStart: .5
                            ...
                            si: k,
                            isStart: .4
                        }, G.push(u.frontInner, u.backInner));
                        k += 1;
                        return q
                    }
                }()
        ...
        B.register("module", ["private", "modules.renderer.js-doughnut2d", function() {
            var a = this,
                b = a.hcLib,
                m = a.window,
            ...
            p("doughnut2d", {
                ...
                getPointColor: function(a, b, k) {
                    ...
                    a = K(a);
                    b = N(b);
                    100 > k && Q ? (h = y(a, q(100 * (85 - .2 * (100 - k))) / 100), a = f(a, q(100 * (100 - .5 * k)) / 100), b = {
                        FCcolor: {
                            color: h + "," + a + "," + a + "," + h,
                            alpha: b + "," + b + "," + b + "," + b,
                            radialGradient: !0,
                ...
                drawDoughnutCenterLabel: function(a, f, b, q, y, v, z) {
                    ...
                    (y = m.doughnutCenterLabel) ? (y.attr("text") !== a && this.centerLabelChange(a), U = m.centerLabelOvalBg) : (v.bgOval && (m.centerLabelOvalBg = U = p.circle(f, b, .5 * q - Q, C)), y = m.doughnutCenterLabel = p.text(C).hover(this.centerLabelRollover, this.centerLabelRollout).click(this.centerLabelClick), y.chart = this);
                    a ? (y.css(na).attr({
                        x: f,
                        y: b,
                        text: N.text,
                        ...
                        "stroke-opacity": v.borderAlpha / 100
                ...
                centerLabelRollover: function() {
                    ...
                    this.attr("text") && a.raiseEvent("centerLabelRollover", b, k, this, f.hoverOnCenterLabel)
                },
        ...
        B.register("module", ["private", "modules.renderer.js-msline", function() {
            var a = this.hcLib,
                b = a.chartAPI,
                a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("msline", {
            ...
            m("stackedcolumn3d", {
                ...
                _mouseEvtHandler: function(b) {
                    var p = b.data.mouseTracker,
                        ...
                        E = l.length,
                        v,
                        z = p._lastDatasetIndex,
                        B = p._lastPointIndex;
                    if (q > N && q < m && f > x && f < h || this.config.plotOverFlow) {
                        for (; E-- && !t;)
                            y = l[E], y.valueLook = !0, y && y.visible && (k = y._getHoveredPlot && y._getHoveredPlot(q, f)) && k.hovered && (t = !0, k.datasetIndex = E, v = p._getMouseEvents(b, k.datasetIndex, k.pointIndex));
                        for (E = 0; E < l.length && !t;)
                            y = l[E], y.valueLook = !1, y && y.visible && (k = y._getHoveredPlot && y._getHoveredPlot(q, f)) && k.hovered && (t = !0, k.datasetIndex = E, v = p._getMouseEvents(b, k.datasetIndex, k.pointIndex)), E++
                    }
                    ...
                    if (t)
                        for (N = v.events && v.events.length, p._lastDatasetIndex = k.datasetIndex, B = p._lastPointIndex = k.pointIndex, K.drawTrendRegion && G[L]._notifyGroup(!0, b), p = 0; p < N; p += 1)
                            y && y._firePlotEvent && y._firePlotEvent(v.events[p], B, b, k.datasetIndex);
                    else
                        K.drawTrendRegion && G[L]._notifyGroup(!1, b);
        ...
        B.register("module", ["private", "modules.renderer.js-stackedbar3d", function() {
            ...
            m("stackedbar3d", {
                ...
                _mouseEvtHandler: function(b) {
                    ...
                    if (q > N && q < m && f > x && f < h || this.config.plotOverFlow) {
                        for (E = l.length; E-- && !t;)
                            if (y = l[E], y.valueLook = !0, y && y.visible) {
                                if ((k = y._getHoveredPlot && y._getHoveredPlot(q, f)) && k.hovered)
                                    for (N = 0; N <= E; ++N)
                                        if (E !== N && k && (m = l[N], (h = m._getHoveredPlot && m._getHoveredPlot(q, f)) && h.pointIndex === k.pointIndex - 1)) {
                                            k = h;
                                            E = N;
                                            y = m;
                                            y.valueLook = !0;
                    ...
                    (!t || v && v.fireOut) && void 0 !== z && (delete p._lastDatasetIndex, delete p._lastPointIndex, l[z] && l[z]._firePlotEvent && l[z]._firePlotEvent("mouseout", B, b));
                    if (t)
                        for (l = v.events && v.events.length, p._lastDatasetIndex = k.datasetIndex, B = p._lastPointIndex = k.pointIndex, K.drawTrendRegion && G[L]._notifyGroup(!0, b), p = 0; p < l; p += 1)
                            y && y._firePlotEvent && y._firePlotEvent(v.events[p], B, b, k.datasetIndex);
                    else
                        K.drawTrendRegion && G[L]._notifyGroup(!1, b);
                    K.drawTrendRegion && G[L]._getHoveredRegion(q, f, b)
        ...
        B.register("module", ["private", "modules.renderer.js-marimekko", function() {
            ...
            b("marimekko", {
                ...
                _setAxisLimits: function() {
                    ...
                    for (l = 0; l < x; l++)
                        h = b[l], (k = h.groupManager) ? t[h.type] = k : E.push(h);
                    for (k in t)
                        b = t[k].getDataLimits(), v(b);
                    x = E.length;
                    for (l = 0; l < x; l++)
                        b = E[l].getDataLimits(), v(b);
                    -Infinity === f && (f = 0);
                    Infinity === q && (q = 0);
                    m[0].setAxisConfig({
                    ...
                    for (l = 0; l < m.length; l++)
                        b = m[l], x = k * b / 100, b = L + x / 2, a[0].updateCategory(l, {
                            x: b
                        }), L += x
                }
            }, b.mscartesian, {
                ...
                _createDatasets: function() {
                    ...
                    if (m || 0 !== z.length) {
                        ...
                        for (b = 0; b < h; b++) {
                            ...
                            U++;
                            if (E.dataset)
                                for (fa = !0, v = E.dataset && E.dataset.length || 0, ra[b] = [], x = 0; x < v; x++) {
                                    if (k = E.dataset[x], G = (G = C(k.renderas, q)) && G.toLowerCase(), y[G] || (G = q), f = B.get("component", ["dataset", G]))
                                        t = "datasetGroup_" + G, L = B.register("component", ["datasetGroup", G]), G = a[t], L && !G ? (G = a[t] = new L, G.chart = this, G.init()) : G && ka && 0 !== ka.length && !ma && (G.init(), ma = !0), ka && ka[b] && ka[b][x] ? (f = ka[b][x], f.index = na, t = f.JSONData, L = t.data && t.data.length || 0, t = k.data && k.data.length || 0, ba = ua.getCategoryLen(), P = Aa - ba, L -= t, L = this._getDiff(L, t, P, ba), t = L.diff, L = L.startIndex, 0 < t && f.removeData(L, t, !1), f.JSONData = k, f.configure()) : (f = new f, f.chart = this, f.index = na, f.init(k)), na++, ra[b].push(f), l.push(f), G && G.addDataSet(f, U, x)
                                }
                            else
                                v = x = 0, U--;
                            E = ka && ka[b] && ka[b].length;
                            if (E > v)
                                for (k = x, E = E - v + x; k < E; k++)
                                    G = ka[b][k], ia.removeItem(G.legendItemId), p.call(G)
                        }
                        if (va > h)
                            for (k = b, E = va - h + b; k < E; k++)
                                for (v = ka[k].length, x = 0; x < v; x++)
                                    G = ka[k][x], ia.removeItem(G.legendItemId), p.call(G);
                        Y.dataSetMap = ra;
                        if (this.lineset) {
                            b = 0;
                            for (h = z.length; b < h; b++)
                                m = z[b], f = B.get("component", ["dataset", "line"]), f = new f, ea && ea[b] ? (f = ea[b], f.index = na, t = f.JSONData, L = t.data.length, t = m.data && m.data.length || 0, L > t && f.removeData(t, L - t, !1), f.JSONData = m, f.configure()) : (f.chart = this, f.index = na, f.init(m)), sa.push(f), l.push(f), na++;
                            z = ea && ea.length;
                            if (z > h)
                                for (k = b, E = z - h + b; k < E; k++)
                                    G = ea[k], ia.removeItem(G.legendItemId), p.call(G);
                            Y.lineSetMap = sa
                        }
            ...
            b("mscombi2d", {
                ...
                _createDatasets: function() {
                    ...
                    var y = a.xAxis[0],
                        ...
                        ra = va.datasetMap || (va.datasetMap = {
                            line: [],
                            area: [],
                            column: [],
                            column3d: [],
                    ...
                    x && x.emptyItems();
                    for (x = 0; x < h; x++)
                        if (E = m[x], t = E.parentyaxis || "", L = (L = this.config.isdual && "s" === t.toLowerCase() ? "line" === this.defaultSecondaryDataset ? this.sDefaultDatasetType : C(E.renderas, this.sDefaultDatasetType) : C(E.renderas, f)) && L.toLowerCase(), q[L] || (L = f), k = B.get("component", ["dataset", L]))
                            void 0 === ea[L] ? ea[L] = 0 : ea[L]++, l = "datasetGroup_" + L, t = B.register("component", ["datasetGroup", L]), (G = a[l]) && ka.push(G), t && !G && (G = a[l] = new t, G.chart = this, G.init()), t = ra[L], (l = t[0]) ? (delete l.legendItemId, G = y.getCategoryLen(), k = ia - G, Y = l.JSONData, z = Y.data && Y.data.length, Y = E.data && E.data.length || 0, z -= Y, k = this._getDiff(z, Y, k, G), G = k.diff, k = k.startIndex, 0 < G && l.removeData(k, G, !1), l.index = x, l.JSONData = E, l.configure(), t.splice(0, 1)) : (l = new k, l.chart = this, l.index = x, G && (v ? G.addDataSet(l, 0, ea[L]) : G.addDataSet(l, ea[L], 0)), l.init(E)), sa[L].push(l), b.push(l);
                    this._setDatasetOrder();
                    for (m in ra)
                        if (t = ra[m], f = t[0] && t[0].groupManager, h = t.length, q = void 0 === ea[m] ? 0 : ea[m] + 1, h)
                            for (v && f && f.removeDataSet(0, q, h), a = 0; a < h; a++)
                                f && !v && f.removeDataSet(q, 0, 1), "column" === t[a].type && !0 === this.is3D ? (t[a].visible = !1, t[a].draw()) : p.call(t[a]);
                    va.datasetMap = sa;
        ...
        B.register("module", ["private", "modules.renderer.js-scrollcolumn2d", function() {
            ...
            m("scrollcolumn2d", {
                ...
                _swipeX: function(f, b) {
                    ...
                    case "mousemove":
                        if (C)
                            return p || a.raiseEvent("scrollStart", {
                                scrollPosition: m
                            }, this.chartInstance), h = t - 2 * E - (t * k - 2 * E * k), h = K(N(m + (l - b) / h, 0), 1), this.updateManager(h), this.swipeStart = !0, this.touchCurrPos = b, f.originalEvent.preventDefault ? f.originalEvent.preventDefault() : f.originalEvent.returnValue = !1, !0;
                        break;
                    case "touchend":
                    case "mouseup":
                ...
                eiMethods: {
                    scrollTo: m.mscartesian._scrollTo
                },
                _manageScrollerPosition: function() {
                    ...
                    l = h.getLogicalSpace();
                    this._allocateSpace({
                        bottom: a.shift = !1 === b ? 0 : l.height + h.conf.padding
                    })
                },
                ...
                _setInitialDrawingIndex: function() {
                    ...
                    for (p = 0; p < v; p++)
                        k = m[p], E = k.components, E.removeDataArr = [], t = E.pool, k.drawn && t && (k = E.data.slice(a.scrollMinVal, a.scrollMaxVal), t.element && t.element.push.apply(t.element, k.filter(this._filterDataFn).map(this._datasetModifyFn)), t.label && t.label.push.apply(t.label, k.filter(this._filterLabelFn).map(this._labelModifyFn)), t.image && t.image.push.apply(t.image, k.filter(this._filterImageFn).map(this._imageModifyFn)));
                    (t = (b = b.datasetGroup_scrollcolumn2d) && b.pool) && a.isstacked && (t = t.sumLabels[0]) && t.push.apply(t, b.graphics.sumLabels[0].slice(a.scrollMinVal, a.scrollMaxVal).filter(this._filterSumFn).map(this._sumValModifyFn));
                ...
                updateManager: function(a) {
                    ...
                    void 0 !== a && v.scrollBar.node && v.scrollBar.node.attr({
                        "scroll-position": a
                    });
                    this._manageScroll();
                    p.attr({
                ...
                _filterLabelFn: function(a) {
                    if (a.graphics && a.graphics.label)
                        return a
                },
                _filterDataFn: function(a) {
                    ...
                    a._baseXPos = void 0;
                    a._baseYPos = void 0;
                    if (a.graphics && a.graphics.element)
                        return a
                },
                _filterImageFn: function(a) {
                    if (a.graphics && a.graphics.image)
                        return a
                },
                _filterSumFn: function(a) {
                    if (a.graphics && a.element)
                        return a
                },
                ...
                _createDataPool: function() {
                    ...
                    for (m = 0; m < l; m++) {
                        ...
                        b = a.components;
                        k = a.graphics;
                        t = k.container.anchorGroup || k.container;
                        ...
                        if (!k)
                            for (k = b.pool = {
                                ...
                                k.element.push("column" === a.type ? v.rect(t) : v.polypath(t)), k.label.push(v.text(p))
                    }
                },
                _manageScroll: function() {
                    ...
                    var K = B - x,
                        C,
                        N;
                    .5 <= l.maxValue - a.visibleAxisMaxVal ? (N = B - z > K, a.scrollMinVal = N ? B - K : z, a.scrollMaxVal = B, a.visibleAxisMaxVal = l.maxValue, a.visibleAxisMinVal = l.minValue, a.startPathIndex = B - K, a.endPathIndex = B, E = !0) : .5 <= k - l.minValue && (N = v - x > K, a.scrollMinVal = x, a.scrollMaxVal = N ? x + K : v, a.visibleAxisMaxVal = l.maxValue, a.visibleAxisMinVal = l.minValue, a.startPathIndex = x, a.endPathIndex = x + K, t = !0);
                    if (t || E) {
                        a.showsum && a.isstacked && (b = b.datasetGroup_scrollcolumn2d, b.drawSumValueFlag = !0, this._createSumLabelPool(), l = b.pool, E ? C = b.graphics.sumLabels[0].slice(v, N ? v + K : x) : t && (C = b.graphics.sumLabels[0].slice(N ? z - K : B, z)), l.sumLabels[0].push.apply(l.sumLabels[0], C.filter(this._filterSumFn).map(this._sumValModifyFn)));
                        for (b = 0; b < p; b++)
                            k = m[b], l = k.components, this._createDataPool(), l = l.pool, E ? C = k.components.data.slice(v, N ? v + K : x) : t && (C = k.components.data.slice(N ? z - K : B, z)), l.element.push.apply(l.element, C.filter(this._filterDataFn).map(this._datasetModifyFn)), l.label.push.apply(l.label, C.filter(this._filterLabelFn).map(this._labelModifyFn)), k.config.imageCount && l.image.push.apply(l.image, C.filter(this._filterImageFn).map(this._imageModifyFn)), k.draw();
                        a.scrollMinVal = x;
                        a.scrollMaxVal = B
                    }
                },
                    ...
                    p({
                        ...
                        scroll: function(b) {
                            return function() {
                                ...
                                k || a.raiseEvent("onScroll", {
                                    scrollPosition: f
                                }, b.chartInstance);
                                h.scrollTo = !1;
                                b.updateManager.apply(b, arguments)
                            }
                        }(this)
                    });
                    h = l()[0];
                ...
                drawScrollBar: function() {
                    ...
                    !1 !== h.scrollEnabled ? (Q.draw(m - Aa, ia + ra + ma + U - 2, {
                        width: na + Aa + E,
                        scrollRatio: sa,
                ...
                _setClipping: function() {
                    var a = this.config,
                        ...
                        C = C && C.slice(0) || [];
                    this.config.clipSet ? (b.animateWith(B, K, {
                        "clip-rect": C
                    }, v, x), h.animateWith(B, K, {
                        "clip-rect": C
                    }, v, x), l.attr({
                        "clip-rect": C
                    }), C[3] = a, C[1] = 0, k && k.animateWith(B, K, {
                        "clip-rect": C
                    }, v, x)) : (b.attr({
                        "clip-rect": C
                    }), h.attr({
        ...
        B.register("module", ["private", "modules.renderer.js-scrollcombidy2d", function() {
            ...
            a("scrollcombidy2d", {
                ...
                eiMethods: {
                    scrollTo: a.mscartesian._scrollTo
                }
            }, a.mscombidy2d, {
                enablemousetracking: !0,
                isdual: !0
            ...
            a("bubble", {
                ...
                getDataLimits: function() {
                    ...
                    for (h = a.length; b < h; b++)
                        m = a[b], m = m.getDataLimits(), x = B(x, m.zMax || -Infinity), l = p(l, m.zMin || Infinity);
                    x = -Infinity === x ? 0 : x;
                    l = Infinity === l ? 0 : l;
                    return {
                        zMax: x,
    ...
    B.register("module", ["private", "modules.renderer.js-zoomline", function() {
        ...
        h("zoomline", {
            ...
            _createDatasets: function() {
                ...
                for (a = 0; a < F; a++) {
                    ...
                    v[c] || (c = r);
                    if (d = B.get("component", ["dataset", c]))
                        void 0 === g[c] ? g[c] = 0 : g[c]++, (c = w[a]) ? (d = (c.JSONData.data || []).length, b = (k.data || []).length, d > b && c.removeData(b, d - b, !1), w[a].JSONData = k, w[a].configure(), w[a]._deleteGridImages && w[a]._deleteGridImages()) : (c = new d, w.push(c), c.chart = this, c.index = a, c.init(k))
                }
                if (l > F) {
                    g = l - F;
                    c = a;
            ...
            highlightPoint: function(a, c, d, n, g, h) {
                ...
                F || (F = m.tracker = q.circle(0, 0, 0, m.trackerGroup).attr({
                    "clip-rect": k.canvasLeft + "," + k.canvasTop + "," + k.canvasWidth + "," + k.canvasHeight
                }).click(r).trackTooltip(!0).hover(t, v));
                n && F.data("eventArgs", {
                    x: n.x,
                    y: n.y,
                    tooltip: n.tooltip,
            ...
            configure: function() {
                ...
                x(g, {
                    ...
                    btnSwitchToZoomModeTooltext: f(c.btnswitchtozoommodetooltext, "<strong>Switch to Zoom Mode</strong><br/>Select a subset of data to zoom into it for detailed view"),
                    ...
                    showPeakData: q(c.showpeakdata, 0),
                    ...
                    crossline: {
                        ...
                        valueEnabled: q(c.showcrosslinevalues, c.showcrossline, 1),
                        valuestyle: {
                ...
                return {
                    ...
                    draw: function(a) {
                        var c,
                            ...
                            d;
                        for (c = 0; c < a.length; c += 1)
                            e = a[c], d = e.drawingArea, e.draw(d.x, d.y)
                    },
            ...
            __preDraw: function() {
                ...
                (d = q(a.pixelsperlabel, a.xaxisminlabelwidth, d.getAxisConfig("labels").rotation ? 20 : 60)) < c && (d = c);
                (0 > N || N >= (A - 1 || 1)) && (N = 0);
                (P <= N || P > (A - 1 || 1)) && (P = A - 1 || 1);
                ...
                if (A.clen) {
                    for (; D--;)
                        a = R[D].config, Q = fa(Q, a.drawanchors && (a.anchorradius || 0) + (Number(a.anchorborderthickness) || 0) || 0);
                    u.overFlowingMarkerWidth = Q;
                    g = u.canvasPadding = fa(Q, g);
                    ...
                    f && (u.viewPortConfig.pinned = !1, f = E.crispBound(0, C - h, 0, z, G), u["clip-pinrect"] = [f.x, C, f.width, f.height], k = (t.zoompin || (t.zoompin = F.group("zoompin"))).insertBefore(l).transform(u._pingrouptransform = ["T", b, h]).hide(), l = {
                        "stroke-width": 0,
                        stroke: "none",
                        fill: u.pinPaneFill,
                    ...
                    K && 0 !== K.enabled && 1 === u.useCrossline ? (p || (p = t.crossline = new r), p.configure(m, K)) : (K && (K.enabled = 0), p && p.hide())
                }
            },
            resetZoom: function() {
            ...
            eiMethods: {
                zoomOut: function(a) {
                    ...
                    if (c)
                        if (d)
                            g.eiMethods.push(ma.addJob(function() {
                                b = c.zoomOut && c.zoomOut();
                                "function" === typeof a && a(b)
                            }, U.postRender));
                        else
                            return c.zoomOut && c.zoomOut()
                },
                ...
                zoomTo: function(a, c, d) {
                    ...
                    if (b)
                        if (g || d)
                            f.eiMethods.push(ma.addJob(function() {
                                h = b.zoomRange && b.zoomRange(a, c);
                                "function" === typeof d && d(h)
                            }, U.postRender));
                        else
                            return b.zoomRange && b.zoomRange(a, c)
                },
                resetChart: function() {
                ...
                getViewStartIndex: function(a) {
                    ...
                    else if (c && (b = c.config.viewPortConfig))
                        return b.ddsi
                },
            ...
            zoomTo: function(e, c, d) {
                ...
                d ? this.updateVisual(d.x, d.y, d.scaleX, d.scaleY) : (d = r.getPixel(e), b = r.getPixel(c), g = this.getOriginalPositions(d - g, l, b - g, m - l), this.zoomSelection(g[0], 0, g[2], k));
            ...
            activatePin: function(e) {
                ...
                if (c.pinned ^ (e = !!e))
                    return e || this.pinRangePixels(), a.raiseEvent("zoomModeChanged", {
                        pinModeActive: e
            ...
            pinRangePixels: function(a, c) {
                ...
                if (l && m && d) {
                    if (a === c)
                        return m.hide(), h.hide(), l.pinned = !1;
                    for (v = b.length; v--;)
                        u = b[v], d = u.graphics, t = d.pinline, t || (t = d.pinline = g.path(m)), t.attr({
            ...
            getOriginalPositions: function(a, c, d, b) {
                ...
                c = c > g.canvasHeight ? g.canvasHeight : c;
                m = 0 > m ? 0 : m;
                d = 0 > d ? 0 : d;
            ...
            updateManager: function(a) {
                ...
                if (c.legendClicked)
                    ...
                    r = k.lskip = Aa(fa(v, xa(r.lineHeight)) / x / m);
                    ...
                    void 0 !== a && b.scrollBar.node && b.scrollBar.node.attr({
                        "scroll-position": k._pos = a
                    });
                    ...
                    C.FC_DEV_ENVIRONMENT && C.jQuery && (B["debugger"].enable() ? (this.debug = this.debug || (C.jQuery("#fc-zoominfo").length || C.jQuery("body").append('<pre id="fc-zoominfo">'), C.jQuery("#fc-zoominfo").css({
                        position: "absolute",
                        left: "10px",
                        top: "0",
                        "pointer-events": "none",
            ...
            getParsedLabel: function(a) {
                var c = this.xlabels;
                return c.parsed[a] || (c.parsed[a] = k(c.data[a] || ""))
            },
            _createToolBox: function() {
                var a,
                    c,
            ...
            draw: function() {
                ...
                f && u && (b++, f = E.crispBound(l - b, m + q + b, p + b + b, r.scrollHeight, b), b--, k = (g = k.scrollBar) && g.node, g.draw(f.x + (c && -1 || b % 2), f.y - (c && 4 || 2), {
                    isHorizontal: !0,
                    width: f.width - (!c && 2 || 0),
                    height: f.height,
                    ...
                    E.eve.on("raphael.scroll.end." + g.node.id, function(b) {
        ...
        B.register("component", ["dataset", "zoomline", {
            ...
            _firePlotEvent: function(a, c, d, f) {
                var g = this.chart,
                    ...
                    r;
                if (k)
                    switch (p = h.config, r = p.setLink, p = p.eventArgs, a) {
                    case "mouseover":
            ...
            isWithinShape: function(a, c, b, h) {
                if (a) {
                    var g = a.config.anchorProps,
                        f = g.borderThickness,
                    ...
                    p = a._yPos;
                    if (null !== p)
                        return a = a.config.hoverEffects, g = Math.max(g.radius, a && a.anchorRadius || 0, ra) + f / 2, b = Math.sqrt(Math.pow(b - m, 2) + Math.pow(h - p, 2)), b <= g || b <= l ? {
                            pointIndex: c,
                            hovered: !0,
                            pointObj: k[c]
                        } : !1
            ...
            draw: function() {
                var a,
                    ...
                    ra = p.shadow,
                    ha,
                    sa = g.graphics.dataLabelContainer,
                    I = {},
                    oa,
                    la,
                    ta = l.is3D,
                ...
                var Ua,
                    ...
                    ob = function(a, c) {
                        ...
                        ia = la.hoverEffects;
                        I.isAnchorHoverRadius = ia.anchorRadius;
                        kb = A.getLabel(c);
                        ...
                        null === la.setValue || fb || (I.imageUrl ? (oa = new K, oa.onload = g._onAnchorImageLoad(g, c, ba, E, L), oa.onerror = g._onErrorSetter(E, L, c, g), oa.src = I.imageUrl) : (D = b.element, D || (D = Ha.element && Ha.element.length ? b.element = Ha.element.shift() : b.element = C.polypath(Y.anchorGroup)), D.attr({
                            polypath: [I.symbol[1] || 2, E, L, I.radius, I.startAngle, ab],
                            fill: v({
                                color: I.bgColor,
                                alpha: I.bgAlpha
                            }),
                            ...
                            fill: v({
                                color: ia.anchorColor,
                                alpha: ia.anchorBgAlpha
                            }),
                            stroke: v({
                    ...
                    Ya = function(c, b) {
                        ...
                        var d;
                        for (y = c; y < b; y += 1)
                            for (d in a = u[y] && u[y].graphics || {}, u[y] && (u[y].config.isRemoving = !0), a)
                                Ha[d] || (Ha[d] = []), a[d] && (Ha[d].push(a[d].hide()), a[d] = void 0)
                    },
                    Za = na.ddsi || 0,
                    Ja = na.ddei || B,
                    Na = p._oldStartIndex,
                ...
                }, Y.lineGroup.trackTooltip(!0), Va || (Y.lineShadowGroup.hide(), Y.anchorShadowGroup.hide(), Y.lineGroup.hide(), Y.anchorGroup.hide()));
                ...
                for (y = p._oldStartIndex = Za; y <= Ja; y += Ia) {
                    ...
                    if (rb)
                        if (0 === y && null === M) {
                            lb = 0;
                            for (Ca = c = y; Ca < B;)
                                if (null !== u[Ca].config.setValue || d ? d = !0 : Ca++, null === u[c].config.setValue && !h && c <= B ? (c += Ia, lb++) : h = !0, d && h) {
                                    d = h = !1;
                                    break
                                }
                    ...
                    if (W = u[Wa])
                        ob(W, Wa), sb && 1 < Ia && (Xa = qa(y + 1, Ja), eb = qa(Xa + Ia, Ja), db = eb === Ja ? u.slice(Xa) : u.slice(Xa, eb), db.length && ub(db, Xa))
                }
                bb = g.getLinePath(cb, {});
        ...
        r.prototype.configure = function(a, c) {
            ...
            if (c.valueEnabled) {
                b = 0;
                for (h = u.length; b < h; b += 1)
                    g = u[b], g = m(g.config.linecolor), f.x = 0, f.y = y, f.fill = g, f.direction = t.textDirection, f.text = "", f["text-bound"] = E["text-bound"], f.lineHeight = E.lineHeight, p[b] ? p[b].attr(f) : p[b] = p.items[b] = r.text(f, void 0, z);
                for (; b < p.items.length; b += 1)
                    p[b].remove(), delete p[b], p.items.splice(b, 1);
                this.numberFormatter = q
            } else if (p.items && p.items.length) {
                for (b = 0; b < p.items.length; b += 1)
                    p[b].remove(), delete p[b];
                p.length = 0
            }
        };
        ...
        r.prototype.onMouseMove = function(a) {
            if (!(this.disabled || this._mouseIsDown && !z)) {
                ...
                if (q !== this.position || this.hidden)
                    this.position = q, this.lineX = a, this.updateLabels()
            }
        };
        r.prototype.updateLabels = function() {
                ...
                x = function() {
                    ...
                    function d(a) {
                        ...
                        for (c = 0; c < this.length; c++)
                            b = this[c] - a, 0 > b ? e = v.NEG : e = v.POS, b = t(b), b <= f && (f = b, g.absValue = b, g.noScaleSide = e);
                        return g
                    }
                    function g(a) {
                        this.holes = b.call([], a)
                    ...
                    "function" != typeof Object.create && (Object.create = function() {
                        ...
                        return function(b) {
                            ...
                            if (1 < arguments.length)
                                for (e in d = Object(arguments[1]), d)
                                    c.call(d, e) && (g[e] = d[e]);
                            return g
                        }
                    }());
                    ...
                    g.prototype.repositionHoles = function() {
                        var a,
                            c = 0,
                            b;
                        for (a = this.holes.length = 0; a < this.length; a++)
                            b = this[a], !b && (this.holes[c++] = a)
                    };
                    g.prototype.attachShift = function(a, b, e) {
                        var g,
                            f = this.length;
                        if (a === q)
                            e.calcY = q;
                            ...
                            if (a.noScaleSide === v.POS)
                                return b.applyDirectIndex(e), this.splice(e, 1, b), this.holes.splice(this.holes.indexOf(e), 1), e;
                            ...
                            b.applyDirectIndex(f), this.splice(f, 1, b), this.holes.splice(this.holes.indexOf(f), 1)
                    };
                    try {
            ...
            c && (c[0] && c[0].attr({
                text: r.yAxis("0")
            }), c[0] && x.init(c[0].getBBox().height, c.length), c.forEach(function(a, c) {
                var e = b[c],
            ...
            c && c.forEach(function(a, c) {
                var e = b[c],
                    l,
                    m;
                (e = r[e.config.parentYAxis ? "sYAxis" : "yAxis"](e.components.data[g] && e.components.data[g].config.setValue)) ? (a.attr({
                    text: e
        ...
        E.addSymbol({
            pinModeIcon: function(a, c, b) {
                var f = .5 * b,
                    ...
                    u = c - f,
                    f = c + (b - f);
                return ["M", g, r, "L", k, u, k, f, g, t, a - .5, t, a, c + b + .5, m, t, h, t, l, f, l, u, h, r, q, r, q, u, q, f, p, f, p, u, q, u, q, r, "Z"]
            },
