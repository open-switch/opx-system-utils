                ...
                u.types = {}, u.instances = {}, u.controllers = {}, h.extend(u.prototype, {
                    ...
                    buildOrUpdateControllers: function() {
                        ...
                        return h.each(o.data.datasets, function(t, e) {
                            ...
                            if (i.type && i.type !== n && (o.destroyDatasetMeta(e), i = o.getDatasetMeta(e)), i.type = n, r.push(i.type), i.controller)
                ...
                fit: function() {
                    ...
                    if (a.display && s) {
                        ...
                        if (l) {
                            ...
                            a.mirror ? h = 0 : h += p + g, e.width = Math.min(t.maxWidth, e.width + h), t.paddingTop = u.size / 2, t.paddingBottom = u.size / 2
                    }
                    ...
                    if (D.display) {
                        ...
                        if (H.each(O, function(t, e) {
                            ...
                            var o,
                                ...
                                f = C(e) / 2;
                            if (F)
                                o = _.left + (_.right - _.left) / 2, c = "bottom" === D.position ? _.bottom - f - a.bottom : _.top + f + a.top;
                            else {
            ...
            (e.exports = a.extend({
                ...
                getCaretPosition: function(t, e, i) {
                    var n,
                        ...
                        m = e.height;
                    if ("center" === h)
                        s = g + m / 2, l = "left" === c ? (a = (n = f) - u, o = n, r = s + u, s - u) : (a = (n = f + p) + u, o = n, r = s - u, s + u);
                    else if (o = (n = "left" === c ? (a = f + d + u) - u : "right" === c ? (a = f + p - d - u) - u : (a = i.caretX) - u, a + u), "top" === h)
                        s = (r = g) - u, l = r;
                    else {
                        s = (r = g + m) + u, l = r;
                        var v = o;
            ...
            e.exports = {
                ...
                resolve: function(t, e, i) {
                    ...
                    for (n = 0, a = t.length; n < a; ++n)
                        if (void 0 !== (o = t[n]) && (void 0 !== e && "function" == typeof o && (o = o(e)), void 0 !== i && r.isArray(o) && (o = o[i]), void 0 !== o))
                            return o
                }
            }
        }, {
                ...
                var a,
                    ...
                    r = o.unit || function(t, e, i, n) {
                        ...
                        for (a = k.indexOf(t); a < s - 1; ++a)
                            if (r = (o = y[k[a]]).steps ? o.steps[o.steps.length - 1] : v, o.common && Math.ceil((i - e) / (r * o.size)) <= n)
                                return k[a];
                        return k[s - 1]
                    }(o.minUnit, t, e, i),
                    s = _(r),
            ...
            e.exports = function() {
                var t = n.extend({
                        ...
                        for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
                            if (s.isDatasetVisible(t))
                                if (a = s.data.datasets[t].data, m.isObject(a[0]))
                                    ...
                                    h.push.apply(h, g), f[t] = g.slice(0);
                            else
                                f[t] = [];
                    ...
                    getPixelForValue: function(t, e, i) {
                        var n = null;
                        if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = S(t, this)), null !== n)
