...
(function(J) {
    ...
    J.register("module", ["private", "modules.renderer.js-gradientlegend", function() {
        function a(d, h) {
            (function k(t, h) {
                var x,
                    p;
                for (p in t)
                    ka.call(t, p) && (x = t[p], void 0 === h[p] ? h[p] = x : "object" === typeof x && k(x, h[p]))
            })(d, h);
            return h
        }
        function c(d) {
        ...
        var Q = this,
            ...
            w = K.getLightColor,
            U = K.getValidColor,
            g = "rgba(192,192,192," + (n.isIE ? .002 : 1E-6) + ")",
            y,
            P = n.COLOR_BLACK,
            ka = {}.hasOwnProperty,
            d,
        ...
        y = function() {
            function d(k) {
                var q = h.numberFormatter,
                    x,
                    p,
                    G;
                x = 0;
                for (p = k.length; x < p; x++)
                    if (G = k[x].maxvalue)
                        k[x].maxvalue =
                        q.getCleanValue(G)
            }
            ...
            return {
                ...
                legacyDataParser: function(k, q) {
                    ...
                    g = 0;
                    for (f = G.length; g < f; g++)
                        u = G[g], a = c(u.code || u.color), y = U = u.maxvalue, isNaN(parseInt(y, 10)) || (U = (void 0 !==
        ...
        W.prototype.getLogicalSpace = function(d, h) {
            ...
            var G = {},
                ...
                b = 0;
            if (q && !h)
                return q.isImpure = !0, q;
            q = this._lSpace = x = this.getBoundingBox(d);
            if (e(q.x) || e(q.y) || e(q.height) || e(q.width))
                this.autoRecalculate = !0;
            q = a(x, {});
            q.height -= 2 * k.v;
            q.width -= 2 * k.h;
            q.x += k.h;
            q.y += k.v;
            for (u in t)
                O = t[u], k = a(q, {}), k.y += p, p = q.height * O.conf.spreadFactor, k.height = p + b, p = O.getLogicalSpace(a(k,
        ...
        W.prototype.draw = function(d) {
            var h = this.conf,
                q = this.compositionsByCategory,
                k = d.paper,
                t = d.parentGroup,
                O = d.componentPool,
                x,
                p,
                G = O.getChart().get("config", "animationObj").duration,
                u,
                b = O.getKeys();
            ...
            for (x in q)
                O = q[x], O.draw(h.captionAlignment, p, {
        ...
        S.prototype.getPostCalcDecisions = function(d, h) {
            var q = this.conf.padding,
                k = Number.NEGATIVE_INFINITY,
                t,
                O,
                x = this.moveInstructions;
        ...
        I.prototype.getLogicalSpace = function(d, h, q) {
            var k = this.conf.padding,
                t = this._lSpace,
                O = this.rawText,
                x = h.componentPool.getChart();
            if (t && !q)
                return t.isImpure = !0, t;
            t = this._lSpace = {
                bound: {
                    height: 0,
                    width: 0
        ...
        I.prototype.draw = function() {
            ...
            this.node = k({}, h).attr({
                text: p.smartText.text,
                x: O,
                y: p.logicArea.y +
                p.smartText.height / 2,
        ...
        B.prototype.getLogicalSpace = function(d, h, q) {
            ...
            g; b++)
                if (t = O[B.SC_STACK[b]])
                    x = G(x, t.conf.spreadFactor), x = t.getLogicalSpace(a(x, {}), h, q), u += this.getSpaceTaken(x);
            this.updateEffectivePlotArea(d, p, u);
            k.node.logicArea = p;
            return k.bound = d
        };
        B.prototype.draw = function() {
            var d = this.childTextConf,
                h = this.conf.bound.style || {},
                q = this.compositionsByCategory,
                k,
                t,
                O,
            ...
            p.parentLayer = d;
            x = 0;
            for (G = B.DARW_STACK.length; x < G; x++)
                (t = q[B.DARW_STACK[x]]) && t.draw(p);
            p.moveInstructions && d.attr({
                transform: p.moveInstructions
            });
            return {
                bound: h,
                group: d
        ...
        M.prototype.getLogicalSpace = function(d, h, q) {
            ...
            U = p;
            for (p = 1; p < t - 1; p++)
                b = P[p].label, n = P[p].oriIndex, w = void 0, g = p + 1 === t - 1 ? x : q[P[p + 1].oriIndex] * u.width / 100, y = q[P[p].oriIndex] *
        ...
        M.prototype.draw = function() {
            ...
            p = 0;
            for (O = x.length; p < O; p++)
                if (k = x[p])
                    G = t.y + k.height / 2, u = p === O - 1 ? t.x + k.x - k.width / 2 : p ? t.x + k.x : t.x + k.x + k.width / 2, this.node.push(b({}, d).attr({
                        text: k.text,
                        x: u,
                        y: G,
                        lineHeight: this._metaStyle.lineHeight,
        ...
        R.prototype.getLogicalSpace = function(d, h, q) {
            ...
            U = p;
            for (p = 1; p < t - 1; p++)
                b = P[p].label, n = P[p].oriIndex, w = void 0, g = p + 1 === t - 1 ? x : q[P[p + 1].oriIndex] * u.height / 100, y = q[P[p].oriIndex] * u.height / 100, g = Math.min(y - U, g - y), g > 2 * L.width && (w = h.getSmartText(b, g, u.width), w.y = q[n] * u.height / 100, U = g, G.push(w.height)), f[P[p].oriIndex] = w;
            G = Math.max.apply(Math, G);
            u.width = G;
            d.width = G + 2 * O.v;
            k.node.logicArea = u;
        ...
        function() {
            ...
            for (O = x.length; p < O; p++)
                if (k = x[p])
                    G = t.x + k.height / 2, u = p === O - 1 ? t.y + k.y - k.width / 2 : p ? t.y + k.y : t.y + k.y + k.width / 2, this.node.push(b({}, d).attr({
                        text: k.text,
                        x: G,
                        y: u,
                        lineHeight: this._metaStyle.lineHeight,
        ...
        r.prototype.getLogicalSpace = function(d, h, q) {
            ...
            L = G;
            for (G = 1; G < t - 1; G++)
                p = void 0, U = q[G].displayValue, b = G + 1 === t - 1 ? f : u[G + 1] * y.width / 100, g = u[G] * y.width / 100, b = Math.min(g - L, b - g), b > 1.5 * x.width && (p = h.getSmartText(U, 2 * b, y.height), p.x = u[G] * y.width / 100, L = b, w.push(p.height)), P[G] = p;
        ...
        r.prototype.draw = function() {
            ...
            for (p = k.length; q < p; q++)
                if (u = G[q])
                    k = x.y + u.height / 2, t = q === p - 1 ? x.x + u.x - u.width / 2 : q ? x.x + u.x : x.x + u.x + u.width / 2, b({}, O).attr({
                        text: u.text,
                        x: t,
                        y: k,
                        lineHeight: this._metaStyle.lineHeight,
        ...
        D.prototype.getLogicalSpace = function(d, h, q) {
            ...
            L = p;
            for (p = 1; p < x - 1; p++)
                t = void 0, y = q[p].displayValue, u = p + 1 === x - 1 ? f : G[p + 1] * g.height / 100, b = G[p] * g.height / 100, u = Math.min(b - L, u - b), u > 2 * U.height && (t = h.getSmartText(y, g.width, 2 * u), t.y = G[p] * g.height / 100, L = u, w.push(t.width)), P[p] = t;
            w = Math.max.apply(Math, w);
            g.width = w;
            d.width = w + 2 * O.h;
            k.node.logicArea = g;
        ...
        D.prototype.draw = function() {
            ...
            for (G = x.length; p < G; p++)
                if (x =
                O[p])
                    t = k.x + x.width / 2, u = p === G - 1 ? k.y + x.y - x.height / 2 : p ? k.y + x.y : k.y + x.y + x.height / 2, b({}, d).attr({
                        text: x.text,
                        x: t,
                        y: u,
                        lineHeight: this._metaStyle.lineHeight,
        ...
        v.prototype.getLogicalSpace = function(d, h, q) {
            ...
            var p = this.compositionsByCategory,
                G;
            G = 0;
            if (h && !q)
                return h.isImpure = !0, h;
            h = this._lSpace = {
                bound: {
                    height: 0,
                    width: 0
            ...
            O = x / 2;
            if (p = p.RANGE)
                G = p.sliders[!1], G = G.conf.outerCircle.rFactor * x, O += G = Math.max(G / 2 - x / 2, 0);
            q.y += G;
            q.height = x = O + k + G;
            d.height = x + 2 * t.v;
            h.node.logicArea = q;
        ...
        v.prototype.getDrawableAxisArea = function(d) {
            ...
            return {
                ...
                y: d.y,
                width: d.width,
                height: h.legendAxisHeight,
                r: h.legendAxisHeight / 2
            }
        };
        v.prototype.preDrawingRangeParam = function(d) {
            return {
                y: d.y + d.height / 2,
                calculationBase: d.height,
                rangeStart: d.x,
                rangeEnd: d.x + d.width,
                prop: "y"
            }
        };
        v.prototype.getScaleMarkerPathStr = function(d, h) {
            ...
            p = q.y + q.height;
            t = 0;
            for (O = h.length; t < O; t++)
                x = h[t], x = q.x + x * q.width / 100, G += "M" + x + "," + (p - k.grooveLength) + "L" + x + "," + (p + k.offset);
        ...
        A.prototype.getLogicalSpace = function(d, h, q) {
            ...
            b = x / 2;
            if (p = p.RANGE)
                G = p.sliders[!1], G = G.conf.outerCircle.rFactor * x, b += G = Math.max(G / 2 - x / 2, 0);
            q.x += G;
            q.width = x =
            b + k + G;
            d.width = x + 2 * t.v;
        ...
        A.prototype.getScaleMarkerPathStr = function(d, h) {
            ...
            for (x = h.length; t < x; t++)
                b = h[t], b = q.y + b * q.height / 100, G += "M" + (p - k.grooveLength) + "," + b + "L" + (p + k.offset) + "," + b;
        ...
        F.prototype.draw = function(d, h, q) {
            ...
            this.updateWhenInMove = function(k, t) {
                this.updateWhenInMove = function(d, q) {
                    var h = this.extremes,
                        h = this.getValueFormPixel(d.sliderIndex ? h[1] - h[0] + q : q);
        ...
        F.prototype.updateWhenInRest = function(d, h) {
            ...
            k = 0;
            for (t = x.length; k < t; k++)
                p = x[k], G = p.params.slice(0), G.unshift(this.getValueFormPixel(q)), G.unshift(this.getValueFormPixel(b)), p.fn.apply(p.context, G)
        };
        ...
        function(d) {
            ...
            Q.raiseEvent("legendpointerdragstart", {
                ...
                pointers: [{
                    value: this.getValueFormPixel(h[!1].currPos)
                }, {
                    value: this.getValueFormPixel(q[1] - q[0] + h[!0].currPos)
                }],
        ...
        F.prototype.dragCompleted = function(d, h, q) {
            var k = this.sliders,
                t = this.extremes,
                b = d.conf,
                x = this.getValueFormPixel(k[!1].currPos),
                k = this.getValueFormPixel(t[1] - t[0] + k[!0].currPos),
                p = this._fcChart,
                G;
        ...
        l.prototype.draw = function(d, h, q, k) {
            var t = k.parentLayer,
                ...
                x = b.outerCircle,
                p = b.innerCircle,
                G = Math.ceil(x.rFactor * k.rCalcBase / 2),
                u = Math.ceil(p.rFactor * k.rCalcBase / 2),
                f = G - u,
                w = this.rangeGroup,
                L = this.sliderIndex,
                a,
            ...
            t = this.node = y("fc-gl-slider", t).attr({
                cursor: "pointer",
                transform: "t0,0"
            });
        ...
        l.prototype.getDragAPI = function(d) {
            ...
            return {
                dragging: function(g, f) {
                    ...
                    y < w ? a += w - y : y > L && (a -= y - L);
                    q.attr({
                        transform: d ? "t0," + (h.currPos + a) : "t" + (h.currPos + a) + ",0"
                    });
                    x = a;
                    p && clearTimeout(p);
                ...
                dragStart: function(k) {
                    ...
                    k.preventDefault();
                    q.attr({
                        transform: d ? "t0," + h.currPos : "t" + h.currPos + ",0"
                    });
                    b = b || h.swing;
                    u = !1;
                    t.dragStarted(h)
        ...
        C.prototype.getValueRatio = function() {
            ...
            t = this.valueRatio = [];
            for (q = 0; q < k; q++)
                h = d[q], h = (h.value - b) / x, t.push(100 * (h - p)), p = h;
            return t
        };
        C.prototype.getCumulativeValueRatio = function() {
            var d = this.colorRange,
                ...
                x = [];
            for (q = 0; q < k; q++)
                h = d[q], x.push((h.value - t) / (b - t) * 100);
            return x
        };
        C.prototype.getBoxFill = function(d) {
            var h = this.colorRange,
                q,
                k = h.length,
                t = [],
                b;
        ...
        J.register("component", ["gradientLegend", "gradientLegend", {
            ...
            _configure: function() {
                var d = this._chart,
                    ...
                    q = this.conf = {},
                    k = h.outcnvbasefont,
                    t = h.outcnvbasefontsize,
                    g = h.outcnvbasefontcolor,
                    d = d.config.dataLabelStyle,
                    x,
                    p,
                    G,
                    u,
                ...
                q.sliderGroupConf = {
                    ...
                    outerCircle: {
                        rFactor: b(h.sliderdiameterfactor),
                        style: {
                    ...
                    innerCircle: {
                        ...
                        style: {
                            stroke: Z(z(h.legendpointercolor, "FFFFFF"), b(h.legendpointeralpha, 100))
                        }
                    }
                };
                q.legendCarpetConf = {
            ...
            getLogicalSpace: function(d) {
                var h = this.conf,
                    ...
                    k = this.drawOptions,
                    t = this._chart;
                if (!this._recalculateLogicalSpace)
                    return h = k.refSideKey, k = k.refOffsetKey, this.drawOptions.refSide = t.config[h], this.drawOptions.refOffset = t.config[k], (this._logicalArea = this.elem.gl.getLogicalSpace(this.drawOptions, !0)) || q;
                if (this._dontPlot)
                    return q;
    ...
    J.register("module", ["private", "modules.renderer.js-msstepline", function() {
        var a = this.hcLib,
            c = this.window,
            E = !a.CREDIT_REGEX.test(c.location.hostname),
            e = a.chartAPI,
            ba = a.pluckNumber,
            W = a.pluck,
            S = c.Image,
            ...
            A = c.hiddenStr,
            F = Math.max,
            l = a.TOUCH_THRESHOLD_PIXELS,
            C = a.CLICK_THRESHOLD_PIXELS,
            H = a.hasTouch ? l : C,
            Q = c.ROUND,
            n = c.miterStr;
        e("msstepline", {
        ...
        J.register("component", ["dataset", "MSStepLine", {
            ...
            _addLegend: function() {
                var b = this.config,
                    a = this.chart.components.legend,
                    f = ba(b.drawanchors, 1),
                    b = {
            ...
            draw: function() {
                ...
                var N,
                    ...
                    O = b.components.data,
                    x,
                    p = b.components.removeDataArr || [],
                    G = p.length,
                    u = m.linethickness,
                    da = b.graphics.container,
                    ma = ga.connectnulldata,
                    La = d.datasetGroup,
                    aa,
                    d = m.shadow,
                    db,
                    c = b.graphics.dataLabelContainer,
                    ta = {},
                    C,
                    e,
                    ta = f.get(R, r),
                    ...
                    Ra,
                    Va = y.getAxisBase(),
                    Va = y.yBasePos = y.getAxisPosition(Va),
                    Da = V.canvas.config.clip,
                    V = Da["clip-canvas-init"].slice(0),
                    Da = Da["clip-canvas"].slice(0),
                    J = m.lineDashStyle,
                    va = {
                        color: m.linecolor,
                        alpha: m.alpha
                    ...
                    ca = !1,
                    Aa,
                    ya = b.graphics.lineElement,
                    Y = b.visible,
                    ua = m.drawverticaljoins,
                    xa = m.useforwardsteps,
                    za,
                    Ga = ta.animType,
                    Ma = 0,
                    ra,
                    f = f.config.stepatmiddle ? .5 * g.getPVR() : 0,
                    Ba,
                    Ua = ga.canvasTop,
                    Ja = ga.canvasBottom;
                m.imagesLoaded = 0;
                ...
                for (w = 0; w < L; w++)
                    if (x = O[w])
                        e = x.config, q = e.setValue, h = e.setLink, k = e.setLevelTooltext, ta = e.anchorProps,
                        C = ta.symbol, db = ta.shadow, t = e.displayValue, T = x.graphics.element, za = x.graphics.image, P = x.graphics.hotElement, ka = x.graphics.label, x || (x = O[w] = {
                            graphics: {}
                        }), null === q ? (ha.length = 0, ma || (sa = null), T && T.hide(), za && za.hide(), ka && ka.hide(), P && P.hide()) : (qa = {
                            color: e.color,
                            alpha: e.alpha
                        ...
                        (za && za.hide(), q = [C[1] || 2, P, ka, ta.radius, ta.startAngle, ta.dip], h = {
                            ...
                            stroke: X({
                                color: ta.borderColor,
                                alpha: ta.borderAlpha
                            }),
                            "stroke-width": ta.borderThickness,
                            visibility: ta.radius ? Y : A
                        }, T || (E.element && E.element.length ? T = x.graphics.element = E.element.shift() : (T = x.graphics.element = U.polypath(da.anchorGroup), T.attr({
                            polypath: q
                        }))), T.show().animateWith(Qa, Ea, {
                            polypath: q
                        }, M, Ga, Na && ba), T.attr(h).shadow(db, da.anchorShadowGroup).data("hoverEnabled", aa.enabled).data("eventArgs",
                        k), Na = !1), db = x.graphics.connector, aa.enabled && (q = {
                            polypath: [aa.anchorSides || 2, P, ka, aa.anchorRadius, aa.startAngle, aa.dip],
                            fill: X({
                                color: aa.anchorColor,
                                alpha: aa.anchorBgAlpha
                            }),
                            stroke: X({
                                color: aa.anchorBorderColor,
                                alpha: aa.anchorBorderAlpha
                            }),
                        ...
                        P)), oa && (ia ? ea = ea.concat(la) : (db || (db = x.graphics.connector = U.path(la, da.lineGroup), ca = !0), db.animateWith(Qa, Ea, {
                            path: la
                        }, M, Ga, Na && ba), db.attr({
                            "stroke-dasharray": wa,
                            "stroke-width": u,
                        ...
                        }).shadow(Aa, da.lineShadowGroup), Na = !1), la = []), oa || db && db.hide()) : ha.push("M", P, ka), fa = P, sa = ka, Fa = X(qa || va), Aa = qa ? {
                            opacity: qa && qa.alpha / 100
                        } : d, wa = Ra || J, ia = void 0 === W(e.color, e.alpha, e.dashed) ? 1 : 0, oa = [Fa, wa].join(":"), x._xPos = P, x._yPos = ka, !ta.imageUrl && this.drawLabel(w));
                ...
                ya || (ya = b.graphics.lineElement = U.path({
                    path: ea
                }, da.lineGroup), ca = !0);
                ...
                for (w = 0; w < G; w++)
                    b._removeDataVisuals(p.shift());
                b.drawn = !0
            }
        }, B, {
            drawverticaljoins: void 0,
            useforwardsteps: void 0
        }])
    }]);
    J.register("module", ["private", "modules.renderer.js-powercharts", function() {
        ...
        c.addSymbol({
            resizeIcon: function(a, c, e) {
                ...
                for (e = 3; 0 < e; --e)
                    W.push("M", a - M * e, c - 3, "L", a - 3, c - M * e);
                return W
            },
        ...
        this.addEventListener("rendered", function(a) {
            a = a.sender;
            var c = a.__state,
                e = a.jsVars && a.jsVars.instanceAPI;
    ...
    ["private", "modules.renderer.js-spline", function() {
        var a = this.hcLib,
            c = Math.round,
            E = !a.CREDIT_REGEX.test(this.window.location.hostname),
            a = a.chartAPI;
        a("spline", {
            ...
            getSplineExtremities: function(a, c, E, S, I) {
                ...
                for (I = I || {
                    ...
                    if (X)
                        if (isNaN(a[S].config.setValue) || null === a[S].config.setValue) {
                            if (!E)
                                break
                        } else
                            B.push({
                        ...
                        isNaN(a[S].config.setValue) || null === a[S].config.setValue || (X = !0, B.push({
                            index: S,
                            y: a[S].config.setValue
                        }));
            ...
            evalSplineExtremities: function(a, E, W) {
                ...
                for (I = 0; 10 > I; ++I)
                    for (B = 0; B < a.length; ++B)
                        X = 0 === B ? (3 * (a[B + 1].y - a[B].y) - S["D" + a[B + 1].index]) / 2 : B === a.length - 1 ? (3 * (a[B].y - a[B - 1].y) - S["D" + a[B - 1].index]) / 2 : (3 * (a[B +
                        1].y - a[B - 1].y) - S["D" + a[B + 1].index] - S["D" + a[B - 1].index]) / 4, S["D" + a[B].index] = X;
                E = c(E / (a.length - 1));
                for (B = 1; B < a.length; ++B)
                    this.getSegmentExtremities(B, a, S, W, E)
            },
            getSegmentExtremities: function(a, c, E, S, I) {
                ...
                X = S.min;
                for (R = 0; R <= I; R++)
                    r = R / I, r = E + B * r + M * r * r + a * r * r * r, r < X && (X = r), r > c && (c = r);
                S.max = c;
                S.min = X
            }
        }, a.sscartesian, {
    ...
    function() {
        var a = this.hcLib,
            c = !a.CREDIT_REGEX.test(this.window.location.hostname),
            a = a.chartAPI;
        a("msspline", {
            standaloneInit: !0,
    ...
    J.register("module", ["private", "modules.renderer.js-multiaxisline", function() {
        var a = this.hcLib,
            ...
            W = ba.sStr,
            S = a.BLANKSTRING,
            I = a.parseUnsafeString,
            B = ba.defaultFontStr,
            X = a.pluckFontSize,
            M = ba.divLineAlphaStr,
            R = ba.divLineAlpha3DStr,
            r = a.componentDispose,
            D = a.chartPaletteStr = {
                chart2D: {
                    bgColor: "bgColor",
                    bgAlpha: "bgAlpha",
            ...
            c = !a.CREDIT_REGEX.test(c.location.hostname),
            v = a.graphics.convertColor,
            A = a.extend2,
            F = ba.altVGridColorStr,
            l = ba.configStr,
            C = ba.animationObjStr,
            H = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")",
            Q = a.toRaphaelColor,
            n = a.hasTouch,
            b = Math,
            z = b.max,
            f = b.min,
            K = ba.POSITION_BOTTOM,
            V = ba.colors.c000000,
            m = ba.altVGridAlphaStr,
            a = a.chartAPI;
        a("multiaxisline", {
            ...
            _createDatasets: function() {
                var b = this.components,
                    ...
                    d,
                    N,
                    T = this.defaultDatasetType,
                    h = this.applicableDSList,
                    q = b.legend.components.items || [],
                    k,
                    t,
                    O,
                    x,
                    p = this.config.isstacked,
                    G,
                    u = {},
                    da = 0,
                    ma;
                if (w) {
                    ...
                    for (g = 0; g <
                    U; g++)
                        if (y = w[g].dataset, ma[g] = [], y)
                            for (N = y.length, n += N, a = 0; a < N; a++)
                                if (x = y[a], x.seriesname && (x.seriesname = I(x.seriesname)), d = x.parentyaxis || S, t = (t = this.isDual && d.toLowerCase() === W ? E(x.renderas, this.sDefaultDatasetType) : E(x.renderas, T)) && t.toLowerCase(), h[t] || (t = T), d = J.get("component", ["dataset", t]))
                                    void 0 === u[t] ? u[t] = 0 : u[t]++, G = "datasetGroup_" + t, O = J.register("component", ["datasetGroup", t]), k = b[G], O && !k && (k = b[G] = new O, k.chart = this, k.init()), f[da] ? (d = f[da], k = d.JSONData, k = k.data ? k.data.length : 0, t = x.data ?
            ...
            _createAxes: function() {
                var b = this.components,
                    a = J.register("component", ["axis", "cartesian"]);
                b.yAxis = [];
                b.xAxis = [];
                b.xAxis[0] = b = new a;
                b.chart =
            ...
            _feedAxesRawData: function() {
                ...
                var d = J.register("component", ["axis", "cartesian"]),
                    N,
                    T,
                    h,
                    q,
                ...
                for (h = N.length; T < h; T += 1) {
                    ...
                    y = !1;
                    da = 0;
                    for (q = k.dataset ? k.dataset.length : 0; da < q; da += 1)
                        0 !== Number(k.dataset[da].visible) && (y = !0);
                    da = e(k.showaxis, 1);
                    q = f.getPlotColor(T);
                ...
                T = ma;
                for (h = b.yAxis.length; T < h; T += 1)
                    b.yAxis[T].hide()
            },
            _setAxisLimits: function() {
                var b = this.components,
                    a = this.config.axisDataSetMap,
                    L = b.dataset,
                    b = b.yAxis,
                    w = a.length,
                    U,
                ...
                for (U = 0; U < w; U += 1) {
                    n = 0;
                    for (r = a[U].length; n < r; n += 1)
                        d = L[a[U][n]].getDataLimits(), g = z(g, d.max), y = f(y, d.min);
                    Infinity === y && (y = 0);
                    -Infinity === g && (g = y + 1);
            ...
            _spaceManager: function() {
                ...
                var y = g.xAxis;
                b = g.yAxis;
                var n = this.hasLegend,
                    r = w.yDepth;
                a = g.legend;
                var d = w.axesPadding,
                    N = 0,
                    T = 0,
                    h = w.axisDataSetMap.length,
                    q,
                    k,
                    t,
                    O = this.jsonData.chart,
                    x = e(O.showborder, this.is3D ? 0 : 1),
                    g = g.canvas.config.canvasBorderWidth;
                q = w.borderWidth = x ? e(O.borderthickness, 1) : 0;
                var p = w.canvasMarginTop,
                    G = w.canvasMarginBottom,
                    u = w.canvasMarginLeft,
                    O = w.canvasMarginRight,
                    da = w.height,
                    x = w.width;
                this._allocateSpace({
                    top: q,
                ...
                this._allocateSpace({
                    left: w.canvasMarginLeft,
                    right: w.canvasMarginRight
                });
                q = U.axesMap;
                k = U.leftAxes;
                U = U.rightAxes;
                ...
                for (n = 0; n < h; n += 1)
                    0 !== q[n].showaxis && (a = .7 * w.canvasWidth, a = b[n].placeAxis(a),
            ...
            _postSpaceManagement: function() {
                var b = this.config,
                    ...
                    U = b.xDepth,
                    g = a.canvas.config,
                    a = g.canvasBorderWidth,
                    y = g.canvasPadding,
                    n = g.canvasPaddingLeft,
                    g = g.canvasPaddingRight;
            ...
            _resuffelAxis: function() {
                ...
                if ("l" === b.position) {
                    ...
                    if (f.leftSideSelected && void 0 === g)
                        return;
            ...
            _dolegendInteraction: function(b, a) {
                var f = a.components.dataset,
                    w = a.components.legend,
                    U;
                if (this.checked)
                    for (U in f)
                        f.hasOwnProperty(U) && (f[U].visible || f[U].axisIndex !==
                        b || f[U].show());
                else
                    for (U in f)
                        f.hasOwnProperty(U) && f[U].visible && f[U].axisIndex === b && f[U].hide();
                w.drawLegend()
            },
            _drawAxis: function(b) {
                var a = this.config,
                    ...
                    P = a.allowAxisShift,
                    r = a.allowSelection,
                    d = this.graphics.axisHotElement || [],
                    N = this.graphics.trackerContainer,
                    T = this.graphics.buttonGroup,
                    h = w.canvas.config,
                    q = h.canvasBorderWidth,
                    k = h.canvasPaddingTop,
                    h = h.canvasPaddingBottom,
                    t = a.axesPadding,
                    O = this.components.tb,
                    x = 0,
                    p = 0,
                    G = 0,
                    u,
                ...
                F = f.checkBox;
                for (z in F)
                    F.hasOwnProperty(z) && F[z].checkbox.hide();
                v = {
                    cursor: "col-resize",
                    stroke: H,
                    fill: H,
                ...
                for (z = aa.length - 1; 0 <= z; --z)
                    if (0 !== aa[z].showAxis && (u = a.canvasLeft -
                    ...
                    }), D ? c.checkbox.node.animateWith(W, X, {
                        transform: "t" + B + "," + E
                    }, D, A) : c.checkbox.node.attr({
                        transform: "t" + B + "," + E
                    })) : (c = F[e] = {}, c.checkbox = new V(S, !0, I++, O.pId), c.checkbox.conf = K.getDefaultConfiguration(), c.checkbox.attachEventHandlers({
                        click: {
                            fn: this._dolegendInteraction,
                            args: [e, this]
                        }
                    }), c.checkbox.draw(u - m, da + ma + 4, {
                        parentLayer: T
                    }), c.checkboxPrePos = {
                        x: u - m,
                        y: da + ma + 4
                    ...
                    (aa[z].checkBoxChecked ? c.checkbox.check() : c.checkbox.uncheck())), P)) {
                        ...
                        v.height = ma;
                        if (d[G])
                            for (ma = d[G].attr(v), ma.show(), u = 0, da = ma.events.length; u < da; u++)
                                ma.events[u].unbind(), ma.events.splice(u, 1), --da;
                        else
                            ma = d[G] = y.rect(v, N);
                        ma.data("axisDetails", {
                            iapi: this,
                ...
                z = 0;
                for (x = w.length; z < x; z += 1)
                    if (0 !== w[z].showAxis && (e = w[z].index, c = U[e], u = a.canvasRight + q + p + t, da = a.canvasTop + k, ma = a.canvasHeight -
                    ...
                    D ? c.checkbox.node.animateWith(W, X, {
                        ...
                        "stroke-width": [1, 2]
                    }), a.axisConfigured && (w[z].checkBoxChecked ?
                ...
                z = G;
                for (x = d.length; z < x; z += 1)
                    d[z].hide();
                if (!b)
                    for (z = 0, x = g.length; z < x; z++)
                        g[z].draw();
                z = 0;
                for (x = U.length; z < x; z++)
                    U[z].draw();
                a.axisConfigured = !1
            }
        }, a.mscartesian, {
    ...
    J.register("module", ["private", "modules.renderer.js-multilevelpie", function() {
        ...
        c("multilevelpie", {
            ...
            _createDatasets: function() {
                ...
                (a.dataset = []);
                for (a = 0; a < M; a += 1)
                    if (c = E[a], c.seriesname && (c.seriesname = e(c.seriesname)), r = c.parentyaxis || ba, r = (r = r.toLowerCase() === W ? S(c.renderas, this.sDefaultDatasetType) : S(c.renderas, D)) && r.toLowerCase(), v[r] || (r = D), A = J.get("component", ["dataset", r]))
                        void 0 === F[r] ? F[r] = 0 : F[r]++, R[0] ? (r = R[0], r.JSONData = c) : (r = new A, R.push(r), r.chart = this, r.index = a), r.init(E)
            },
            _spaceManager: function() {
                var a = this.config;
    ...
    J.register("module", ["private", "modules.renderer.js-dragbase", function() {
        var a = this,
            ...
            f = ba.max,
            K = c.hasTouch,
            V = c.graphics.convertColor,
            m = c.chartAPI,
            Z = a.xssEncode,
            ga = c.createElement;
        m("dragbase", {
            configure: function() {
                var b = this.jsonData.chart,
                    f,
                    n;
            ...
            _createToolBox: function() {
                var b = this,
                    w = b.components.tb || (b.components.tb = new (J.register("component", ["toolbox", "toolbox"]))),
                    n,
                    g,
                    y,
                    P = b.components,
                    ...
                    p = h.restoreBtnStyle,
                    G = h.restoreBtnWidth,
                    u = h.restoreBtnBgColor,
                    da = h.restoreBtnBorderColor,
                    ma = h.formBtnBgColor,
                    r = h.formBtnBorderColor,
                    aa = h.restoreBtnLabelFill,
                    l = h.formBtnLabelFill,
                    v = h.btnSpacing,
                    K = h.btnPadding,
                    Z = h.formBtnWidth;
                n = P.chartMenuBar;
            ...
            addConfigureOptions: function() {
                var b = this,
                    ...
                    g = r(b.jsonData.chart.allowaxischange, 1),
                    a = a.set,
                    y = [{
            ...
            drawAxisUpdateUI: function() {
                var a = this,
                    f = a.graphics,
                    U = a.components.yAxis[0],
                    g = U.config.axisRange,
                    y = U.getAxisConfig("extremeLabels") || [],
                    U = a.config,
                    P = g.min,
                    g = g.max,
                    z = y.lastLabel.graphic,
                    d = y.firstLabel.graphic,
                    N = a.linkedItems.container,
                    y = Q({
                        outline: "none",
                    ...
                    Z;
                for (Z in P)
                    if (h = P[Z], g = h.label, z = h.value, h.oldValue = z, q = g && g.getBBox(), h = "max" === Z ? !0 : !1, f.inputElements || (f.inputElements = {}), k = f.inputElements[Z], q && g) {
            ...
            changeUpperLimits: function(b) {
                var a = this.components,
                    f = a.yAxis[0],
                    g = f.config.axisRange,
                    y = g.min,
                    n = g.max,
                    c = this.config.yMax,
                    g = !1,
                    d = this.graphics.hiddenAxisLabels || [],
                    z = d.length;
            ...
            changeLowerLimits: function(b) {
                var a = this.components,
                    ...
                    z,
                    d = !1,
                    N = this.graphics.hiddenAxisLabels ||
                    [],
                    r = N.length,
                    g = g.min;
            ...
            eiMethods: {
                getDataWithId: function() {
                    for (var b = this.jsVars.instanceAPI.getJSONData(), a = [[B]], f = b.dataset, b = b.categories && b.categories[0] && b.categories[0].category, g = f && f.length || 0, n = 0, c, z, d, N, r, h; g--;)
                        if (z = f[g])
                            for (a[0][g + 1] = z.id || z.seriesname, N = z.id || g + 1, h = (z = z.data) && z.length || 0, r = 0; r < h; r += 1) {
                                d = r + 1;
                                if (!a[d]) {
                                    for (c = b && b[r + n] || {}; c.vline;)
                                        n += 1, c = b[r + n] || {};
                                    c = c.label || c.name || B;
                                    a[d] = [c]
                                }
                ...
                getData: function(b) {
                    var f = this.jsVars.instanceAPI,
                        ...
                        g = [[B]],
                        y = n.dataset,
                        c = n.categories && n.categories[0] && n.categories[0].category,
                        z = y && y.length || 0,
                        d = 0,
                        r,
                        m;
                    if (b)
                        g = /^json$/ig.test(b) ? n : a.core.transcodeData.call(f.chartInstance, n, "json", b);
                    else
                        for (; z--;)
                            if (b = y[z])
                                for (g[0][z + 1] = y[z].seriesname, f = (b = y[z] && y[z].data) && b.length || 0, n = 0; n < f; n += 1) {
                                    m = n + 1;
                                    if (!g[m]) {
                                        for (r = c && c[n + d] || {}; r.vline;)
                                            d += 1, r = c[n + d] || {};
                                        r = r.label || r.name || B;
                                        g[m] = [r]
                                    }
                ...
                setUpperLimit: function(b, a) {
                    var f = this.apiInstance,
                        g = f.getJobList(),
                        n,
                        c = f.chartInstance.args.asyncRender;
                    if (a || c)
                        g.eiMethods.push(C.addJob(function() {
                            n = f.changeUpperLimits(b);
                            "function" === typeof a && a(n)
                        }, H.postRender));
                    else
                        return f.changeUpperLimits(b)
                },
                ...
                getLowerLimit: function(b) {
                    ...
                    if (g)
                        if (b)
                            a.eiMethods.push(C.addJob(function() {
                                b(g.config.axisRange.min)
                            }, H.postRender));
                        else
                            return g.config.axisRange.min
                },
            ...
            submitData: function(b) {
                var a = this.chartInstance,
                    f = new b.ajax,
                    g = this.config,
                    n = b.dataFormats.JSON,
                    z = b.dataFormats.CSV,
                    r = b.dataFormats.XML,
                    d = g.formAction,
                    N = this.chartInstance,
                    m = g.submitFormAsAjax,
                    h,
                    q,
                    k,
                    t,
                ...
                b.raiseEvent("beforeDataSubmit", {
                    ...
                    b.raiseEvent("dataSubmitCancelled", {
                        data: q
                    }, N)
                })
            },
            getJSONData: function() {
                var b = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(),
                    a = this.components,
                    f = a["datasetGroup_" + b],
                    b = a.dataset,
                    g = this.jsonData.dataset,
                    n,
                    c = this.jsonData,
                    z = b.length,
                    a = [],
                ...
                if (f && f.getJSONData)
                    ...
                    for (f = 0; f < z; f++)
                        n = b[f], d = n.getJSONData(), n = g[f] || {}, delete n.data,
                        a.push(D(n, d));
                b = D({}, c);
                b.dataset = a;
                return b
            ...
            _setDataLimits: function() {
                ...
                c = b.length;
                for (r = 0; r < c; r++)
                    y = b[r], y = y.getDataLimits(), n = f(n, y.max), g = z(g, y.min);
                a.yMax = n;
                a.yMin = g
            },
            _mouseEvtHandler: function(b) {
                var a = b.data.mouseTracker,
                    f = this.config,
                    g = f.canvasLeft,
                    n = f.canvasRight,
                    z = f.canvasBottom,
                    r = f.canvasTop,
                    d = f.datasetOrder || this.components.dataset,
                    N = c.getMouseCoordinate(this.linkedItems.container, b.originalEvent, this),
                    m = N.chartX,
                    h = N.chartY,
                    q,
                    k,
                    ...
                    O = d.length,
                    x,
                    p = a._lastDatasetIndex,
                    N = a._lastPointIndex,
                    G,
                    f = f.dragTolerance || 0;
                void 0 !== N && (G = d[p].components.data[N].config.dragStart);
                if (!G && m > g - f && m < n + f && h > r - f && h < z + f || !G && this.config.plotOverFlow)
                    for (; O-- && !t;)
                        (q = d[O]) && q.visible && (k = q._getHoveredPlot && q._getHoveredPlot(m, h)) && k.hovered && (t = !0, k.datasetIndex = O, x = a._getMouseEvents(b, k.datasetIndex, k.pointIndex));
                ...
                if (t)
                    for (d = x.events && x.events.length, a._lastDatasetIndex = k.datasetIndex, N = a._lastPointIndex = k.pointIndex, a = 0; a < d; a += 1)
                        q && q._firePlotEvent && q._firePlotEvent(x.events[a], N, b)
            }
        }, m.mscartesian)
    }]);
    J.register("module", ["private", "modules.renderer.js-dragnode", function() {
        var a = this,
            ...
            W = c.pluckNumber,
            S = c.extend2,
            I = c.componentDispose,
            B = Math,
            X = B.min,
            M = B.max,
            B = !c.CREDIT_REGEX.test(a.window.location.hostname),
            R = c.chartAPI;
        R("dragnode", {
            ...
            _createDatasets: function() {
                var a = this.config,
                    ...
                    w;
                ga = 0;
                var U = a.datasetMap || (a.datasetMap = {
                        connectors: [],
                        dragnode: [],
                        labels: []
                    }),
                ...
                if (A) {
                    ...
                    for (b = 0; b < C; b++)
                        c = "dragnode", f = U[c], g = f[0], void 0 === P[c] ? P[c] = 0 : P[c]++, g ? (K = A[b], L = g.components && g.components.data || [], y[c].push(g), z.push(g), L = L.length, w = K && K.data && K.data.length || 0, L > w && g.removeData(w - 1, L - w), g.JSONData = K, g.configure(), f.shift()) : (K = A[b], f = new V, f.chart = this, y[c].push(f), z.push(f), f.chart = this, f.index = b, f.init(K), v.addDataset(f, b)), ga++;
                    for (b = 0; b < H; b++)
                        c = "connectors", C = e[b], f = U[c], g = f[0], void 0 === P[c] ? P[c] = 0 : P[c]++, g ? (L = g.components && g.components.data || [], L = L.length, w = C.connector &&
                    ...
                    for (A in U)
                        if (f = U[A],
                        l = f.length, ga = P[A] || -1, l)
                            for (e = 0; e < l; e++)
                                "dragnode" === A ? (v.removeNodeDataset(ga), v._clearConnectors(), n.removeItem(f[e].legendItemId)) : "connectors" === A ? v.removeConnectorSet(ga) : v.removeLabelSet(ga), I.call(f[e]), ga += 1;
                    a.datasetMap = y
                } else
                    this.setChartMessage()
            },
            addConfigureOptions: function() {
                var a = this.chartMenuTools,
                    c = this.components,
                    v = c.actionBar,
                    A = this.components["datasetGroup_" + this.defaultDatasetType],
                    c = (c.chartMenuBar || v).componentGroups[0].symbolList[0].getListRefernce(),
                    a = a.set,
            ...
            _redrawDragNode: function(a, e) {
                var v = this.chart;
                this.draw();
                c.raiseEvent("chartUpdated", S({
                    sourceEvent: e
                }, a), v.chartInstance, [v.chartInstance.id])
            },
            addNode: function(c) {
                var e = this.components.dataset,
                    v = c.datasetId,
                    A = e.length,
                    F,
                    l,
                    ...
                    H;
                for (H = 0; H < A; H++)
                    if (F = e[H] || {}, C = F.config && F.config.id, void 0 !== C && (C = C.toString()), C === v) {
                        l = !0;
                        break
                    }
            ...
            updateNode: function(c) {
                ...
                c.update = !0;
                for (Q = 0; Q < A; Q++)
                    for (C = v[Q].dataset, n = C.components.data || [], F = n.length, b = 0; b < F; b++)
                        if (H = n[b], H.config.id === c.id) {
                            l = !0;
                            break
                        }
                C && l && (v = {
            ...
            deleteNode: function(r) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType].nodes,
                    v = e[r],
                    A,
                    F,
                    l,
                ...
                if (v) {
                    ...
                    if (!0 === H) {
                        ...
                        z(F);
                        for (n in l)
                            H = l[n] || {}, F = H.graphics, z(F), delete H.graphics,
                            H.removed = !0;
                        for (n in C)
                            H = C[n] || {}, F = H.graphics, z(F), delete H.graphics, H.removed = !0;
                        delete e[r];
                        Q.removed = !0;
                        r = Q.config || {};
                        A = {
                        ...
                        }, A), this.chartInstance, [this.chartInstance.id]);
            ...
            editConnector: function(c) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType],
                    ...
                    K = F.length;
                for (l = 0; l < K; l++)
                    for (H = (f = F[l].connectors) && f.components.data || [], C = H.length, b = 0; b < C; b++)
                        if (Q = H[b], n = Q.config, Q = n.from, n = n.to, Q === v && n === A) {
                            z = !0;
                            break
                        }
                c.update = !0;
            ...
            deleteConnector: function(r) {
                var e = r.from;
                r = r.to;
                var v = this.components["datasetGroup_" + this.defaultDatasetType].connectorSet,
                    A,
                    F,
                    l,
                    C,
                    ...
                    n = v.length;
                for (A = 0; A < n; A++)
                    for (F = v[A].connectors, C = F.components.data, H = C.length, F = 0; F < H; F++)
                        if (l = C[F], l.config.from === e && l.config.to === r) {
                            Q = !0;
                            break
                        }
                if (Q) {
                    ...
                    }, e), this.chartInstance, [this.chartInstance.id]);
            ...
            deleteLabel: function(r) {
                ...
                var e,
                    v;
                if (e = r.graphics.element)
                    v = e.data("eventArgs"), e.remove(), delete r.graphics;
                c.raiseEvent("chartUpdated", S({
                    sourceEvent: "labeldeleted"
                }, v), this.chartInstance, [this.chartInstance.id]);
                ...
                var a = this.components["datasetGroup_" + this.defaultDatasetType],
                    ...
                    n = function(b) {
                        ...
                        for (a = 0; a < b.length; a++)
                            if (C = b[a], delete C.removed, C.config.add)
                                for (f in H = b[a].graphics, H)
                                    H[f].remove()
                    };
                for (F = 0; F < e.length; F++)
                    l = e[F].dataset, a = l.components.data, n(a), l.drawn = !1, l.configure();
                for (F = 0; F < A.length; F++)
                    l = A[F].connectors, a = l.components.data, n(a), l.drawn = !1, l.configure();
            ...
            getJSONData: function() {
                var a = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(),
                    c = this.components,
                    e = c["datasetGroup_" + a],
                    a = c.dataset,
                    A = this.jsonData,
                ...
                if (e)
                    ...
                    for (e = 0; e < F; e++)
                        l = a[e], l = l.getJSONData(), c.push(l);
                a = S({}, A);
                a.dataset =
                c.dataset;
            ...
            _setCategories: function() {
                var a = this.jsonData,
                    ...
                    a = a.categories && a.categories[0].category || [],
                    e = a.length,
                    A = [],
                    F,
                    l;
                for (F = 0; F < e; F++)
                    l = a[F] || {}, void 0 !== l.x && A.push(l);
                c && c[0].setCategory(A)
            },
            ...
            _setAxisLimits: function() {
                var a = this.components,
                    c = this.jsonData,
                    c = c.categories && c.categories[0].category || [],
                    v,
                    A = a.dataset,
                    F = a.yAxis,
                    a = a.xAxis,
                ...
                for (H = 0; H < C; H++)
                    l = A[H], (v = l.groupManager) ? V[l.type] = v : m.push(l);
                for (v in V)
                    A = V[v].getDataLimits(), Z(A);
                C = m.length;
                for (H = 0; H < C; H++)
                    A = m[H].getDataLimits(), Z(A);
                -Infinity === Q && (Q = 0);
                Infinity === n && (n = 0);
                this.config.yMax = Q;
                this.config.yMin = n;
                F[0].setAxisConfig({
                    isPercent: this.isStacked ? this.config.stack100Percent : 0
                });
                F[0].setDataLimit(Q, n);
                if (-Infinity !== z || Infinity !== b) {
                    H = 0;
                    for (C = c.length; H < C; H++)
                        if (v = c[H], v = v.x)
                            v < b && (b = v), v > z && (z = v);
    ...
    J.register("module", ["private", "modules.renderer.js-selectscatter", function() {
        var a = this,
            ...
            E = a.window,
            e =
            !c.CREDIT_REGEX.test(E.location.hostname),
            ba = c.getValidValue,
            W = c.extend2,
            S = c.toRaphaelColor,
            I = c.preDefStr,
            ...
            F = I.hiddenStr,
            R = I.visibleStr,
            l = 8 === E.document.documentMode ? R : X,
            C = I.configStr,
            H = "rgba(192,192,192," + (c.isIE ? .002 : 1E-6) + ")",
            Q = c.chartAPI;
        Q("selectscatter", {
            isXY: !0,
            hasLegend: !0,
            ...
            getData: function(n) {
                var b = this.getCollatedData(),
                    ...
                    Z;
                if (n)
                    c = /^json$/ig.test(n) ? b : /^csv$/ig.test(n) ? this.getCSVString() : a.core.transcodeData(b, "json", n);
                else
                    for (; e < l; e += 1)
                        if (b = f[e]) {
                            for ((Z = n = (b = f[e] && f[e].data) && b.length || 0) && (c[m] || (c[m] = [ba(f[e].id, "null")])); Z--;)
                                c[m][Z +
                                1] = ba(b[Z].id, "null");
                            n && (m += 1)
                        }
            ...
            getCSVString: function() {
                for (var a = this.getData(), b = a.length; b--;)
                    a[b] = a[b].join(",");
                return a.join("|")
            },
            getCollatedData: function() {
                for (var c = this.components.dataset, b = this.config._selectEleArr, z = b && b.length, f = W({}, this.chartInstance.getChartData(a.dataFormats.JSON)), l = f.dataset, e, m, Z, r, L, w, U, g, y, P = []; z--;)
                    if (e = b[z])
                        for (w = e.startX, U = e.endX, g = e.startY, y = e.endY, r = l.length; r--;)
                            if (c[r].visible)
                                for (P[r] || (P[r] = {
                                    data: []
                                }), L = (Z = l[r].data) && Z.length; L--;)
                                    m = Z[L],
                                    e = m.x, m = m.y, e > w && e < U && m < g && m > y && (P[r].data[L] = !0);
                for (r = l.length; r--;)
                    for (L = (Z = l[r].data) && Z.length; L--;)
                        P[r] && P[r].data[L] || Z.splice(L, 1);
            ...
            createSelectionBox: function(a) {
                ...
                var L = m + v,
                    ...
                    y = b.graphics.trackerGroup,
                    P = e._selectEleArr || (e._selectEleArr = []);
                g.index = P.length;
                ...
                g.selectBoxTracker.data(C, {
                    position: 6,
                    selectEleObj: g,
                    xChange: !0,
                    yChange: !0
                });
                g.topTracker = f.rect(m, Z - 6, v, 12, y).attr({
                    "stroke-width": 0,
                    ishot: !0,
                    fill: H
                }).css("cursor",
            ...
            _deleteAllSelection: function() {
                var a = this.config._selectEleArr,
                    b,
                    c,
                    f,
                    e;
                for (f in a)
                    if (a.hasOwnProperty(f)) {
                        b = a[f];
                        for (e in b)
                            b.hasOwnProperty(e) && (c = b[e], c.remove && c.remove(), delete b[e]);
                        delete a[f]
                    }
            },
            deleteSelection: function(c, b) {
                var z = c.data(C).index,
                    f = b.components,
                    e = b.config._selectEleArr,
                    l = e[z],
                    m,
                    r;
                ...
                for (m in l)
                    l.hasOwnProperty(m) && (f = l[m], f.remove && f.remove(), delete l[m]);
                delete e[z];
                a.raiseEvent("selectionRemoved", r, b.chartInstance)
            },
            bindDragEvent: function(a) {
                for (var b in a)
                    /Tracker/.test(b) && a[b].drag(this.move, this.start, this.up)
            },
            start: function() {
                var a =
                    this.data(C).selectEleObj,
                    b = a.topTracker,
                    c = a.rightTracker,
                    f = a.bottomTracker,
                    e = a.leftTracker,
                    ...
                    L = e.data(C),
                    w = l.data(C),
                    U = a.selectBoxTracker.data(C),
                    g = a.selectBoxTracker.getBBox();
                m.ox = g.x;
                m.oy = g.y;
                r.ox = g.x2;
                r.oy = g.y;
            ...
            submitData: function() {
                var n = this.chartInstance,
                    b = new a.ajax,
                    z = this.config,
                    f = a.dataFormats.JSON,
                    e = a.dataFormats.CSV,
                    l = a.dataFormats.XML,
                    m = z.formAction || "",
                    r = z.submitFormAsAjax,
                    v,
                    L,
                    w,
                    U,
                ...
                a.raiseEvent("beforeDataSubmit", {
                    ...
                    a.raiseEvent("dataSubmitCancelled", {
                        data: L
                    }, n)
                })
            },
    ...
    J.register("module", ["private", "modules.renderer.js-candlestick", function() {
        var a = this.hcLib,
            ...
            E = a.chartAPI,
            e = a.pluck,
            ba = a.graphics.convertColor,
            W = a.preDefStr,
            S = W.altHGridColorStr,
            I = W.altHGridAlphaStr,
            B = a.parseUnsafeString,
            X = W.column,
            M = a.componentDispose,
            R = W.volume,
            r = a.POSITION_RIGHT,
            D = Math,
            v = D.max,
            ...
            Q = W.miterStr,
            n = a.toRaphaelColor,
            b = W.divLineAlpha3DStr,
            z = W.defaultFontStr,
            f =
            a.pluckFontSize,
            K = W.divLineAlphaStr,
            V = W.altVGridColorStr,
            m = W.altVGridAlphaStr,
            Z = D.min,
            ga = W.colors.c000000,
            L = a.BLANKSTRING,
            w = a.chartPaletteStr = {
        ...
        E("candlestick", {
            ...
            init: function(b, a, f, d) {
                ...
                g.canvasVolume = g.canvasVolume || (g.canvasVolume = {
                    graphics: {},
                    config: {}
                });
            ...
            _createDatasets: function() {
                var b = this.config,
                    ...
                    d = f.dataset,
                    g = f.trendset || [],
                    c = this.config.showVolumeChart,
                    h = d && d.length,
                    q,
                    k,
                    t = this.defaultDatasetType,
                    O =
                    e(B(f.chart.plotpriceas), X),
                    x,
                    p,
                    G,
                    u,
                ...
                if (d) {
                    ...
                    for (h = d.length; f < h; f++)
                        G = d[f], G.seriesname && (G.seriesname = B(G.seriesname)), x = (x = e(G.renderas, t)) && x.toLowerCase(), p = J.get("component", ["dataset", x]), aa = z[x], k = aa[0], p && (void 0 === m[x] ? m[x] = 0 : m[x]++, k ? (u = k, k.index = f, O !== u.config.plotType ? (M.call(u), k = q[w] = new p, k.chart =
                    ...
                    for (h = g.length; f < h; f++)
                        G = g[f], x = "trendset", aa = z[x], k = aa[0], void 0 === m[x] ? m[x] = 0 : m[x]++, k ? (u = (u = k.JSONData) && u.data && u.data.length, n = G.data && G.data.length, l[x].push(k), q.push(k), k.index = w, u > n && k.removeData(n - 1, u - n, !1), k.JSONData = G, k.configure(), aa.shift()) : (p = J.get("component", ["dataset", x]), a = new p, q.push(a),
                        l[x].push(a), a.chart = this, a.index = w, a.init(G)), w++;
                    for (d in z)
                        if (aa = z[d], h = aa.length)
                            for (g = 0; g < h; g++)
                                L.removeItem(aa[g].legendItemId), M.call(aa[g]);
                    b.datasetMap = l
                } else
                    this.setChartMessage()
            },
            _spaceManager: function() {
                ...
                var O = g.legend,
                    x,
                    p = this.config.showVolumeChart,
                    G = p ? d.volumeHeightPercent : 0,
                    u = g.canvas.config,
                    n = g.canvasVolume.config,
                    w =
                    d.width,
                    z = d.height,
                    aa = {};
                ...
                x = d.minCanvasHeight;
                f = d.minCanvasWidth;
                var e = d.canvasMarginLeft,
                    m = d.canvasMarginRight,
                    l = d.canvasMarginTop,
                    L = d.canvasMarginBottom,
                    U,
                    H,
                    Z = d.origCanvasTopMargin,
                    Q = d.origCanvasBottomMargin,
                    V = d.origCanvasLeftMargin,
                ...
                this._manageChartMenuBar(f);
                this._allocateSpace({
                    top: d.canvasMarginTop,
                    bottom: d.canvasMarginBottom
                });
                f = .3 * d.canvasHeight;
                c = h.placeAxis(f);
            ...
            _postSpaceManagement: function() {
                var b = this.components,
                    ...
                    h = b.canvas.config,
                    q = b.legend,
                    b = b.canvasVolume.config,
                    k = h.canvasBorderWidth;
                f && f.setAxisDimention({
                    x: h.canvasLeft,
                    y: h.canvasY,
                ...
                d && d.setAxisDimention({
                    ...
                    k,
                    y: h.canvasTop,
                    opposite: h.canvasRight + k,
                    axisLength: h.canvasHeight
                });
            ...
            _drawCanvas: function() {
                var b = this.components,
                    ...
                    g = b.canvas.config,
                    c = g.clip || (g.clip = []),
                    h = b.canvasVolume.config,
                    q = d.graphics,
                    b = b.canvasVolume.graphics,
                    k = d.config,
                    t = q.topCanvas,
                    O = q.topCanvasBorderElement,
                    d = b.volumeCanvas,
                    x = g.canvasLeft,
                    p = g.canvasTop,
                    G = g.canvasWidth,
                    ...
                    h = h.canvasHeight,
                    a = a.canvasGroup,
                    w = k.canvasBorderRadius,
                    z = k.canvasBorderWidth,
                    e = .5 * z,
                    aa = k.canvasBorderColor,
                    m = this.get(l, C),
                    L = m.dummyObj,
                    U = m.animObj,
                    r = m.animType,
                    m = m.transposeAnimDuration,
                    Z,
                    A = this.config.showVolumeChart,
                    V = k.shadow,
                    K = k.shadowOnCanvasFill,
                    k = k.canBGColor;
                Z = {
                    x: x - e,
                    y: p - e,
                ...
                t ? m ? t.animate({
                    ...
                    r: w
                }) : t.attr(void 0) : (q.topCanvas = t = f.rect(a), t.attr({
                    x: x,
                    y: p,
                    width: G,
                    height: g
            ...
            _createAxes: function() {
                var b = this.components,
                    a,
                    g = J.register("component", ["axis", "cartesian"]),
                    d = this.config.showVolumeChart,
                    f,
                    c;
                b.yAxis = [];
                b.xAxis = [];
            ...
            _feedAxesRawData: function() {
                var a = this.components,
                    ...
                    L,
                    h = this.is3d,
                    q = h ? w.chart3D : w.chart2D,
                    k = J.register("component", ["axis", "cartesian"]),
            ...
            _setCategories: function() {
                var b = this.jsonData,
                    a = this.components.xAxis,
                    b = b.categories && b.categories[0].category || [],
                    g = [],
                    d,
                    f;
                for (f = 0; f < b.length; f++)
                    d = U({}, b[f]), d.label = L, g.push(d);
            ...
            _setAxisLimits: function() {
                var b = this.components,
                    ...
                    u = {};
                for (c = 0; c < f; c++)
                    d = a[c], p = d.groupManager, G = d.config.parentYAxis, p ? (u[d.type] = p, u[d.type].yAxisIndex = G) : (d = d.getDataLimits(), 1 === G ? (k = v(k, d.max), t = Z(t, d.min)) : (h = v(h,
                    d.max), q = Z(q, d.min)), x = v(x, d.xMax || -Infinity), O = Z(O, d.xMin || Infinity));
                for (p in u)
                    d = u[p].getDataLimits(), h = v(h, d.max), q = Z(q, d.min);
                a = this._getTrendLineMinMax("h");
                h = v(h, a.max);
                q = Z(q, a.min);
                g[0].setDataLimit(h, q);
                g[1].setDataLimit(k, t);
                if (-Infinity !== x || Infinity !== O)
                    b[0].setAxisRange({
                        min: O - .5,
                        max: x + .5,
                        tickInterval: 1
                    }), b[1] && b[1].setAxisRange({
                        min: O - .5,
                        max: x + .5,
                        tickInterval: 1
                    })
        ...
        c("kagi", {
            ...
            _postSpaceManagement: function() {
                var a = this.config,
                    ...
                    I = c.yAxis && c.yAxis[0],
                    r = c.canvas.config,
                    D = r.canvasBorderWidth,
                    v = r.canvasPadding || 15,
                    A = r.canvasPaddingTop,
                    r = r.canvasPaddingBottom,
                    F = this.jsonData.chart,
                    l = (c = c.dataset[0].config) && c.shiftCount,
                    C = S(E.getAxisConfig("axisMinValue"), 0),
                    H = S(E.getAxisConfig("axisMaxValue"), l - 1),
                    Q = this.config.canvasWidth;
                e(S(F.canvaspadding, 0), Q / 2 - 10);
                var F = S(F.maxhshiftpercent, 10),
                    Q = Q - 2 * v,
                    n;
            ...
            _setPosition: function() {
                ...
                E = this.jsonData;
                var A = a.dataset[0],
                    F = E.data || A && A[0] && A[0].data,
                    l = (A = A.components.data) && A.length,
                    C = a.yAxis[0],
                    H = 0,
                    Q = H,
                    n = [];
                for (a = 0; a < l; a++)
                    c = A[a].config, e = c.setValue, (E = A[a]) || (A[a] = {
                        graphics: {}
                    }), c.isDefined || (e = c.plotValue), e = W(c.plotValue, e), c.plotY = I(C.getAxisPosition(c.setValue), 2), c.graphY = I(C.getAxisPosition(e), 2), c.plotX = Q, c.isShift ? (Q = H += 1, F && n.push(F[a])) :
            ...
            _setAxisLimits: function() {
                ...
                for (D = 0; D < r; D++)
                    I = c[D], (C = I.groupManager) ? H[I.type] = C : Q.push(I);
                for (C in H)
                    c = H[C].getDataLimits(), n(c);
                r = Q.length;
                for (D = 0; D < r; D++)
                    c = Q[D].getDataLimits(), n(c);
                ...
                if (-Infinity !== l || Infinity !== F)
                    a[0].config.xaxisrange = {
                        max: l,
                        min: F
    ...
    J.register("module", ["private", "modules.renderer.js-boxandwhisker2d", function() {
        var a = this.hcLib,
            ...
            W = a.BLANKSTRING,
            S = a.preDefStr.sStr,
            I = a.componentDispose,
            B = a.HUNDREDSTRING,
            X = a.setAttribDefs,
            M = a.attrTypeNum,
            R = !a.CREDIT_REGEX.test(this.window.location.hostname),
            r = Math,
            D = r.round,
            v = r.abs,
            A = r.ceil,
        ...
        a.prototype = {
            setArray: function(a) {
                var c = this.nf,
                    n = this.dataSeparator,
                    b = 0;
                !a && (a = ba);
                for (a = this.dataLength = (n = a.replace(/\s/g, ba).split(n)) && n.length; a--;)
                    b += n[a] = c.getCleanValue(n[a]);
            ...
            getMD: function() {
                for (var a = this.mean, c = this.frequencies, n = c.length, b, z = 0; n--;)
                    b = c[n], z += b.frequency * v(b.value -
                    a);
                return z / this.dataLength
            },
            getSD: function() {
                for (var a = this.mean, c = this.values, n = this.dataLength, b = n, z = 0; n--;)
                    z += C(c[n] - a, 2);
                return l(z) / b
            },
            getQD: function() {
            ...
            getFrequencies: function() {
                var a = [],
                    ...
                    e;
                for (e = 0; e < c; e += 1)
                    b += z = n[e], f = a[e], void 0 !== f && null !== f ? a[e].frequency += 1 : (f = {}, f.value = z, f.frequency = 1, a[e] = f);
                this.sum = b;
                this.frequencies = a
            },
            getMedian: function() {
                var a = this.dataLength,
                    c = .5 * a,
                    n = this.values;
                return 0 === a %
                2 ? (n[c] + n[c - 1]) / 2 : n[F(c)]
        ...
        c("boxandwhisker2d", {
            ...
            _drawDataset: function() {
                var a = this.components.dataset,
                    ...
                    f = {};
                for (b = 0; b < n; b++)
                    c = a[b], z = c.groupManager, f[c.type] = z;
                for (z in f)
                    f[z].draw();
                a.flag = !0;
                for (b = 0; b < n; b++)
                    for (a[b].components.mean && a[b].components.mean.draw(), a[b].components.sd && a[b].components.sd.draw(), a[b].components.md && a[b].components.md.draw(), a[b].components.qd && a[b].components.qd.draw(), z = a[b].config.maxNumberOfOutliers || a[b].components.outliers.length, c = 0; c < z; c++)
                        a[b].config.showOutliersLegend ||
            ...
            _createDatasets: function() {
                var a = this.components,
                    ...
                    l,
                    r,
                    m = this.defaultDatasetType,
                    v = this.applicableDSList,
                    A = this.components.legend;
                ...
                for (f = 0; f < z; f++)
                    if (g = b[f], g.seriesname && (g.seriesname = e(g.seriesname)), r = g.parentyaxis || W, w = (w = this.isDual && r.toLowerCase() === S ? E(g.renderas, this.sDefaultDatasetType) : E(g.renderas, m)) && w.toLowerCase(), v[w] || (w = m), U = J.get("component", ["dataset", w]))
                        void 0 === h[w] ? h[w] = 0 : h[w]++, P = "datasetGroup_" + w, r = J.register("component", ["datasetGroup", w]), (L = a[P]) && d.push(L), r && !L && (L = a[P] = new r, L.chart = this, L.init()), (r = n[f]) ? (w = c.getCategoryLen(), P = T - w, U = N ? r.components : r.JSONData,
                ...
                if (l > z) {
                    ...
                    a = f;
                    for (z = P + f; a < z; a++)
                        L && !y && L.removeDataSet(f, 0, 1), A.removeItem(n[a].legendItemId), I.call(n[a]);
                    n.splice(f, P)
                }
    ...
    J.register("module", ["private", "modules.renderer.js-heatmap", function() {
        var a = this.hcLib,
            ...
            W = a.preDefStr,
            S = W.defaultFontStr,
            I = W.divLineAlpha3DStr,
            B = W.divLineAlphaStr,
            X = W.altVGridColorStr,
            M = W.altVGridAlphaStr,
            R = W.altHGridColorStr,
            r = W.altHGridAlphaStr,
            D = W.colors.c000000,
        ...
        c("heatmap", {
            ...
            _createAxes: function() {
                var a = this.components,
                    c = J.register("component", ["axis", "cartesian"]),
                    e;
                a.yAxis = [];
                a.xAxis = [];
                a.yAxis[0] = e = new c;
            ...
            _postSpaceManagement: function() {
                var a = this.config,
                    c = a.placeAxisLabelsOnTop,
                    e = this.components,
                    l = e.xAxis && e.xAxis[0],
                    r = e.yAxis && e.yAxis[0],
                    H = e.legend,
                    Q = a.xDepth,
                    e = e.canvas.config.canvasBorderWidth;
            ...
            _feedAxesRawData: function() {
                var c = this.components,
                    ...
                    C;
                C = this.is3d;
                var H = a.chartPaletteStr,
                    H = C ? H.chart3D : H.chart2D;
                C = {
            ...
            _setCategories: function() {
                var a = this.components,
                    ...
                    r = a.xAxis,
                    a = a.yAxis,
                    l = c.dataset && c.dataset[0].data && c.dataset[0].data.length,
                    C,
                    H,
                    Q,
                    n,
                    ...
                    K;
                if (!c.columns || !c.rows)
                    for (c.columns = {}, c.columns.column = n = [], c.rows = {}, c.rows.row = b = [], C = 0; C < l; C++) {
                        Q = H = !0;
                        for (K = 0; K < n.length; K++)
                            c.dataset[0].data[C].columnid == n[K].id && (H = !1);
                        H && (H = {
                            id: c.dataset[0].data[C].columnid,
                            label: c.dataset[0].data[C].columnid
                        }, c.columns.column.push(H));
                        for (K = 0; K < b.length; K++)
                            c.dataset[0].data[C].rowid == b[K].id && (Q = !1);
                        Q && (Q = {
                            id: c.dataset[0].data[C].rowid,
                            label: c.dataset[0].data[C].rowid
                        },
                        c.rows.row.push(Q))
                    }
                n = c.columns.column;
                ...
                for (C = 0; C < (n && n.length); C++)
                    n[C].label = e(n[C].label, n[C].name, n[C].id), void 0 !== n[C].label && z.push(n[C]);
                c.columns.column = z;
                for (C = 0; C < (b && b.length); C++)
                    b[C].label = e(b[C].label, b[C].name, b[C].id), void 0 !== b[C].label && f.push(b[C]);
                c.rows.row = f;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorbar2d", function() {
        var a = this.hcLib,
            ...
            f = a.toRaphaelColor,
            K = a.COMMASPACE,
            V = c.showHoverEffectStr,
            m = c.setRolloverAttrStr,
            Z = c.setRolloutAttrStr,
            ga = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")",
            c = a.TOUCH_THRESHOLD_PIXELS,
            E = a.CLICK_THRESHOLD_PIXELS,
            L = Math,
            w = L.round,
            U = L.min,
            g = L.max,
            ...
            ka = a.getFirstColor,
            d = a.getFirstAlpha,
            N = a.graphics.getLightColor,
            T = a.graphics.convertColor,
            h = a.HUNDREDSTRING,
        ...
        J.register("component", ["dataset", "ErrorBar2D", {
            configure: function() {
                var k = this.chart,
                    ...
                    q = this.JSONData,
                    x = q.data,
                    p = k.config.categories,
                    c = U(p && p.length, x && x.length),
                    u = k.jsonData.chart,
                    da = k.components.colorManager,
                    m,
                    y = da.getPlotColor(this.index || this.positionIndex),
                    aa = b(q.dashed, u.plotborderdashed),
                    L = b(u.useplotgradientcolor, 1),
                    r = a.parseUnsafeString,
                    T = r(u.yaxisname),
                    P = r(u.xaxisname),
                    Z = r(Q(u.tooltipsepchar, K)),
                    v = b(u.seriesnameintooltip, 1),
                    V = a.parseTooltext,
                    H,
                    ga,
                    D,
                    ...
                    Ga,
                    Ma = a.getDashStyle,
                    ra = this.components.data,
                    Ba = k.components.numberFormatter,
                    Ua = k.isBar,
                    Ja = k.is3D;
                ea = k.isStacked;
                var ja,
                ...
                d.animation = ja ? {
                    duration: 1E3 * b(u.animationduration, 1)
                } : !1;
                ...
                for (eb = 0; eb < c; eb++)
                    B = x && x[eb], ea = (E = ra[eb]) && E.config, E || (E = ra[eb] = {
                        graphics: {}
                    }), E.config || (ea = ra[eb].config = {}), ea.showValue = b(B.showvalue, d.showValues), ea.setValue = E = Ba.getCleanValue(B.value), ea.setLink = Q(B.link),
            ...
            ErrorValueConfigure: function() {
                var k = this.chart,
                    ...
                    h = q.data,
                    p = k.config.categories,
                    p = U(p && p.length, h && h.length),
                    c = k.jsonData.chart,
                    k = a.parseUnsafeString,
                    f,
                    w,
                    e,
                    ...
                    l = k(c.xaxisname),
                    L,
                    r = b(c.seriesnameintooltip, 1),
                    N,
                    P = k(Q(c.tooltipsepchar, K)),
                    Z,
                    v,
                    A,
                    V,
                ...
                for (V = 0; V < p; V++)
                    if (f = h && h[V], e = (w = y[V]) && w.config, J = A = void 0, void 0 !== b(f.value)) {
                        w || (w = y[V] = {
                            graphics: {}
                        });
                        ...
                        if (f.positiveerrorvalue || f.negativeerrorvalue)
                            e.halfErrorBar = 0, e.notHalfErrorBar = !0;
                        D = M + (null !== D ? D : ga);
            ...
            init: function(k) {
                var d = this.chart,
                    a = d.components,
                    a = d.isDual ? a.yAxis[this.yAxis || 0] : a.yAxis[0];
                if (!k)
                    return !1;
                this.JSONData = k;
                this.yAxis = a;
            ...
            draw: function() {
                var k = this,
                    d = k.JSONData,
                    q = k.chart.jsonData.chart,
                    h = k.config,
                    p = k.groupManager,
                    c = k.index,
                    g = k.chart.config.categories,
                    n = d.data,
                    w,
                    e,
                    z,
                    ...
                    L = k.visible,
                    r = k.chart,
                    N = r.components.paper,
                    T = r.components.xAxis[0],
                    v = r.components.yAxis[0];
                ...
                var A,
                    ...
                    E = a.Raphael,
                    F = h.showTooltip,
                    ka = T.getAxisPosition(0),
                    M = T.getAxisPosition(1),
                    X = h.groupMaxWidth = M - ka,
                    ba =
                    h.definedGroupPadding,
                    J = h.plotSpacePercent / 200,
                    Fa = p.getDataSetPosition(k),
                    ka = p.manageClip,
                    wa = h.maxColWidth,
                    oa = r.get(W, S),
                    M = oa.animType,
                    ...
                    la = oa.dummyObj,
                    oa = oa.duration,
                    X = (1 - .01 * ba) * X || U(X * (1 - 2 * J), 1 * wa),
                    X = b(Fa.columnWidth, X / 1),
                    ia,
                    ba = Fa.xPosOffset || 0,
                    Fa = Fa.height,
                    ea,
                    ...
                    wa = 0 < wa.max && 0 > Y,
                    Y = v.getAxisBase(),
                    ua = v.yBasePos = v.getAxisPosition(Y),
                    xa = 0,
                    za = h.showShadow,
                    Ga = h.plotBorderThickness,
                    h = h.plotRadius,
                    Ma = k.graphics.container,
                    ra = k.graphics.dataLabelContainer,
                    Ba = k.graphics.shadowContainer,
                    Ua = k.graphics.errorGroupContainer,
                    Ja = k.graphics.errorShadowContainer,
                    ja,
                    xb = !0,
                    eb = !1,
                    Qb = !1,
                    Db = (k.components.removeDataArr || []).length,
                    Kb = k.components.pool || [],
                    pb = r.config.plothovereffect,
                    hb,
                    Eb = function() {
                ...
                for (l = 0; l < w; l++)
                    if (e = n && n[l], fa = J[l])
                        if (hb = fa.trackerConfig = {}, z = (ya = fa && fa.config) && ya.setValue, void 0 !== fa && void 0 !== z && null !== z) {
                            A = 0 <= z;
                            ca = ya.setLink;
                            ja = ya.colorArr;
            ...
            show: function() {
                var k = this.graphics && this.graphics.container,
                    ...
                    q = this.graphics && this.graphics.errorShadowContainer,
                    h = this.chart.is3D,
                    c = this.components.data,
                    f = this.chart.config.categories,
                    g = this.yAxis,
                    n = this.chart,
                ...
                if (h)
                    for (k = 0; k < f; k++)
                        c[k].graphics.element && c[k].graphics.element.attr(D, r);
                else
                    k.show();
                a.show();
                d && d.show();
            ...
            drawErrorValue: function() {
                ...
                h = this.visible;
                var a = this.chart,
                    f = a.components.xAxis[0].getCategoryLen(),
                    g = a.graphics.columnGroup,
                    n = a.components.paper,
                    e = a.components.yAxis[0],
                    z = this.components.data,
                    m = this.groupManager.getDataSetPosition(this).height,
                    l = a.get(W, S),
                    L = l.animType,
                    r = l.animObj,
                    N = l.dummyObj,
                    l = l.duration,
                    T = d.errorBarThickness,
                    Z = d.errorBarWidthPercent,
                    A = d.errorBarColor,
                    V = d.showTooltip,
                    d = d.shadowOpacity,
                    H = this.graphics.errorGroupContainer,
                    K = this.graphics.errorShadowContainer,
                    D,
                    E,
                    Q,
                    B,
                ...
                for (h = 0; h < b; h++) {
                    ...
                    if (f && (void 0 === E || null === E))
                        for (f.graphics.element && (f.graphics.element.hide(), f.graphics.element.shadow(!1)), f.graphics.hotElement && f.graphics.hotElement.hide(), R = f.graphics.error && f.graphics.error.length, c = 0; c < R; c++)
                            f.graphics.error && f.graphics.error[c] && (f.graphics.error[c].hide(), f.graphics.error[c].shadow({
                                opacity: 0
                            }));
                    if (void 0 !== f && void 0 !== E && null !== E)
                        if (f.errorBar && delete f.errorBar, ka = g.errorValueArr, Aa.errorLen = R = ka.length, !f.graphics.error && (f.graphics.error = []), !f.graphics.errorTracker && (f.graphics.errorTracker = []), g.errorValue === C || void 0 === g.errorValue || null === g.errorValue && null === g.positiveErrorValue && null === g.negativeErrorValue)
                            for (c = 0; c < R; c++)
                                f.graphics.error && f.graphics.error[c] && (f.graphics.error[c].hide(), f.graphics.error[c].shadow({
                                    opacity: 0
                                }));
                            ...
                            E = ia ? ea + fa : ea;
                            D += sa / 2;
                            for (f.errorBar || (f.errorBar = []); R--;)
                                Aa.errorTrackerArr[R] = {}, q = ka[R], Aa.errorTrackerArr[R].tooltext = q.tooltext, I = E, F = q.errorValue, null === F || isNaN(F) ? f.graphics.error && f.graphics.error[R] && (f.graphics.error[R].hide(), f.graphics.error[R].shadow({
                                    opacity: 0
                                })) : (ba = Z / 100 * sa, ba /= 2, Q = 0 === m ? 0 : 1, F = ea + (e.getAxisPosition(0) - e.getAxisPosition(1)) * F * Q, ia && (F += fa), Q = w(F) + T % 2 / 2, B = w(D) + T % 2 / 2, f.errorBar[R] || (f.errorBar[R] = []), q.errorEdgeBar ? (F = ["M",
                                B - ba, Q, "H", B + ba], f.errorBar[R][1] = {
                                    ...
                                    _width: 2 * ca,
                                    _toolText: q.tooltext
                                }), f.graphics.error[R] ? (q = {
                                    path: F
                                }, I = f.graphics.error[R], I.animateWith(N, r, q, l, L), I.attr({
                                    stroke: A,
                                    ishot: !V,
                                    "stroke-width": T,
                                    cursor: c ? "pointer" : C,
            ...
            _firePlotEvent: function(k, d, b, h) {
                var p = this.chart,
                    f = this.components.data[d],
                    c = f.graphics.element,
                    g = f.errorBarHovered,
                    n = a.toolTip,
                    w = b.originalEvent,
                    e = p.components.paper.canvas.style,
                    z = f.config.setLink;
                if (c)
                    switch (k) {
                    case "mouseover":
            ...
            d, a) {
                ...
                if (q && (q = q.errorBar))
                    for (c = q && q.length; c--;)
                        for (g = (f = q[c]) && f.length; g--;)
                            if (f[g] && f[g]._xPos && (h = f[g]._xPos, w = f[g]._yPos, e = f[g]._height, z = f[g]._width, n = f[g]._toolText, h = d >= h && d <= h + z && a >= w && a <= w + e))
                                return {
                                    pointIndex: k,
                                    hovered: h,
                                    pointObj: b[k],
            ...
            _checkPointerOverPlot: function(k, d, a) {
                var b = this.components.data[k],
                    q = b && b.config,
                    h;
                if (b)
                    return (h = this._checkPointerOverErrorBar(k, d, a)) ? (b.errorBarHovered = !0, q.finalTooltext = h.toolText) : (h = this._checkPointerOverColumn(k,
                    d, a), b.errorBarHovered = !1, h && (q.finalTooltext = !1 !== q.toolText && q.toolText + q.toolTipValue)), h
            },
            _getHoveredPlot: function(k, d) {
                var a = this.chart,
                    b = a.components.canvas.config,
            ...
            remove: function() {
                var d = this.components,
                    ...
                    n;
                for (g = 0; g < q; g++)
                    if (h = a[0], a.splice(0, 1), h && h.graphics) {
                        c = h.graphics;
                        c.element && c.element.hide() && c.element.shadow({
                            opacity: 0
                        });
                        for (n = 0; 4 > n; n++)
                            c.error && c.error[n] && c.error[n].hide() && c.error[n].shadow({
                                opacity: 0
                            });
                        c.hotElement && c.hotElement.hide() && c.hotElement.attr({
                            width: 0
                        });
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorline", function() {
        var a = this.hcLib,
            ...
            E = c.colors.AAAAAA,
            e = c.configStr,
            ba = c.animationObjStr,
            W = c.errorBarStr,
            S = c.errorShadowStr,
            I = c.ROUND,
            B = c.PERCENTAGESTRING,
            c = c.line,
            X = a.BLANKSTRING,
            M = a.parseTooltext,
            R = a.pluck,
        ...
        J.register("component", ["dataset", "ErrorLine", {
            ...
            ErrorValueConfigure: function() {
                var f = this.chart,
                    ...
                    z = g.data,
                    l = f.jsonData.chart,
                    H = f.components.xAxis[0].getCategoryLen(),
                    d = a.parseUnsafeString,
                    N,
                    T,
                    h,
                    q = this.components.data,
                    f = f.components.numberFormatter,
                    k,
                    t,
                    O,
                    x,
                ...
                var ma = -Infinity,
                    ...
                    F = d(l.xaxisname),
                    ta,
                    I = R(l.tooltipsepchar, A),
                    W,
                    Qa,
                    Ea,
                    S,
                    ba = D(l.seriesnameintooltip, 1),
                    J = function(d) {
                ...
                for (t = 0; t < H; t++)
                    if (N = z && z[t], z && N) {
                        ...
                        if (N.positiveerrorvalue || N.negativeerrorvalue)
                            h.halfErrorBar = 0, h.notHalfErrorBar = !0;
            ...
            show: function() {
                var a = this.chart,
                    b = this.yAxis,
                    f = this.graphics && this.graphics.container,
            ...
            drawErrorValue: function() {
                var a = this.config,
                    b = this.chart,
                    c = b.graphics.datasetGroup,
                    n = b.components,
                    g = n.xAxis[0].getCategoryLen(),
                    l,
                    m,
                    r = this.visible,
                    n = n.paper,
                    ...
                    k = T.dummyObj,
                    T = T.duration,
                    t = a.errorBarThickness,
                    O = a.errorBarWidth,
                    x = a.errorBarColor,
                    b = b.config.showtooltip,
                    a = a.shadowOpacity,
                    p = this.graphics.container.lineGroup,
                    G = this.graphics.errorGroupContainer,
                    u = this.graphics.errorShadowContainer,
                    da,
                    v,
                    Z,
                    aa,
                ...
                for (c = 0; c < g; c++)
                    if (p = N[c], M = p.errorTrackerConfig = {}, M.errorTrackerArr = [], aa = (m = p && p.config) && m.setValue, void 0 === p || void 0 === aa ||
                    null === aa) {
                        if (p.graphics.error)
                            for (m = 0; m < p.graphics.error.length; m++)
                                p.graphics.error[m].hide(), p.graphics.errorTracker[m].hide(), p.graphics.error[m].shadow(!1)
                    } else if (K = m.errorValueArr, M.errorLen = aa = K.length, !p.graphics.error && (p.graphics.error = []), !p.graphics.errorTracker && (p.graphics.errorTracker = []), m.errorValue === X || void 0 === m.errorValue || null === m.errorValue && null === m.positiveErrorValue && null === m.negativeErrorValue)
                        for (m = 0; m < aa; m++)
                            p.graphics.error && p.graphics.error[m] && (p.graphics.error[m].hide(),
                            p.graphics.error[m].shadow({
                                opacity: 0
                            }));
                    else {
                        da = m.setLink;
                        ...
                        for (p.errorBar = []; aa--;)
                            M.errorTrackerArr[aa] = {}, l = K[aa], M.errorTrackerArr[aa].tooltext = l.tooltext, C = Z, A = l.errorValue, null === A || isNaN(A) ? p.graphics.error && p.graphics.error[aa] && (p.graphics.error[aa].hide(), p.graphics.error[aa].shadow({
                                opacity: 0
                            })) : (D = O / 2, V = r ? 1 : 0, V = B + (d.getAxisPosition(0) - d.getAxisPosition(1)) * A * V, A = Q(V) + t % 2 / 2, H = Q(v) + t % 2 / 2, p.errorBar[aa] || (p.errorBar[aa] = []), l.errorEdgeBar ?
                            (V = ["M", H - D, A, "H", H + D], p.errorBar[aa][1] = {
                                ...
                                _width: 2 * E,
                                _toolText: l.tooltext
                            }), p.graphics.error[aa] ? (l = {
                                path: V
                            }, C = p.graphics.error[aa], C.animateWith(k, q, l, T, h), C.attr({
                                stroke: x,
                                ishot: !b,
                                "stroke-width": t,
                                cursor: da ? "pointer" : X,
                        ...
                        if (!m.notHalfErrorBar)
                            for (m = 2; 4 > m; m++)
                                p.graphics.error && p.graphics.error[m] && p.graphics.error[m].hide() && p.graphics.error[m].shadow({
                                    opacity: 0
                                })
                    }
            },
            ...
            _checkPointerOverPlot: function(a, b, f) {
                var c = this.components.data[a],
                    g = c && c.config,
                    n;
                if (c) {
                    if (n = this.isWithinShape(c, a, b, f))
                        c.errorBarHovered = !1, g.finalTooltext = !1 !== g.toolText && g.toolText + g.toolTipValue;
                    else if (n = this._checkPointerOverErrorBar(a, b, f))
                        c.errorBarHovered = !0, g.finalTooltext = n.toolText;
                    return n
                }
            },
            ...
            _removeDataVisuals: function(a) {
                ...
                if (a) {
                    b = a.graphics;
                    b.element && b.element.hide() && b.element.shadow({
                        opacity: 0
                    });
                    for (f = 0; 4 > f; f++)
                        a.graphics.error && a.graphics.error[f] && a.graphics.error[f].hide() && a.graphics.error[f].shadow({
                            opacity: 0
                        });
                    b.hotElement &&
                    b.hotElement.hide() && b.hotElement.attr({
                        width: 0
                    })
                }
            }
        ...
        J.register("component", ["dataset", "ErrorScatter", {
            ErrorValueConfigure: function() {
                var b = this.chart,
                    ...
                    e = this.config,
                    w = this.JSONData,
                    z = b.config.categories,
                    g = b.jsonData.chart,
                    l = w.data,
                    P = c.xAxis[0].getCategoryLen(),
                    P = l && l.length || P,
                    C = a.parseUnsafeString,
                    d,
                    N,
                    T,
            ...
            drawErrorValue: function() {
                var c = this.chart,
                    ...
                    p = O.dummyObj,
                    O = O.duration,
                    G = this.graphics.container.lineGroup,
                    u = this.graphics.errorGroupContainer,
                    da = this.graphics.errorShadowContainer,
                    ma,
                    V,
                    aa,
                    K,
                ...
                for (n = 0; n < m; n++)
                    if (G = d[n], Ra = G.errorTrackerConfig = {}, Ra.errorTrackerArr = [], K = (C = G && G.config) && C.setValue, Q = C.errorValueArr,
                    void 0 !== G && void 0 !== K && null !== K && Q) {
                        ...
                        if (null === C.vErrorValue && null === C.vPositiveErrorValue && null === C.vNegativeErrorValue)
                            for (T = 0; 4 > T; T++)
                                G.graphics.error && G.graphics.error[T] && (G.graphics.error[T].hide(), G.graphics.error[T].shadow({
                                    opacity: 0
                                }));
                        if (null === C.hErrorValue && null === C.hPositiveErrorValue && null === C.vPositiveErrorValue)
                            for (T = 4; 8 > T; T++)
                                G.graphics.error && G.graphics.error[T] &&
                                (G.graphics.error[T].hide(), G.graphics.error[T].shadow({
                                    opacity: 0
                                }));
                        if (!(null === C.hErrorValue && null === C.vErrorValue && C.hPositiveErrorValue && C.hNegativeErrorValue && C.vPositiveErrorValue && C.vNegativeErrorValue))
                            for (ma = C.setLink, R = G._xPos, aa = X = G._yPos, V = R, pa = 0; pa < K; pa++)
                                if (!C.useHorizontalErrorBar && (0 === pa || 1 === pa || 2 === pa || 3 === pa) || !C.useVerticalErrorBar && (4 === pa || 5 === pa || 6 === pa || 7 === pa) || (2 === pa || 3 === pa) && C.halfHorizontalErrorBar || (6 === pa || 7 === pa) && C.halfVerticalErrorBar)
                                    G.graphics.error && G.graphics.error[pa] &&
                                    G.graphics.error[pa].hide() && G.graphics.error[pa].shadow({
                                        opacity: 0
                                    }), G.graphics.errorTracker && G.graphics.errorTracker[pa] && G.graphics.errorTracker[pa].hide() && G.graphics.errorTracker[pa].shadow({
                                        opacity: 0
                                    });
                                else if (Ra.errorTrackerArr[pa] = {}, g = Q[pa], Ra.errorTrackerArr[pa].tooltext = g.tooltext, B = aa, D = g.errorValue, null === D || void 0 === D || isNaN(D))
                                    G.graphics.error && G.graphics.error[pa] && (G.graphics.error[pa].hide(), G.graphics.error[pa].shadow({
                                        opacity: pa
                                    })), G.graphics.errorTracker && G.graphics.errorTracker[pa] &&
                                    (G.graphics.errorTracker[pa].hide(), G.graphics.errorTracker[pa].shadow({
                                        opacity: 0
                                    }));
                                else {
                                    q = g.errorBarColor;
                                    ...
                                    h = 5 < T ? T / 2 + .5 : 2.75;
                                    if (N)
                                        if (N = R + (f.getAxisPosition(0) - f.getAxisPosition(1)) * D * E, D = H(B) + T % 2 / 2, E = H(N) + T % 2 / 2, g.errorEdgeBar)
                                            for (N = ["M", E, D - Ea, "V", D + Ea], J = 2 * Ea, B = D - Ea, Ea = h; Ea < J; Ea += 2 * h)
                                                Na.push({
                                                    x: E,
                                                    y: B + Ea,
                                                    r: h,
                                            ...
                                            for (N = ["M", V, D, "H", E], J = b(V - E), B = V > E ? E : V, Ea = h; Ea < J; Ea += 2 * h)
                                                Na.push({
                                                    x: B + Ea,
                                                    y: D,
                                                    r: h,
                                    ...
                                    else if (N = X + (A.getAxisPosition(0) - A.getAxisPosition(1)) * D * E, D = H(N) + T % 2 / 2, E = H(V) + T % 2 / 2, g.errorEdgeBar)
                                        for (N = ["M", E - Ea, D, "H", E + Ea], J = 2 * Ea, B = E - Ea, Ea = h; Ea <= J; Ea += 2 * h)
                                            Na.push({
                                                x: B + Ea,
                                                y: D,
                                                r: h,
                                        ...
                                        for (N = ["M", E, B, "V", D], J = b(B - D), B = B > D ? D : B, Ea = h; Ea <= J; Ea += 2 * h)
                                            Na.push({
                                                x: E,
                                                y: B + Ea,
                                                r: h,
            ...
            _getHoveredPlot: function(a, b) {
                ...
                if (c = this.dataTree.getNeighbour({
                    ...
                    return f = c.data.config.toolText, c.data.config.finalTooltext = f, n = c.data.config.hoverEffects, f = c.data.graphics.element, f.data("hoverEnabled", n.enabled), n.enabled && f.attr(f.getData().setRolloverAttr), {
                        pointIndex: c.index,
                        hovered: !0,
                        pointObj: c.data
                    };
                if (c = this.dataTreeB && this.dataTreeB.getNeighbour({
                    ...
                    return "h" === c.barType ? f = c.toolText : "v" ===
            ...
            show: function() {
                var a = this.chart,
                    b = this.yAxis,
                    c = this.graphics && this.graphics.errorGroupContainer,
            ...
            remove: function() {
                var a = this.components,
                    ...
                    m;
                for (z = 0; z < f; z++)
                    if (n = b[0], b.splice(0, 1), n && n.graphics) {
                        e = n.graphics;
                        e.element && e.element.hide() && e.element.shadow({
                            opacity: 0
                        });
                        for (m = 0; 8 > m; m++)
                            e.error && e.error[m] && e.error[m].hide() && e.error[m].shadow({
                                opacity: 0
                            });
    ...
    ["private", "modules.renderer.js-dataset-multiaxisline", function() {
        ...
        J.register("component", ["dataset", "multiaxisline", {
            ...
            legendInteractivity: function(a, c) {
                var e = a.chart,
                    E = e.components.dataset,
                    X = this.config,
                    M = a.visible,
                    R = c.config,
                    r = c.graphics,
                    D = X.itemHiddenStyle.color,
                    X = X.itemStyle.color,
                    v = R.fillColor,
                    R = R.strokeColor,
                    A = a.axisIndex,
                    F = !0,
                    l,
                    e = e.config.axesArr.checkBox;
                M ? a.hide() : a.show();
                if (M) {
                    for (l in E)
                        E.hasOwnProperty(l) && E[l].visible && E[l].axisIndex === A && (F = !1);
                    F && e[A] && e[A].checkbox.uncheck()
                } else
                    e[A] && e[A].checkbox.check();
                M ? (r.legendItemSymbol && r.legendItemSymbol.attr({
                    fill: D,
                    stroke: D
                }), r.legendItemText && r.legendItemText.attr({
                    fill: D
                }),
                r.legendIconLine && r.legendIconLine.attr({
                    stroke: D
                })) : (r.legendItemSymbol && r.legendItemSymbol.attr({
                    fill: v,
                    stroke: R
                }), r.legendItemText && r.legendItemText.attr({
                    fill: X
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-multilevelpie", function() {
        var a = this.hcLib,
            c = a.graphics.convertColor,
            E = a.plotEventHandler,
            e = a.preDefStr,
            ba = e.colors,
            W = ba.FFFFFF,
            S = ba.c000000,
        ...
        J.register("component", ["dataset", "multiLevelPie", {
            ...
            configure: function() {
                ...
                var N = A(-e.centerangle, 180),
                    T = A(e.totalangle, 360);
                g.animation = a ? {
                    duration: 1E3 * A(e.animationduration, e.moveduration, 1)
                } : !1;
                ...
                a && (g.events = {
                    mouseOver: function() {
                        for (var d = this.data("plotItem").selfRef, a = n.conf; d.graphics.element;)
                            d.graphics.element.attr({
                                fill: a.hoverFillColor
                            }), d = d.linkedItems.parent
                    },
                    mouseOut: function() {
                        for (var d = this.data("plotItem"), a = d.selfRef; a.graphics.element;)
                            a.graphics.element.attr({
                                fill: (a.config || d).color
                            }), a = a.linkedItems.parent
                    }
                });
                z.plotBorderWidth = 0;
                z.plotBorderWidth = 0;
            ...
            removalFn: function(a, b, c) {
                ...
                !g[c] && (g[c] = []);
                "element" === c ? (n = a.attr("ringpath"), f = (n[4] + n[5]) / 2, b ? a.animateWith(z, m, {
                    ringpath: [n[0], n[1], n[2], n[3], f, f]
                }, e, d, l) : g[c].push(a)) : b ? l(a) : g[c].push(a)
            },
            removeGraphics: function(a, b) {
                var c,
                    f,
                    n = a.components && a.components.data,
                    g,
                    e = a.graphics;
                if (n)
                    for (g = n.length, c = 0; c < g; c += 1)
                        this.removeGraphics(n[c]);
                if (a.graphics)
                    for (f in e)
                        e.hasOwnProperty(f) && this.removalFn(a.graphics[f], b, f)
            },
            removeChild: function(a, b, c) {
                ...
                if (a.length)
                    for (f = 0; f < a.length; f += 1)
                        n = a[f], c ? this.removalFn(n, b, c) : this.removeGraphics(n, b);
                else
                    for (f in a)
                        this.removeChild(a[f], b, f)
            },
            addMSPieCat: function(a, b, f, n, e) {
                ...
                var W = 0,
                    R;
                for (G = 0; G < H; G += 1)
                    e = a[G], e._userValue = t.getCleanValue(e.value, !0), e._value = A(e._userValue, 1), x += e._value;
                x = x || 1;
                O /= x;
                for (G = H - 1; 0 <= G; --G)
                    e = a[G], p = O * e._value, g = l(D(e.label, e.name)), ma = null !== e._userValue ? t.dataLabels(e._userValue) : M, La = t.percentValue(e._value / x * 100), da = A(e.alpha, h.alpha), E = h.showLabels ? g : M, h.showValues && (h.showPercentValues ? E += E !== M ? u + La : La : void 0 !== ma && ma !==
                    M && (E += E !== M ? u + ma : ma)), aa = h.showTooltip ? l(D(e.tooltext, e.hovertext, h.tooltext)) : void 0, aa === M ? (aa = g, h.showValuesInTooltip && (h.showPercentInTooltip ? aa += aa !== M ? u + La : La : void 0 !== ma && ma !== M && (aa += aa !== M ? u + ma : ma))) : aa = r(aa, [1, 2, 3, 14], {
                        ...
                        shadow: {
                            opacity: .01 * K(50 < da ? da * da * da * 1E-4 : da * da * .01)
                        },
                        isSingleTon: 1 < H ? !1 : !0
            ...
            draw: function(c) {
                var f,
                    ...
                    h = C.dataLabelStyle;
                f = g.showShadow;
                var q = r.components.paper,
                    k = C.textDirection,
                    t = C.tooltip || {};
                e = t && !1 !== t.enabled;
                var T = C.canvasWidth,
                    O = C.canvasHeight,
                    t = A(g.originX, C.canvasLeft + .5 * T),
                    C = A(g.originY, C.canvasTop + .5 * O),
                    x,
                    p,
                    G,
                    u,
                    da,
                    ma,
                    K = d.datasetGroup.trackTooltip(!0),
                    aa = r.get(I,
                    B),
                    D = aa.duration || 0,
                    Q = aa.dummyObj,
                    ...
                    W,
                    Qa,
                    Ea = d.datalabels || (d.datalabels = q.group("datalabels").insertAfter(K)),
                    X = g.events || {},
                    J = function(d) {
                        var k = X.mouseOver;
                ...
                0 : x + (T - x) / 2, (e = O._textAttrs) || (e = O._textAttrs = {}), e.text = m, e.fill = h.color || S, e.direction = k, e.ishot = u, e.cursor = u ? "pointer" : R, e.x = t + c * z(f), e.y = C + c * b(f), e["text-bound"] = [h.backgroundColor, h.borderColor, h.borderThickness, h.borderPadding, h.borderRadius, h.borderDash]), W.animateWith(Q, F, {
                    ringpath: [t, C, T, x, da, ma]
                }, D, aa, !N && d)) : (g._drawn && l.drawLabel(), l.removeChild(l.pool, !0))
            },
            drawLabel: function(a) {
                ...
                var g = f.dataLabelStyle,
                    n = c.components.paper,
                    ...
                    t = this.pool || (this.pool = {}),
                    e = e.datalabels;
                !a && (a = this);
                b = a.components.data.length;
                for (m = 0; m < b; m += 1)
                    this.drawLabel(a.components.data[m]);
                d = a.config;
                m = d.plotItem;
                z = d.displayValue;
                b = d._textAttrs;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragnode", function() {
        var a = this.hcLib,
            c = "VML" === a.Raphael.type,
            E = a.preDefStr,
            e = E.configStr,
            ba = E.animationObjStr,
            W = a.ZEROSTRING,
            S = E.POSITION_TOP,
            I = E.POSITION_BOTTOM,
            B = E.UNDERSCORE,
            ...
            K = a.getFirstColor,
            V = a.getFirstAlpha,
            m = a.graphics.getDarkColor,
            Z = a.graphics.getLightColor,
            ga = a.graphics.convertColor,
            L = a.graphics.mapSymbolName,
            w = a.COMMASTRING,
            U = a.HUNDREDSTRING,
            g = a.getMouseCoordinate,
            y = a.plotEventHandler,
            P = a.SHAPE_RECT,
            ka = function() {
                this.data("move", !1);
        ...
        J.register("component", ["dataset", "Dragnode", {
            ...
            configure: function() {
                ...
                if (0 === v(b.includeinlegend) || void 0 === k.name)
                    k.showInLegend = !1;
                ...
                k.colorObj = {
                    ...
                    lineColor: {
                        FCcolor: {
                            color: k.datasetPlotBorderColor,
                            alpha: k.datasetPlotBorderAlpha
                        }
                    }
                };
                k.lineWidth = void 0;
            ...
            _setConfigure: function(d, a) {
                var c = this.JSONData,
                    ...
                    n,
                    m = h.use3DLighting,
                    w = h.datasetPlotBorderThickness,
                    y = h.datasetPlotBorderColor,
                    A = h.datasetPlotBorderAlpha,
                    C = this.chart.jsonData.chart,
                    V = h.color,
                    H = h.alpha,
                    E = h.datasetAllowDrag,
                    U = this.chart.components.numberFormatter;
                ...
                if (q || a) {
                    ...
                    if (null === e)
                        ...
                        q = q.labelalign;
                        if (y = t.imageNode)
                            y = t.imageURL, y = void 0 !== y && null !== y;
            ...
            updatePointConfig: function(d, a) {
                var c = this.chart,
                    h = this.config,
                    q = (this.components.data[a] || {}).config,
                    k = c.components.numberFormatter,
                    c = c.jsonData.chart,
                    t = h.yMin || Infinity,
                    f = h.yMax || -Infinity,
                    x = h.xMax || -Infinity,
            ...
            pointHoverOptions: function(d, a, b) {
                var c = v(d.showhovereffect, this.showhovereffect, a.plothovereffect, a.showhovereffect),
                    q = {},
                    ...
                    t = !1;
                if (void 0 === c && k || c)
                    t = !0, c = r(d.hovercolor, this.hovercolor, a.plotfillhovercolor, Z(b.color, 70)), k = r(d.hoveralpha, this.hoveralpha, a.plotfillhoveralpha, b.alpha), q = {
            ...
            getJSONData: function() {
                var d = this.components.data,
                    ...
                    q;
                for (q = 0; q < a; q++)
                    c = d[q], !c.removed && c.config._options && (delete c.config._options.update, delete c.config._options.add, b.push(c.config._options));
                return b
            },
            ...
            _addLegend: function() {
                var a = this.config,
                    b = this.chart.components.legend,
                    a = {
            ...
            draw: function() {
                var d = this,
                    ...
                    f = d.chart,
                    q = f.getJobList(),
                    k = f.linkedItems.smartLabel,
                    b = b.data,
                    t = d.components.removeDataArr || [],
                    g = t.length,
                    x = f.components.paper,
                    p,
                    e = f.config.dataLabelStyle,
                    u = {
                ...
                for (k =
                b.length; f < k; f += 1)
                    e = b[f].removed, !e && this._drawNode(f);
                ...
                for (f = 0; f < g; f++)
                    d._removeDataVisuals(t.shift())
            },
            rolloverResponseSetter: function(a, b) {
                return function(c) {
                    var f = this.data("drag-options"),
                        q = f.chart,
                        f = (f = f.dataObj.config.dragStart) && Object.keys(f).length,
                        k = this.data("hoverAttr");
            ...
            _drawNode: function(a) {
                var b = this.chart,
                    ...
                    k = q.nodes,
                    t = f.paper,
                    g = this.xAxis = f.xAxis[0],
                    x = this.yAxis = f.yAxis[0],
                    f = this.components.data[a],
                    p = f.config,
                    G = this.config,
                    u = b.get(e, ba) || {},
                    n = u.duration,
                    ...
                    E,
                    D,
                    U = G.colorObj.lineColor,
                    L = G.datasetPlotBorderThickness,
                    Q,
                    Z,
                    F;
                V = this.graphics;
                ...
                var W = V.group,
                    R = f.config.rollOverProperties,
                    ka,
                    S,
                    ga = this.rolloverResponseSetter,
                    J = this.rolloutResponseSetter,
                    oa = this.dragUp,
                    qa = this.dragMove,
                    la = this.dragStart,
                    ia,
                    ea = p.shapeType,
                    sa = p.link ? "pointer" : p.allowDrag ? "move" : M,
                    fa = this.components.pool || {},
                    ha;
                K = u.graphic;
                var ca = u.cloneText,
                    Aa = u.cloneGraphic,
                ...
                if (void 0 !== x && !isNaN(x)) {
                    ...
                    "poly" === z[0] || "circle" === z[0] ? (p.shapeType = z[0], ua = "polypath", G = "path", ha = {
                        polypath: ha
                    }, K.x = g, K.y = x, K.radius = p.radius, K.sides = z[1]) : (p.shapeType = P, G = ua = "rect", K.x = g - w / 2, K.y = x - y / 2,
            ...
            drawLabel: function(a) {
                var b = this.chart,
                    c = this.index,
                    f = b.components.paper,
                    q = this.components.data,
                    k = q.length,
                    t,
                    g,
                    x = this.graphics.group,
                    p = b.config.dataLabelStyle,
                    e = b.get("config", "animationObj"),
                    u = e.dummyObj,
                    n = e.animObj,
                    z = e.duration,
                    m = this.components.pool || {},
                    l,
                    w,
                    y = b.config,
                    v,
                    ...
                    C,
                    V,
                    H = this.rolloverResponseSetter,
                    E = this.rolloutResponseSetter,
                    U = this.dragUp,
                    D = this.dragMove,
                    L = this.dragStart,
                    F,
                    Q,
                    Z = b.linkedItems.smartLabel;
                for (void 0 !== a ? k = a + 1 : a = 0; a < k; a++)
                    if (A = q[a], l = A.config, K = l._plotWidth, C = l._plotHeight, w = l.displayValue, g = l.labelAlign, V = A.graphics, v = V.cloneText, F = A.config.rollOverProperties, Q = l.shapeType, void 0 !== w && null !== w || w !== X) {
                        ...
                        V.label && V.label.hide()
            },
            _removeDataVisuals: function(a) {
                var b = this.components.pool || (this.components.pool = {}),
                    c,
                    f,
                    q,
                    k;
                if (a)
                    for (f in a = a.graphics, a)
                        c = b[f] || (b[f] = {}), q = (k = a[f]) && k.type, c = c[q] || (c[q] = []), k.hide && "function" === typeof k.hide && (k.attr({
                            "text-bound": []
                        }), k.hide(), k.transform && k.transform(M)), c.push(a[f])
            },
            show: function() {
                var a = this.graphics,
                    b = a.dragLabelGroup;
            ...
            _dragStart: function(a, b) {
                var g = this.data("drag-options"),
                    h = g.dataObj,
                    q = h.graphics.element,
                    k = q.getBBox(),
                    t = h.config,
                    e = g.dataset,
                    x = e.groupManager,
                    ...
                    g = u.viewMode;
                f && Q(a);
                var l = b.components.paper,
                    m = e.graphics.group,
                    z = t.dragStart || (t.dragStart = {}),
                    r = h.graphics.cloneGraphic,
                    y = e.graphics.cloneGraphicGroup,
                    v = h.graphics.cloneText,
                    K = h.graphics.image,
                    V = h.graphics.cloneImage,
                    H = h.graphics.label,
                    E = {
                        circle: "circ",
                        rectangle: "rect",
                ...
                g || (n || (n = p.waitElement = l.ringpath(t._xPos, t._yPos, 8, 11, 0, 0, m).attr({
                    ...
                    ringpath: [t._xPos, t._yPos, 8, 11, 0, 0]
                }).show().animate({
                    ringpath: [t._xPos, t._yPos, 8, 11, 0, 6.28]
                }, 1E3), q._longpressactive =
                setTimeout(function() {
                    var a = u.name !== X && void 0 !== u.name ? u.name + w + " " : X,
                        k = u.id;
                    ...
                    x.showNodeUpdateUI(b, {
                        ...
                        dataset: {
                            innerHTML: '<option value="' + k + '">' + a + k + "</option>",
                            disabled: !0
                        },
            ...
            _dragMove: function(a, b, c, f, q) {
                var k = this.data("drag-options"),
                    t = k.dataObj,
                    g = t.graphics.element;
                c = t.graphics.cloneGraphic;
                f = t.graphics.cloneImage;
                var x = t.graphics.cloneText,
                    t = t.config,
                    p = t.dragStart,
                    e = p.bBox.x + a,
                    u = p.bBox.x2 +
                    ...
                    n = p.bBox.y + b,
                    l = p.bBox.y2 + b,
                    z = k.dataset.groupManager.graphics,
                    m = q.config.canvasLeft,
                    r = q.config.canvasRight,
                    w = q.config.canvasTop;
                ...
                l > q && (b -= l - q);
                if (a || b)
                    z.waitElement && z.waitElement.hide(), g.data("fire_click_event", 0), ka.call(g);
                t.allowDrag && (p.draged = !0, p.lastDx = a, p.lastDy = b, q = k._transformObj = {
                    transform: "t" + (p.origX + a) + "," + (p.origY + b)
                }, c && c.attr(q), f && f.attr(q), x && x.attr({
                    x: t._xPos + a,
                    y: t._yPos + b
                }))
            },
            removeData: function(a, b) {
                var c = this.components,
                    f = this.groupManager,
                    q = c.data,
                    k = c.removeDataArr || (c.removeDataArr = []);
                a = a || 0;
                0 > a && (a = 0);
            ...
            _dragUp: function(b) {
                var c = this.data("drag-options"),
                    ...
                    q = f.components.data,
                    k = c.dataObj,
                    t = k.graphics.element,
                    e = c.dataset.groupManager,
                    x = t.data("fire_click_event"),
                    c = k.config,
                    p = h.config.canvasTop,
                    n = h.config.canvasLeft,
                    u = k.config.dragStart || {},
                    z = f.yAxis,
                    m = k.graphics.cloneText,
                    r = f.groupManager.graphics,
                    w = h.components.xAxis[0],
                    v = {},
                    K,
                    A,
                    V,
                    C,
                    H,
                    E = k.graphics.cloneGraphic,
                    U = k.graphics.cloneImage,
                    D = function(a) {
                        var b;
                        if (a)
                            for (b in a)
                                if (H = a[b])
                                    V = H.config.datasetIndex, K = H.config.fromPointObj, A = H.config.toPointObj, (C = e.connectorSet[V]) && C && C.connectors.drawConnector(H, K, A)
                    };
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-connector", function() {
        ...
        ["dataset", "Connector", {
            type: "connector",
            configure: function() {
                var c = this.chart.jsonData.chart,
                    b = this.config,
                    e = this.components.data || (this.components.data = []),
                    f = this.JSONData,
                    r = f.connector,
                    v = r && r.length,
                    m = a.parseUnsafeString;
            ...
            _setConfigure: function(a, b) {
                var c = this.components.data,
                    ...
                    f = this.config,
                    e = this.chart,
                    l = B(W(b.label, b.name)),
                    m = W(b.alpha, f.conAlpha),
                    r = e.linkedItems.smartLabel,
                    v = "$fromLabel" + f.toolTipSepChar + "$toLabel",
                    m = {
                        FCcolor: {
                            color: F(W(b.color, f.conColor)),
                            alpha: m
                        }
                    },
            ...
            draw: function() {
                var c =
                    ...
                    e = c.config,
                    f = b.graphics,
                    l = c.groupManager.nodes,
                    r = c.components.data,
                    m,
                    v,
                    A = c.chart.components.paper,
                    C = b.getJobList();
                v = f.datasetGroup;
                m = b.config.dataLabelStyle;
                var b = r.length,
                    f = c.components.removeDataArr || [],
                    w = f.length,
                    H;
                ...
                H.css(m);
                for (A = 0; A < b; A++)
                    e = r[A], H = e.config, e.graphics || (e.graphics = {}), m = H.from, v = H.to, m = l[m], v = l[v], m && v && !0 !== H.deleted &&
            ...
            mouseDown: function() {
                ...
                a._longpressactive = setTimeout(function() {
                    ...
                    a.data("viewMode") || f.showConnectorUpdateUI(l, {
                        fromid: {
                            val: m.from,
                            innerHTML: "<option>" + m.from + "</option>",
                            disabled: !0
                        },
                        toid: {
                            val: m.to,
                            innerHTML: "<option>" + m.to + "</option>",
                            disabled: !0
                        },
                        datasetIndex: e.index,
                        index: b.index,
                        arratstart: {
                            val: !!I(m.arrowatstart, 1)
                        },
                        arratend: {
                            val: !!I(m.arrowatend, 1)
                        },
                        dashed: {
                            val: I(m.dashed)
                        },
            ...
            drawConnector: function(a, b, l) {
                if (!a.removed) {
                    var f = this.chart,
                        ...
                        m,
                        A,
                        C = f.components.paper,
                        H = f.components.numberFormatter,
                        w = a.graphics,
                        E = f.get("config", "animationObj"),
                        f = this.graphics.connectorGroup,
                        g =
                        E.animObj,
                        y = E.dummyObj,
                        D = E.animType,
                    ...
                    l = w.graphic;
                    w.graphic || (q.graphic && q.graphic.path && q.graphic.path.length ? l = w.graphic = q.graphic.path.shift() : (l = w.graphic = C.path(f).mousedown(this.mouseDown).mousemove(this.mousemove).mouseup(this.mouseup).hover(this.hoverIn, this.hoverOut), l.attr({
                        path: b
                    })));
                    l.show().animateWith(y, g, {
                        path: b
                    }, E, D);
                    l.attr({
                        "stroke-width": r,
            ...
            drawLabel: function(a) {
                var b = this,
                    l = b.config,
                    f = b.chart,
                    r = f.components.paper,
                    v = f.get("config", "animationObj"),
                    m = b.graphics.connectorGroup,
                    A = v.animObj,
                    C = v.dummyObj,
                    H = v.animType,
                    w = v.duration,
            ...
            getJSONData: function() {
                var a = this.components.data,
                    b = a.length,
                    c = [],
                    f,
                    e;
                for (e = 0; e < b; e++)
                    f = a[e], f.removed || (f.config._options && (delete f.config._options.update, delete f.config._options.add), c.push(f.config._options));
                return c
            },
            ...
            _drawArrow: function(a, b, c, f, e, l) {
                var m = r.atan((b - f) / (a - c)),
                    C = [];
                0 > m && (m = 2 * r.PI + m);
                if (f > b) {
                    if (c >= a && m > r.PI || c < a && m > r.PI)
                        m -= r.PI
                } else if (c >= a && m < r.PI && 0 !== m || c < a && m < r.PI)
                    m += r.PI;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragablelabels", function() {
        var a = this.hcLib,
            ...
            D = a.hashify,
            v = a.schedular,
            A = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")",
            F = a.setLineHeight,
            l = a.getMouseCoordinate,
            C = a.plotEventHandler;
        J.register("component", ["dataset", "DragableLabels", {
            configure: function() {
                var a = (this.JSONData || []).length,
                    c,
            ...
            _setConfigure: function(a, c) {
                var e = this.JSONData,
                    ...
                    l,
                    f = this.chart.config.style.inCanvasStyle,
                    v = f.fontSize;
                l = b[a];
                !l && (l = b[a] = {});
                !l.graphics &&
                ...
                b._options = e;
                b.add = e.add;
                l && (b.text = l, b.x = e.x || 0, b.y = e.y || 0, b.labelFontSize = v = I(e.fontsize, v), b.labelColor = D(S(e.color, f.color)), b.alpha = I(e.alpha, 100) / 100, b.allowdrag = I(e.allowdrag, 1), b.padding = I(e.padding, 5), b.labelCSS = e.fontsize ? {
                    fontSize: v + "px"
                } : void 0, b.labelBGColor = S(e.bgcolor && e.bgcolor.replace(R, r)), b.labelBDColor = S(e.bordercolor && e.bordercolor.replace(R, r)), b.link = e.link, b.allowDrag = I(e.allowdrag, 1), b.borderThickness =
            ...
            getJSONData: function() {
                var a = this.components.data,
                    ...
                    l;
                for (l = 0; l < c; l++)
                    b = a[l], b.removed || b.config._options && e.push(b.config._options);
                return e
            },
            draw: function() {
                var c = this,
                    ...
                    C = r.dummyObj,
                    r = r.animObj,
                    m = n.components.paper,
                    D = n.components.yAxis[0],
                    B = n.components.xAxis[0],
                    L = n.linkedItems.smartLabel,
                    w = n.graphics.datalabelsGroup,
                    U = n.graphics.trackerGroup,
                    g = n.config.dataLabelStyle,
                    y,
                    P,
                    R,
                    d,
                    ...
                    u,
                    da = l.length,
                    ma = c.components.removeDataArr || [],
                    La = ma.length,
                    aa = c.components.pool || {},
                    S,
                    X,
                ...
                w.css({
                    ...
                    "font-style": g.fontStyle,
                    "font-size": g.fontSize,
                    "font-family": g.fontFamily
                });
                for (S = 0; S < da; S++)
                    O = l[S], O.removed || (t = O.config, !O.graphics && (O.graphics = {}), t.index = S, U = B.getPixel(t.x), d = D.getPixel(t.y), T = t.text, h = t.labelBGColor, q = t.labelBDColor, k = t.padding, x = t.allowDrag, p = t.labelFontSize, N = t.labelColor, G = t.radius, R = t.dashed, u = t.borderThickness, y = t.dashLen, P = t.dashGap, u = t.borderThickness, X = t.labelCSS, y = {
                        x: U,
                        y: d,
                        text: T,
                        align: "center",
            ...
            drawTracker: function() {
                var a = this,
                    c = a.components.data,
                    e = a.chart,
                    b = e.components.paper,
                    l = a.groupManager,
                    f = a.config,
                    r = a.graphics.trackerContainer,
                    v = c.length,
                    m,
                    E,
                    F,
                    ...
                    x;
                for (x = 0; x < v; x++)
                    m = c[x], m.removed || (E = m.config, F = E.padding || 0, h = E.width, q = E.height, N = E.xPos - h / 2, T = E.yPos - q / 2, B = E.allowDrag, I = E.text, d = m.graphics.trackerElement, F = {
                        x: N - F,
                        y: T - F,
                        width: h + 2 * F,
                        height: q + 2 * F,
            ...
            _labelDragStart: function() {
                var a = this,
                    c = a.getBBox(),
                    e = a.data("drag-options"),
                    b = e.dataset,
                    l = b.groupManager,
                    f = b.components.data[e.index],
                    b = f.graphics.element,
            ...
            _labelDragMove: function(a, c, e) {
                var b = e.config,
                    ...
                    r = b.canvasBottom,
                    b = b.canvasTop,
                    v = this.data("drag-options"),
                    m = v.dataset,
                    A = m.groupManager,
                    m = m.components.data[v.index],
                    E = m.graphics.element,
                    F = m.dragStart,
                    w = F.bBox,
                    D = c[0];
                c = c[1];
            ...
            _labelDragUp: function(c) {
                var e = this.data("drag-options"),
                    ...
                    b = n.chart,
                    r = n.groupManager,
                    f = n.components.data[e.index].dragStart,
                    e = this.data("eventArgs"),
                    n = n.yAxis;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragcolumn", function() {
        ...
        J.register("component", ["dataset", "DragColumn", {
            configure: function() {
                ...
                l = v.length;
                for (c = 0; c < l; c++)
                    C = E[c] || {}, A = v[c].config, A.allowDrag = e(C.allowdrag, a.allowDrag), A.allowNegDrag = e(C.allownegativedrag, a.allowNegDrag)
            },
            _firePlotEvent: function(e, D, v) {
                var A = this.JSONData,
                    F = this.chart.jsonData.chart,
                    l = this.chart,
                    C = this.config,
                    H = l.config,
                    B = H.useplotgradientcolor,
                    n = H.useroundedges,
                    b = l.components,
                    z = b.paper,
                    f = z.canvas.style,
                    K = b.numberFormatter,
                    V = this.components.data[D],
                    m = V.config,
                    Z = V.graphics.element,
                    J = m.finalTooltext,
                    L = c.toolTip,
                    w = v.originalEvent,
                    U = I && "ns-resize" || "n-resize",
                    g = v.originalEvent;
                v = c.getMouseCoordinate(l.linkedItems.container, g).chartY;
                var y = V._yPos,
                    P = V._height,
                    ka = b.yAxis[0],
                    b = ka.getPixel(ka.getAxisBase()),
                    d,
                    N = H.canvasTop;
                d = H.canvasBottom;
                var T = m.allowDrag,
                    h = m.allowNegDrag ? d : b,
                    q,
                    k,
                    t = y,
                    O = y + P,
                ...
                d = y >= b ? y + P : y;
                if (Z)
                    switch (A = W(ba(E(m.origToolText, A.plottooltext, F.plottooltext))),
                    e) {
                    case "mouseover":
                        C.mouseIn = !0;
                        J && L.setStyle(z);
            ...
            getJSONData: function() {
                ...
                for (H = a.length; B < H; B++) {
                    ...
                    A = {};
                    for (C in l)
                        A[C] = "value" === C ? E.config.setValue : l[C];
                    e.push(A)
                }
                return {
                    data: e
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragarea", function() {
        var a = this,
            c = a.hcLib,
            E = "VML" === c.Raphael.type,
            e = c.BLANKSTRING,
            ba = c.parseUnsafeString,
            W = c.getValidValue,
            S = c.preDefStr.hiddenStr,
            I = c.pluck,
            B = c.pluckNumber,
            X = c.hasSVG,
            M = Math,
        ...
        J.register("component", ["dataset", "DragArea", {
            configure: function() {
                ...
                n = e.length;
                for (c = 0; c < n; c++)
                    v = E[c] || {}, r = e[c].config, r.allowDrag = B(v.allowdrag, a.allowDrag), r.allowNegDrag = B(v.allownegativedrag, a.allowNegDrag)
            },
            updateImage: function(a) {
                var c =
                    ...
                    b = D.imageScale,
                    z = c.components.paper,
                    f = v.height * b * .01,
                    K = v.width * b * .01,
                    c = a._xPos;
                a = a._yPos;
                var V = B.imageHoverScale,
                    m = v.width * V * .01,
                    Z = v.height * V * .01,
                    I = D.radius = D.isAnchorRadius ? D.radius : r(K, f) / 2,
                    L = D.imagePadding,
                    w = I - L - .5 * D.borderThickness,
                    L = B.radius - L - .5 * B.anchorBorderThickness,
                    I = D.symbol[1],
                    D = z.polypath(I || 2, c, a, 0 < w ?
                    w : 0, D.startAngle, 0).attr({
                        visibility: S
                    }),
                    w = n(D.attrs.path),
                    b = {
            ...
            _firePlotEvent: function(e, r, l) {
                var C = this.JSONData,
                    ...
                    Z = m.data[r],
                    M = m.data.length,
                    L = J.get("component", ["dataset", "DragArea"]),
                    w = this.config,
                    U = this.index;
                l = l.originalEvent;
                var g = X && "ns-resize" || "n-resize",
                    y,
                    P,
                    S,
                    d,
                ...
                if (Z)
                    ...
                    case "mousemove":
                        if (t.dragStart) {
                            ...
                            E && ma ? La = N : (db && (d = N.data("setRolloverAttr")) && (d.polypath[2] = Z._yPos), db && (S = N.data("setRolloutAttr")) && (S.polypath[2] = Z._yPos), N && N.attr(S || {
                                polypath: [da.symbol[1] || 2, B, Z._yPos, da.radius, aa, 0]
                            }));
                            ...
                            if (fc)
                                for (L = 0; L < M; L++)
                                    if (d = m[L].graphics &&
                                    m[L].graphics.connector)
                                        K = m[L], S = K.config.connStartIndex, K = K.config.connEndIndex, S = this.getLinePath(m, {}, {
                                            begin: S,
                                            end: K + 1
                                        }), d.attr({
                                            path: S.getPathArr()
            ...
            getJSONData: function() {
                ...
                for (b = a.length; z < b; z++) {
                    ...
                    r = {};
                    for (n in v)
                        r[n] = "value" === n ? E.config.setValue : v[n];
                    e.push(r)
                }
                return {
                    data: e
        ...
        J.register("component", ["dataset", "DragLine", {
            ...
            getJSONData: function() {
                ...
                for (B = a.length; X < B; X++) {
                    ...
                    J = {};
                    for (S in W)
                        J[S] = "value" === S ? I.config.setValue : W[S];
                    e.push(J)
                }
                return {
                    data: e
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-selectscatter", function() {
        var a = this,
            c = a.hcLib,
            E = c.graphics.convertColor,
            e = c.preDefStr,
            ba = e.altHGridColorStr,
            W = e.altHGridAlphaStr,
            S = e.colors.FFFFFF,
            I = c.getValidValue,
            B = c.ZEROSTRING,
            X = c.bindSelectionEvent,
            M = c.getMouseCoordinate,
            R = c.extend2,
            r = c.pluck,
            D = c.pluckNumber;
            ...
            draw: function() {
                ...
                X(c, {
                    ...
                    selectionEnd: function(c) {
                        var l = M(e, c.originalEvent),
                            r = c.chart.components.xAxis[0],
                            v = c.chart.components.yAxis[0],
                            l = R({
                                selectionLeft: c.selectionLeft,
                                selectionTop: c.selectionTop,
                                selectionWidth: c.selectionWidth,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-candlestick", function() {
        var a = this.hcLib,
            ...
            I = a.getFirstValue,
            B = a.getFirstColor,
            X = c.setRolloverAttrStr,
            M = c.setRolloutAttrStr,
            R = a.ZEROSTRING,
            r = a.parseUnsafeString,
            D = c.column,
            v = a.getDashStyle,
        ...
        J.register("component", ["dataset", "Candlestick", {
            ...
            configure: function() {
                if (this.plotType === e)
                    ...
                    var b = this.config,
                        ...
                        x = c.jsonData.chart,
                        p = l.length,
                        G = b.plotPriceAs = S(x.plotpriceas, W).toLowerCase(),
                        u = k.numberFormatter,
                        n = k.colorManager,
                        m,
                        z,
                        aa,
                        A,
                        k = b.bearBorderColor = B(g(x.bearbordercolor, w)),
                        ...
                        H = b.plotLineDashLen = y(x.plotlinedashlen, 5),
                        P = b.plotLineDashGap = y(x.plotlinedashgap,
                        4),
                        Z = !!y(x.drawanchors, 1),
                        I = y(x.anchorstartangle, 90),
                        Q = y(x.anchorradius, this.anchorRadius, 3),
                        T = B(g(x.anchorbordercolor, K)),
                        M = y(x.anchorborderthickness, this.anchorBorderThickness, 1),
                        n = B(g(x.anchorbgcolor, n.getColor("anchorBgColor"))),
                        X = g(x.anchoralpha, R),
                        J = g(x.anchorbgalpha, X),
                        ga,
                        Ia,
                        va,
                        Fa,
                    ...
                    b.animation = ga ? {
                        duration: 1E3 * y(x.animationduration, 1)
                    } : !1;
                    ...
                    for (ga = 0; ga < p; ga += 1)
                        if (fa = l[ga], (Ia = sa[ga]) || (Ia = sa[ga] = {}), !Ia.config && (Ia.config = {}), !Ia.graphics && (Ia.graphics = {}), ha = Ia.config, fa && !fa.vline) {
                            ...
                            ha.colorArr = [{
                                ...
                                color: ha.borderColor,
                                alpha: ha.borderAlpha
                            }];
            ...
            _parseToolText: function(a) {
                var b = this.config,
                    ...
                    d = b.plotType ===
                    E ? 1 : 0,
                    f = this.JSONData.data[a],
                    e = this.components.data[a].config,
            ...
            _configureVolume: function() {
                var b = this.config,
                    ...
                    m,
                    z,
                    E = b.bearBorderColor = B(g(e.bearbordercolor, w)),
                    A = b.bearFillColor = B(g(e.bearfillcolor, w)),
                    p = b.bullBorderColor = B(g(e.bullbordercolor, p.getColor("canvasBorderColor"))),
                    C = b.bullFillColor = B(g(e.bullfillcolor, U)),
                    K = y(e.showvplotborder,
                    1) ? y(e.vplotborderthickness, 1) : 0,
                    V = b.plotLineDashLen = y(e.plotlinedashlen, 5),
                    F = b.plotLineDashGap = y(e.plotlinedashgap, 4),
                    L,
                    H = this.yAxis,
                    P = -Infinity,
                    Z = Infinity,
                ...
                b.animation = k ? {
                    duration: 1E3 * y(e.animationduration, 1)
                } : !1;
                k = g(e.maxcolwidth);
                ...
                for (c = 0; c < x; c += 1)
                    ...
                    G < n ? E : p)), l = g(m.alpha, "100"), G = B(g(m.color, G < n ? A : C)), L.dashStyle = y(m.dashed) ? v(V, F) : "none", n = {
                        opacity: l / 100
                    }, L.color = G, L.alpha = l, L.setLink = m.link, L.borderWidth = K, L.borderColor = u, L.borderAlpha = g(L.plotLineAlpha, l), L.y = z, L.colorArr = [{
                        color: L.color,
                        alpha: L.alpha
                    }, {
                        color: L.borderColor,
            ...
            _drawColumn: function() {
                var b = this,
                    ...
                    r,
                    w = b.visible,
                    z = k.components.paper,
                    v = k.components.xAxis[0],
                    E = b.yAxis,
                    B,
                    K,
                    U = k.graphics,
                    P = a.parseUnsafeString,
                    Z = a.getValidValue,
                    T = a.Raphael,
                    I,
                    S = e.showTooltip,
                    ...
                    Va = R.animObj,
                    Da = v.getPVR(),
                    Ia = e.plotSpacePercent,
                    va = e.maxColWidth,
                    Da = (1 - .01 * e.definedGroupPadding) * Da || ka(Da * (1 - 2 * Ia), 1 * va),
                    Ia = Da / 2,
                    Da = Da / 1,
                    va = ka(Da - 1, 0),
                    Ia = 0 * Da - Ia + va / 2,
                    Fa,
                    wa = b.components.data,
                    oa,
                    qa,
                    la,
                    ia,
                    va = E.getAxisBase(),
                    ea = E.yBasePos = E.getAxisPosition(va),
                    sa = e.plotBorderThickness,
                    fa = e.plotRadius || 0,
                    ha = b.graphics.container,
                    ca = b.graphics.shadowContainer,
                    Aa,
                    ya,
                    Y,
                    ua = !k.config.plotAnimDone,
                    xa = b.components.removeDataArr || [],
                    za =
                    xa.length,
                    Ga = J.get("component", ["dataset", D]).prototype.drawLabel,
                    Ma = function() {
                ...
                e.columnWidth = Da;
                for (e = 0; e < u; e++)
                    m = G[e], oa = wa[e], m.originalIndex = e, ia = oa && oa.config, la = ia.setLink, r = ia.y, B = y(ia.x, e), Aa = ia.colorArr, null !== r && (la = ia.setLink, oa.graphics || (wa[e].graphics = {}), qa = b.index + V + e, ia.groupId = qa, qa = ia.displayValue, Z(P(g(m.tooltext, c.plottooltext, f.plottooltext))),
                ...
                for (e = 0; e < za; e++)
                    if (oa = xa[0])
                        b._removeDataVisuals(oa.graphics), xa.shift();
                b.drawn = !0;
                for (e = b.JSONData.data.length; e--;)
                    b.JSONData.data[e].originalIndex = e;
            ...
            _getHoveredPlot: function(a, b) {
                ...
                if (k === E)
                    return this._getHoveredPlotCandleLine(a, b);
                if (k === D)
                    return this._getHoveredPlotCandleColumn(a, b)
            },
            _getHoveredPlotCandleLine: function(a, b) {
                var k = this.chart,
                    c = k.components.canvas.config,
                    d = k.components.xAxis[0],
                ...
                for (g = e.length; g--;)
                    if (k = f[e[g].originalIndex])
                        if (k = this.isWithinShape(k, e[g].originalIndex, a, b))
                            return k;
                for (g = d.length; g--;)
                    if (k = f[d[g].originalIndex])
                        if (k = this.isWithinShape(k, d[g].originalIndex, a, b))
                            return k
            },
            _getHoveredPlotCandleColumn: function(a, b) {
                for (var k = this.chart, c = k.components.canvas.config, d, k = k.components.xAxis[0].getValue(a - k.config.canvasLeft - Math.max(c.canvasPaddingLeft, c.canvasPadding)), k = this.getPlotIndices(k),
                    c = k.length; c--;)
                    this._checkPointerOverErrorBar(k[c].originalIndex, a, b) && (d = this._checkPointerOverErrorBar(k[c].originalIndex, a, b)), this._checkPointerOverColumn(k[c].originalIndex, a, b) && (d = this._checkPointerOverColumn(k[c].originalIndex, a, b));
                return d
            },
            getPlotIndices: function(a) {
                var b = Math.floor(a),
                    ...
                    c,
                    d = [];
                for (a = (this.JSONData && this.JSONData.sortedData).length; a--;)
                    c = this.JSONData.sortedData[a], c.x >= b && c.x <= k && d.push(c);
                return d
            },
            _checkPointerOverErrorBar: function(a, b, k) {
                ...
                if (d && (d = d.errorBar))
                    for (g = d && d.length; g--;)
                        for (u = (e = d[g]) && e.length; u--;)
                            if (e[u] && e[u]._xPos && (f = e[u]._xPos, l = e[u]._yPos, n = e[u]._height, m = e[u]._width, f = b >= f && b <= f + m && k >= l && k <= l + n))
                                return {
                                    pointIndex: a,
                                    hovered: f,
                                    pointObj: c[a]
            ...
            _checkPointerOverColumn: function(a, b, k) {
                ...
                null !== c && (b = b - (g._xPos - l * n) + f, k = k - g._yPos + f + (0 < c ? u : 0), d = 0 <= b && b <= g._width + d && 0 <= k && k <= g._height + d + (0 < c ? 0 : u))))
                    return {
                        pointIndex: a,
                        hovered: d,
                        pointObj: e[a]
            ...
            _firePlotEvent: function(a, b, c) {
                ...
                if (d === E)
                    return this.__base__._firePlotEvent.call(this, a, b, c);
                if (d === D)
                    return J.get("component", ["dataset", "column"]).prototype._firePlotEvent.call(this, a, b, c)
            },
            _rolloverResponseSetter: function(a, b, c) {
                var d = this.graphics.sharedAnchor,
                    d = b.graphics.element || d.element;
            ...
            _drawCandlestickBar: function() {
                var a = this.chart,
                    ...
                    c = c.paper,
                    l = f.numColumns || 1,
                    n = f.columnPosition || 0,
                    m = p.getPVR(),
                    r = f.groupPadding,
                    w = f.maxColWidth,
                    m = (1 - .01 * f.plotspacepercent) * m || ka(m * (1 - 2 * r), w * l),
                    l = m / l * n - m / 2,
                    u = u.datasetGroup,
                    v,
                    E,
                ...
                for (v = 0; v < T; v++)
                    this._removeDataVisuals(Z.shift())
            },
            _drawErrorValue: function() {
                var a = this.config,
                    c = this.JSONData.data,
                    c = c && c.length,
                    d;
                d = this.visible;
                var e = this.chart,
                    g = e.components.paper,
                    x = e.components.yAxis[0],
                    p = this.components.data,
                    G,
                    u = a.errorBarWidthPercent,
                    l,
                    n = e.graphics,
                    m = n.datasetGroup,
                    a = a.showTooltip,
                    r = this.graphics.errorGroupContainer,
                    w = this.graphics.errorTrackerContainer,
                    z = n.trackerGroup,
                    v,
                    y,
                    E,
                ...
                for (d = 0; d <
                c; d++)
                    if (v = (m = p[d]) && m.config, B = v.y, w = v.errorValue, z = w.length, !m.graphics.error && (m.graphics.error = []), null !== B) {
                        v = v.setLink;
                        B = 0 > B;
                        y = m._xPos;
                        E = m._yPos;
                        ...
                        if (l > z)
                            for (Z = z; Z < l; Z++)
                                I = G.pop(), this._removeDataVisuals(I);
                        for (m.errorBar || (m.errorBar = []); z--;)
                            (T = m.graphics.error[z]) || (T = m.graphics.error[z] = {}), Z = T.errorLineElem, H = w[z], C = H.errorValue, D = H.errorStartValue, l = H.errorBarColor, G = H.errorBarThickness, I = isNaN(D) ? E : x.getAxisPosition(D), V =
                            u / 100 * Q, V /= 2, C = x.getAxisPosition((void 0 !== D && null !== D ? D : void 0) + C), B && (C += R), C = P(C) + G % 2 / 2, D = P(y) + G % 2 / 2, V = ["M", D, I, "V", C, "M", D - V, C, "H", D + V], H.errorPath = V, H = m.graphics.hotElement || m.graphics.element, H.data("groupId"), m.errorBar[z] || (m.errorBar[z] = []), m.errorBar[z][0] = {
                                ...
                                _height: N(I - C),
                                _width: 4
                            }, Z || (Z = M.errorLineElem && M.errorLineElem.length ? T.errorLineElem = M.errorLineElem.shift() : T.errorLineElem = g.path(r)), Z.show().animateWith(F, U, {
                                path: V
                            }, n, e.animType), Z.attr({
                                stroke: l,
                                ishot: !a,
            ...
            removeData: function(a, b) {
                var c = this.components,
                    d = c.data,
                    f = c.removeDataArr || (c.removeDataArr = []);
        ...
        J.register("component", ["dataset", "Trendset", {
            configure: function() {
                var a = this.chart,
                    ...
                    M = -Infinity,
                    L = Infinity,
                    w = a.components.numberFormatter,
                    r = A(I(e.color, c.trendsetcolor, "666666"));
                E = I(e.alpha, c.trendsetalpha,
                "100");
                F = X(e.thickness, c.trendsetthickness, 2);
                z = !!X(e.dashed, c.trendsetdashed, 0);
                var U = X(e.dashlen, c.trendsetdashlen, 4),
                    g = X(e.dashgap, c.trendsetdashgap, 4);
                ...
                r = 0;
                for (F = n.length; r < F; r += 1)
                    (z = n[r]) && !z.vline && (e = f[r] = f[r] || (f[r] = {}), E = e.config = e.config || (e.config =
            ...
            _addLegend: function() {
                var a = this.JSONData,
                    c = this.config,
                    e = this.chart.components.legend,
                    a = {
            ...
            draw: function() {
                var a = this.chart,
                    ...
                    d = B["clip-canvas"].slice(0),
                    B = B["clip-canvas-init"].slice(0),
                    N = v.lineDashStyle,
                    v = {
                        color: v.lineColor,
                        alpha: v.lineAlpha
                ...
                for (b = 0; b < n; b++)
                    U = w[b], A = U.config, D = A.setValue, A = A.x, A = c.getAxisPosition(A), D = f.getAxisPosition(D), U._xPos = A, U._yPos = D;
                n = this.getLinePath(w, {}).getPathArr();
                h || (h = this.graphics.lineElement = z.path(y.lineGroup), T = !0);
                h.show().animateWith(I, L, {
                    path: n
                }, a, F);
                h.attr({
                    "stroke-dasharray": N,
                ...
                a && q && T && (y.lineShadowGroup.hide(), P.line.attr({
                    "clip-rect": B
                }).animateWith(I, L, {
                    "clip-rect": d
                }, a, F, M))
    ...
    function() {
        var a = this.hcLib,
            ...
            g = a.getFirstColor,
            y = a.getFirstAlpha,
            P = a.graphics.getLightColor,
            ka = a.graphics.convertColor,
            d = a.POSITION_LEFT,
            N = a.COMMASTRING,
            T = a.HUNDREDSTRING,
            h = a.plotEventHandler;
        J.register("component", ["dataset", "boxandwhisker2d", {
            ...
            configure: function() {
                var c = this.chart,
                    ...
                    e = this.JSONData,
                    h = e.data,
                    x = c.config.categories,
                    p = c.singleseries,
                    G = c.config,
                    u = w(x && x.length, h && h.length),
                    l = c.jsonData.chart,
                    v = c.components.colorManager,
                    E = this.index || this.positionIndex,
                    aa,
                    A = d.plotColor = v.getPlotColor(E),
                    B = f(e.dashed, l.plotborderdashed),
                    D = f(l.useplotgradientcolor, 1),
                    C,
                    K = a.parseUnsafeString,
                    V = K(l.yaxisname),
                    L = K(l.xaxisname),
                    F = K(b(l.tooltipsepchar, ": ")),
                    I = a.parseTooltext,
                    H,
                    Z,
                    M,
                    ...
                    Ka = c.components.numberFormatter,
                    Xb,
                    Mb,
                    $a,
                    Pb,
                    ...
                    Wa = 0,
                    ob = 0,
                    Jb = a.BoxAndWhiskerStatisticalCalc,
                    cb,
                    Gb,
                    jb,
                    kb,
                ...
                qb = this.components.data;
                for (Sa = 0; Sa < u; Sa++)
                    if (ca = h && h[Sa], Y = (ya = qb[Sa]) && ya.config, ya ||
                    (ya = qb[Sa] = {
                        graphics: {}
                    }), ya.config || (Y = qb[Sa].config = {}), ca.value) {
                        ...
                        ob = w(ob, rb);
                        if (Hb && ca.outliers)
                            for (ub = 0; ub < Y.outliers.length; ub++)
                                Wa = U(Wa, Y.outliers[ub]), ob = w(ob, Y.outliers[ub]);
                        ...
                        0, !1), Y.lowerBoxHoverColorArr = a.graphics.getColumnColor(Ba, Ua, void 0, void 0, wa, fa, sa.toString(), 0, !1), Y.setUpperBoxRolloutAttr = {
                            fill: m(Y.upperColorArr[0])
                        }, Y.setUpperBoxRolloverAttr = {
                            fill: m(Y.upperBoxHoverColorArr[0])
                        }, Y.setLowerBoxRolloutAttr = {
                            fill: m(Y.lowerColorArr[0])
                        }, Y.setLowerBoxRolloverAttr = {
                            fill: m(Y.lowerBoxHoverColorArr[0])
                        }, Y.setUpperBoxBorderRolloverAttr = {
                            stroke: ka(Ga, Ma),
                            "stroke-width": ra
                        ...
                        Y.setMedianRolloverAttr = {
                            stroke: ka(Eb, Fb),
                            "stroke-width": Lb
                        }, Y.setMedianRolloutAttr = {
                            stroke: Y.median.color,
                            "stroke-width": Y.median.borderWidth
                        });
                        H = Y.toolTipValue;
                ...
                for (Sa = 0; Sa < Ib; Sa++)
                    Ya = this._createSubDS(4 + Sa, "Outliers", Sa), this.components.outliers[Sa] = Ya;
            ...
            _createSubDS: function(a, b, d) {
                var c = this.chart,
                    f = c.jsonData.dataset,
                    e = f && f.length,
                    g = this.components,
                    h,
                    l,
                    f = c.components.legend,
                    m = {},
                    g = g.dataset || (g.dataset = []),
                    e = e * (a + 1) + this.index;
                if (g[a])
                    l = g[a], l.index = e, c = V({}, this.JSONData), l.JSONData = c;
                else if (h = J.get("component", ["dataset", "subDS"]))
                    void 0 === m.subDS ? m.subDS = 0 : m.subDS++, l = new h, l.chart = c, l.index = e, g.push(l), c = V({}, this.JSONData), this.initSubDataset(c, l), l.name = b;
                switch (a) {
                case 0:
            ...
            configureMean: function(d) {
                var c = d.chart,
                    e = c.components,
                    g = a.parseUnsafeString,
                    x = d.config,
                    p = d.JSONData,
                    h = c.jsonData.chart,
                    u = e.colorManager,
                    m = d.index || d.stackIndex,
                    n = d.type,
                    v = !c.singleseries || z(h.palettecolors) ? u.getPlotColor(m) : u.getColor(l).split(/\s*\,\s*/)[0],
                    m = p.data,
                    y,
                    A = c.config.categories,
                    A = w(A && A.length, m && m.length),
                    B = e.numberFormatter,
                    D = c.use3dlineshift,
                    C,
                    K = -Infinity,
                    ...
                    L,
                    F,
                    I = b(h.tooltipsepchar, ": "),
                    P = f(p.dashed, h.linedashed);
                F = c.isStacked;
                y = c.hasLineSet;
                e = e.xAxis[0];
                ...
                x.animation = u ? {
                    duration: 1E3 * f(h.animationduration, 1)
                } : !1;
                ...
                x.shadow = {
                    opacity: f(h.showshadow, c) ? n === H ? x.alpha / 100 : x.plotBorderAlpha / 100 : 0
                };
                ...
                c = d.components.data;
                for (v = 0; v < A; v++)
                    y = m && m[v], n = c[v] = c[v] || {}, n.config = n.config || {}, u = n.config, D = this.components.data[v].config, y.value = D.showMean ? D.mean : null, u.x = this.components.data[v]._xPos, u.setValue = D = B.getCleanValue(y.value), u.setLink =
                    ...
                    p.meaniconshape, h.meaniconshape, "polygon"), x.dip = u.dip = "polygon" === y ? 0 : "spoke" === y ? 1 : 0, y = x.showTooltip ? "<b>Mean" + I + "</b>" : !1, u.toolText = y, u.setTooltext = y, n ? n.graphics || (c[v].graphics = {}) : c[v] = {
                        graphics: {}
                    }, u.hoverEffects = {
                        enabled: !1
                    };
            ...
            configureSD: function(d) {
                var c = d.chart,
                    ...
                    F,
                    I,
                    P = b(m.tooltipsepchar, ": "),
                    Z = f(p.dashed, m.linedashed);
                I = c.isStacked;
                A = c.hasLineSet;
                e = e.xAxis[0];
                d.visible = 1 === f(d.JSONData.visible, !Number(d.JSONData.initiallyhidden), 1);
                ...
                h.animation = u ? {
                    duration: 1E3 * f(m.animationduration, 1)
                } : !1;
                ...
                h.shadow = {
                    opacity: f(m.showshadow, c) ? v === H ? h.alpha / 100 : h.plotBorderAlpha / 100 : 0
                };
            ...
            configureMD: function(d) {
                ...
                c = d.components.data;
                for (y = 0; y < D; y++)
                    A = n && n[y], v = c[y] = c[y] || {}, v.config = v.config || {}, u = v.config, C = this.components.data[y].config, A.value = C.showMD ? C.md :
                    ...
                    a.getValidValue(g(b(A.tooltext, p.plottooltext, m.plottooltext))), A = b(A.mdiconshape, p.mdiconshape, m.mdiconshape, "polygon"), h.dip = u.dip = "polygon" === A ? 0 : "spoke" === A ? 1 : 0, A = h.showTooltip ? "<b>MD" + P + "</b>" : !1, u.toolText = A, u.setTooltext = A, v ? v.graphics || (c[y].graphics = {}) : c[y] = {
                        graphics: {}
                    }, u.hoverEffects = {
                        enabled: !1
                    };
            ...
            configureQD: function(d) {
                ...
                g.shadow = {
                    opacity: f(m.showshadow, c) ? v === H ? g.alpha / 100 : g.plotBorderAlpha / 100 : 0
                };
                ...
                for (y = 0; y < D; y++)
                    ...
                    !1, u.toolText = A, u.setTooltext = A, v ? v.graphics || (c[y].graphics = {}) : c[y] = {
                        graphics: {}
                    }, u.hoverEffects = {
                        enabled: !1
                    };
            ...
            configureOutliers: function(d, c) {
                ...
                p.animation = n ? {
                    duration: 1E3 * f(u.animationduration, 1)
                } : !1;
                ...
                p.shadow = {
                    opacity: f(u.showshadow, e) ? y === H ? p.alpha / 100 : p.plotBorderAlpha / 100 : 0
                };
                p.drawAnchors =
            ...
            _parseAnchorProperties: function(d, c, e) {
                ...
                c.shadow = f(d.anchorshadow, g.anchorShadow) && 1 <= c.radius ? {
                    opacity: h / 100
                } : !1;
                g.attachEvents = !0;
                return c
            ...
            init: function(a) {
                var d = this.chart,
                    b = d.components,
                    c = a.parentyaxis && a.parentyaxis.toLowerCase() ===
                    r ? 1 : 0,
                    b = b.yAxis[c];
                if (!a)
                    return !1;
            ...
            draw: function() {
                var a,
                    ...
                    ga = u.chart,
                    ka = ga.config,
                    pa = ga.components.paper,
                    Na = ga.components.xAxis[0],
                    Ra = u.yAxis,
                    Va = ga.graphics.columnGroup,
                    Da,
                    Ia,
                    va = ga.graphics,
                    Fa = z.showtooltip,
                    ...
                    la = wa.dummyObj,
                    ia = wa.duration,
                    ea = Na.getAxisPosition(0),
                    sa = Na.getAxisPosition(1) - ea,
                    fa = z.definedGroupPadding,
                    ha = z.plotSpacePercent / 200,
                    ca = E.getDataSetPosition(u),
                    Aa = z.maxcolwidth,
                    ya = (1 - .01 * fa) * sa || w(sa * (1 - 2 * ha), 1 * Aa),
                    Y = f(ca.columnWidth, ya / 1),
                    ua,
                    xa = ca.xPosOffset || 0,
                    za = ca.height,
                    Ga,
                    Ma = u.components.data,
                    ra,
                    Ba,
                    Ua,
                    Ja,
                    ...
                    Db,
                    Kb = z.showShadow,
                    pb = u.graphics.upperBoxContainer,
                    hb = u.graphics.lowerBoxContainer,
                    Eb = u.graphics.medianContainer,
                    Fb = u.graphics.upperWhiskerContainer,
                    Lb = u.graphics.lowerWhiskerContainer,
                    ib = u.graphics.dataLabelContainer,
                    qb = u.graphics.shadowContainer,
                    Ka,
                    Xb,
                    Mb,
                    $a,
                    ...
                    sb,
                    ab,
                    na = ga.config.dataLabelStyle,
                    Yb = va.datalabelsGroup,
                    Ha = z.rotatevalues,
                    lb = z.valuepadding,
                    mb = ga.components.numberFormatter,
                    bb = Ha ? d : "middle",
                    Hb = ga.linkedItems.smartLabel,
                    Ca,
                    Za,
                    Rb,
                    Sb,
                    ...
                    ic,
                    wb = !0,
                    yc = (u.components.removeDataArr || []).length,
                    kc,
                    lc,
                    mc,
                    nc,
                    ...
                    bc = function(a) {
                        return function(d) {
                            ...
                            if (0 !== this.data(W))
                                for (b in a)
                                    "label" !== b && (a[b].attr(this.data("setRolloverAttr")[b]), h.call(this, ga, d, "DataPlotRollOver"))
                        }
                    },
                    cc = function(a) {
                        return function(d) {
                            ...
                            if (0 !== this.data(W))
                                for (b in a)
                                    "label" !== b && (a[b].attr(this.data("setRolloutAttr")[b]), h.call(this, ga, d, "DataPlotRollOut"))
                        }
                    },
                    Cb = function() {
                ...
                for (R = 0; R < M; R++)
                    if (Ua =
                    (ja = (ra = Ma[R]) && ra.config) && ja.setValue, sc = rc = qc = pc = oc = nc = mc = lc = kc = !1, void 0 !== ra && void 0 !== Ua && null !== Ua)
                        for (Ca = ra.graphics, xb = 0 <= Ua, Ba = ja.setLink, ra.graphics || (Ma[R].graphics = {}), Ca.label || (Ma[R].graphics.label = []), Qb = xb ? ja.previousPositiveY : ja.previousNegativeY, Db = Ra.getAxisPosition(Qb || eb), Da = Na.getAxisPosition(R) + xa, 0 === za && (jc = 0, Xa = Db), Ia = w(Ia, Db), ua = Y, Mb = ((Xb = (Ka = ja.upperQuartile || {}, Ka.value)) || 0 === Xb) && Ra.getAxisPosition(Xb), yb = ((Pb = ($a = ja.lowerQuartile || {}, $a.value)) || 0 === Pb) && Ra.getAxisPosition(Pb),
                        Wa = ((Sa = (nb = ja.median) && nb.value) || 0 === Sa) && Ra.getAxisPosition(Sa), ob = Wa - Mb, Jb = yb - Wa, cb = ja.upperBoxBorder || {}, Gb = ja.lowerBoxBorder || {}, Ga = ja.toolText, Za = u.index + C + R, Ja = {
                            ...
                            stroke: cb.color,
                            "stroke-width": cb.borderWidth,
                            "stroke-linecap": X,
                            dashstyle: cb.dashStyle,
                            ishot: !0,
                            visibility: J
                        }, g = {
                            stroke: Gb.color,
                            ...
                            height: U(w(jc, ob), 0),
                            r: 0
                        }, (jb = ra.graphics.upperBoxElem) ? (jb.animateWith(la, qa, N, ia, oa, wb && Cb), wb = !1) : (jb = ra.graphics.upperBoxElem = pa.rect(N, pb), kc = !0), jb.attr(a).shadow({
                            opacity: Kb ? z.upperBoxAlpha / 100 : 0
                        }, qb), N = {
                            path: ["M", Pa, Xa || ab, "V", Xa || ab + ob, "M", sb, Xa || ab, "V", Xa || ab + ob]
                        }, (kb = ra.graphics.upperBoxBorderEle) ? kb.animateWith(la, qa, N, ia, oa, wb && Cb) : (kb = ra.graphics.upperBoxBorderEle =
                        pa.path(N, pb), mc = !0), kb.attr(c), N = {
                            path: ["M", Pa, Xa || ab, "H", Pa + ua]
                        }, (zb = ra.graphics.upperQuartileEle) ? zb.animateWith(la, qa, N, ia, oa, wb && Cb) : (zb = ra.graphics.upperQuartileEle = pa.path(N, pb), oc = !0), zb.attr(l), Rb = ab, Sb = z.whiskerslimitswidthratio / 100 * ua, Nb = Sb / 2, Ib = Ob = Ra.getAxisPosition(ja.max), Ya = Pa, Ib = L(Ob) + ja.upperWhiskerThickness % 2 / 2, Pa = L(Pa + ua / 2) + ja.upperWhiskerThickness % 2 / 2, ub = ["M", Pa, Xa || Rb, "V", w(Xa || Ib, tc), "M", Pa - Nb, w(Xa || Ib, tc), "H", Pa + Nb], gb = ra.graphics.upperWhiskerEle, N = {
                            path: ub,
                            ishot: !Fa,
                            "stroke-width": ja.upperWhiskerThickness,
                            cursor: Ba ? "pointer" : n,
                            "stroke-linecap": X
                        }, gb ? gb.animateWith(la, qa, N, ia, oa, wb && Cb) : (gb = ra.graphics.upperWhiskerEle = pa.path(N, Fb), rc = !0), gb.attr({
                            stroke: ja.upperWhiskerColor
                        }), gb.shadow({
                            opacity: ja.upperWhiskerShadowOpacity
                        }, qb), Hb.useEllipsesOnOverflow(ga.config.useEllipsesWhenOverflow), Hb.setStyle(na), Tb = Hb.getOriSize(mb.dataLabels(ja.max)), Zb = Ha ? Tb.width : Tb.height, Ub = Ob - .5 * ja.upperWhiskerThickness - lb - Zb * (Ha ? .5 : 1), Ub - (Ha ? Zb / 2 : 0) < ka.canvasTop && (Ub = ka.canvasTop + (Ha ? Zb / 2 : 0)), N = {
                        ...
                        }, ia, oa, wb && Cb)) : Ca.label[3] = pa.text(N, ib), Ca.label[3].data("groupId", Za)) : Ca.label[3] && Ca.label[3].hide() && Ca.label[3].attr({
                            "text-bound": []
                        }), Pa = L(Da) + Gb.borderWidth % 2 * .5, sb = L(Da + ua) + Gb.borderWidth % 2 * .5, ab = L(Wa + Jb) + $a.borderWidth % 2 * .5,
                        uc = Xa || Wa, vc = U(w(jc, ab - Wa), 0), wc = uc + vc, N = {
                            ...
                            height: vc,
                            r: 0
                        }, (rb = ra.graphics.lowerBoxElem) ? rb.animateWith(la, qa, N, ia, oa, wb && Cb) : (rb = ra.graphics.lowerBoxElem = pa.rect(N, hb), lc = !0), rb.attr(b).shadow({
                            opacity: Kb ? z.lowerBoxAlpha / 100 : 0
                        }, qb), N = {
                            path: ["M", Pa, Xa || Wa, "V", Xa || Wa + Jb, "M", sb, Xa || Wa, "V", Xa || Wa + Jb]
                        }, (Oa = ra.graphics.lowerBoxBorderEle) ? Oa.animateWith(la, qa, N, ia, oa, wb && Cb) : (Oa = ra.graphics.lowerBoxBorderEle = pa.path(N, hb), nc = !0), Oa.attr(g), ab = L(Wa + Jb) + $a.borderWidth % 2 * .5, N = {
                            path: ["M",
                            Pa, Xa || ab, "H", Pa + ua]
                        ...
                        qa, {
                            ...
                            fill: na.color,
                            "text-bound": [na.backgroundColor, na.borderColor, na.borderThickness, na.borderPadding, na.borderRadius, na.borderDash]
                        })) : Ca.label[4] = pa.text(N, ib), Ca.label[4].data("groupId", Za)) : Ca.label[4] && Ca.label[4].hide() && Ca.label[4].attr({
                            "text-bound": []
                        }), N = {
                            path: ub,
                            ishot: !Fa,
                            ...
                            cursor: Ba ? "pointer" : n,
                            "stroke-linecap": X
                        }, vb ? vb.animateWith(la, qa, N, ia, oa, wb && Cb) : (vb = ra.graphics.lowerWhiskerEle = pa.path(N, Lb), sc = !0), vb.attr({
                            stroke: ja.lowerWhiskerColor
                        }), vb.shadow({
                            opacity: ja.lowerWhiskerShadowOpacity
                        }, qb), ab = L(Wa) + nb.borderWidth % 2 * .5, N = {
                            path: ["M", Pa, Xa || ab, "H", Pa + ua]
                        }, (tb = ra.graphics.midLineElem) ? tb.animateWith(la, qa, N, ia, oa, wb && Cb) : (tb = ra.graphics.midLineElem = pa.path(N, Eb), qc = !0), tb.attr(r), Vb = {
                        ...
                        }, Z(Ka.displayValue) && Ka.displayValue !== Q && ja.showQ3Values ? (Ca.label[0] ? (Ca.label[0].show(), Ab = Da + ua / 2, Bb = Xa || Mb - lb, Ca.label[0].animateWith(la, qa,
                        {
                            ...
                            fill: na.color,
                            "text-bound": [na.backgroundColor, na.borderColor, na.borderThickness, na.borderPadding, na.borderRadius, na.borderDash]
                        })) : Ca.label[0] = pa.text(N, ib), Ca.label[0].data("groupId", Za)) : Ca.label[0] && Ca.label[0].hide() && Ca.label[0].attr({
                            "text-bound": []
                        }), N = {
                            ...
                            x: Ab,
                            y: Bb,
                            transform: pa.getSuggestiveRotation(Ha,
                            Ab, Bb)
                            ...
                            fill: na.color,
                            "text-bound": [na.backgroundColor, na.borderColor, na.borderThickness, na.borderPadding, na.borderRadius, na.borderDash]
                        })) : Ca.label[1] = pa.text(N, ib), Ca.label[1].data("groupId", Za)) : Ca.label[1] && Ca.label[1].hide() && Ca.label[1].attr({
                            "text-bound": []
                        }), N = {
                            text: $a.displayValue,
                            x: Da + ua / 2,
                            ...
                            fill: na.color,
                            "text-bound": [na.backgroundColor, na.borderColor, na.borderThickness, na.borderPadding, na.borderRadius, na.borderDash]
                        })) : Ca.label[2] = pa.text(N, ib), Ca.label[2].data("groupId", Za)) : Ca.label[2] && Ca.label[2].hide() && Ca.label[2].attr({
                            "text-bound": []
                        }), wb && Cb(), Fa ? (jb.tooltip(Ga), rb.tooltip(Ga), kb.tooltip(Ga), Oa.tooltip(Ga), zb.tooltip(Ga), fb.tooltip(Ga), tb.tooltip(Ga), gb.tooltip(Ga),
                        vb.tooltip(Ga)) : (jb.tooltip(!1), rb.tooltip(!1), kb.tooltip(!1), Oa.tooltip(!1), zb.tooltip(!1), fb.tooltip(!1), tb.tooltip(!1), gb.tooltip(!1), vb.tooltip(!1)), Da += ua / 2, u.components.mean.components.data[R].config.xPos = Da, u.components.sd.components.data[R].config.xPos = Da, u.components.qd.components.data[R].config.xPos = Da, u.components.md.components.data[R].config.xPos = Da, ic = 0; ic < z.maxNumberOfOutliers; ic++)
                            u.components.outliers[ic].components.data[R].config.xPos = Da;
                u.flag = !0;
                yc && u.remove()
            },
            remove: function() {
                var a =
                    ...
                    n;
                for (m = 0; m < c; m++)
                    if (f = b[0], b.splice(0, 1), f && f.graphics) {
                        h = f.graphics;
                        for (g in h)
                            if ("label" !== g)
                                h[g].shadow({
                                ...
                                for (l = h[g].length, n = 0; n < l; n++)
                                    h[g][n] && (h[g][n].shadow({
                                        opacity: 0
                                    }), h[g][n].hide(), h[g][n].attr({
                                        "text-bound": []
                                    }));
            ...
            removeData: function(a, d, b) {
                var c = this.components,
                    ...
                    l = c.qd.components.removeDataArr || (c.qd.components.removeDataArr = []),
                    n = this.config,
                    r = this.groupManager,
                    v =
                    this.maxminFlag;
                ...
                g = c.outliers.length;
                for (f = 0; f < g; f++)
                    h = c.outliers[f].components.removeDataArr ||
                ...
                for (f = 0; f < g; f++)
                    if (e[f]) {
                        a = e[f].config;
                        if (a.setValue === n.maxValue || a.setValue === n.minValue)
                            v = this.maxminFlag = !0;
                        if (v)
                            break
                    }
            ...
            _addLegendSubDS: function(a) {
                var d;
                d = a.config;
                var b = a.chart.components.legend,
                    c = d.anchorBgColor;
                d = {
            ...
            _addLegendOutliers: function(a) {
                var d = this.JSONData,
                    ...
                    e = this.config,
                    g = e.upperBoxColor,
                    h = this.chart.components.legend,
                    m = b(d.outliericoncolor, c.outliericoncolor, E),
                    d = {
            ...
            legendInteractivityOutliers: function(a, d) {
                ...
                for (h = 0; h < a.length; h++)
                    m = a[h].visible, a[h].visible = m ? !1 : !0, a[h].draw(), m ? (a.visible = !1, f.legendItemSymbol && f.legendItemSymbol.attr({
                        fill: e,
                        stroke: e
                    }), f.legendItemText && f.legendItemText.attr({
                        fill: e
                    }), f.legendIconLine && f.legendIconLine.attr({
                        stroke: e
                    })) : (f.legendItemSymbol && f.legendItemSymbol.attr({
                        fill: g,
                        stroke: c
                    }), f.legendItemText && f.legendItemText.attr({
                        fill: b
            ...
            legendInteractivity: function(a, d) {
                ...
                c ? a.hide() : a.show();
                if (c)
                    for (e.legendItemSymbol && e.legendItemSymbol.attr({
                        fill: g,
                        stroke: g
                    }), e.legendItemText && e.legendItemText.attr({
                        fill: g
                    }), e.legendItemLine && e.legendItemLine.attr({
                        stroke: g
                    }), c = l + 1; c <= l + n; c++) {
                        if (e = (f = this.components.items[c]) && f.graphics)
                            e.legendItemSymbol && e.legendItemSymbol.attr({
                                fill: g,
                                stroke: g
                            }), e.legendItemText && e.legendItemText.attr({
                                fill: g
                    ...
                    for (e.legendItemSymbol && e.legendItemSymbol.attr({
                        ...
                        if (e = (f = this.components.items[c]) && f.graphics)
                            f = f.config, h = b.color, m = f.fillColor, f = f.strokeColor, e.legendItemSymbol && e.legendItemSymbol.attr({
                                fill: m,
                                stroke: f
                            }), e.legendItemText && e.legendItemText.attr({
                                fill: h
            ...
            show: function() {
                var a = this.graphics.upperBoxContainer,
                    d = this.graphics.lowerBoxContainer,
                    b = this.graphics.medianContainer,
                    c = this.graphics.upperWhiskerContainer,
                    f = this.graphics.lowerWhiskerContainer,
                    e = this.graphics.dataLabelContainer,
                    g = this.graphics.shadowContainer,
                    h = this.chart,
                    m = this.yAxis;
                h._chartAnimation();
                this.visible = !0;
                ...
                e.show();
                g.show();
                for (a = 0; a < this.config.maxNumberOfOutliers; a++)
                    this.components.outliers[a].show();
                h._setAxisLimits();
                m.draw();
                h._drawDataset();
            ...
            hide: function() {
                ...
                for (c = 0; c < b; c++)
                    this.components.outliers[c].hide();
                a._setAxisLimits();
                d.draw();
                a._drawDataset();
                ...
                for (c = 0; c < b; c++)
                    this.components.outliers[c].visible =
        ...
        J.register("component", ["dataset", "subDS", {
            ...
            legendInteractivity: function(a, c) {
                ...
                e = {
                    ...
                    legendItemLine: {
                        stroke: e ? S : J.lineAttr && J.lineAttr.stroke
                    }
                };
                for (B in W)
                    (J = W[B]) && e[B] && J.attr(e[B])
            }
        },
        "Line"])
    }]);
    J.register("module", ["private", "modules.renderer.js-dataset-heatmap", function() {
        var a = this.hcLib,
            ...
            L = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")",
            c = a.TOUCH_THRESHOLD_PIXELS,
            w = a.CLICK_THRESHOLD_PIXELS,
            U = Math,
            g = U.round,
            y = U.min,
            P = U.max,
        ...
        J.register("component", ["dataset", "HeatMap", {
            ...
            configure: function() {
                var c = this.chart,
                    ...
                    I = f(u.dashed, B.plotborderdashed),
                    U = f(B.useplotgradientcolor, 1),
                    Z = f(B.showtooltip, 1),
                    M = a.parseUnsafeString,
                    R = M(B.yaxisname),
                    S = M(B.xaxisname),
                    W = M(b(B.tooltipsepchar, ": ")),
                    J = a.parseTooltext,
                    X,
                    ga,
                    ba,
                    ...
                    za,
                    Ga = r.colorrange || {},
                    Ma = c.components.xAxis[0],
                    ra = c.components.yAxis[0],
                    Ba,
                    Ua,
                    Ja = p.mapByPercent =
                    f(Ga.mapbypercent, 0),
                    ja = p.mapByCategory = f(B.mapbycategory, 0),
                    xb = c.jsonData,
                    eb = xb.colorrange && f(xb.colorrange.gradient),
                    Qb = a.nonGradientColorRange,
                    Db,
                    Kb,
                    pb,
                    hb,
                    ...
                    $a,
                    Pb = a.getDashStyle,
                    yb = this.components.data,
                    nb = this.components.plotGrid = [],
                    Sa = c.components.numberFormatter,
                    Wa,
                    ob,
                    Jb = c.isBar,
                    cb = c.is3D,
                    ...
                    vb,
                    Tb,
                    Zb = r.rows.row.length,
                    dc = r.columns.column.length,
                    Ub;
                for (fb = 0; fb < Zb; fb++)
                    for (nb.push([]), tb = 0; tb < dc; tb++)
                        nb[fb].push([]);
                ...
                p.animation = Gb ? {
                    duration: 1E3 * f(B.animationduration, 1)
                } :
                !1;
                ...
                p.brLabelStyle = {
                    fontFamily: b(B.brfont, gb),
                    fontSize: f(B.brfontsize, ub) + "px",
                    color: T(b(B.brfontcolor,
                    vb), 100),
                    fontWeight: H,
                    fontStyle: H
                };
                ...
                for (Oa = 0; Oa < C; Oa++)
                    Y = w && w[Oa], za = (xa = yb[Oa]) && xa.config, xa || (xa = yb[Oa] = {
                        graphics: {}
                    }), xa.config || (za = yb[Oa].config = {}), za.showValue = f(Y.showvalue, p.showValues), za.setValue = ua = Sa.getCleanValue(Y.value),
                ...
                if (eb && !ja)
                    t({
                        min: sb,
                        max: Pa
                    }), this.components.colorRange = Ga = m.colorRange;
                else {
                    ...
                    p.colorMap = [];
                    for (Oa = 0; Oa < Ga.colorArr.length; Oa++)
                        p.colorMap[Oa] = {
            ...
            init: function(a) {
                var d =
                    this.chart,
                    c = d.components,
                    b = a.parentyaxis && a.parentyaxis.toLowerCase() === v ? 1 : 0,
                    c = c.yAxis[b];
                if (!a)
                    return !1;
                this.JSONData = a;
            ...
            _addLegend: function() {
                var a = this.components.data,
                    ...
                    b,
                    e,
                    g = this.config.colorMap,
                    l = this.components.colorRange,
                    u,
                    n,
                    v,
                    z;
                ...
                n.emptyItems();
                n = 0;
                for (v = g.length; n < v; n++)
                    z = g[n], u = l.colorArr[n].code, b = N(u, 60).replace(V, m), N(u, 40), c ? (e = N(u, 40), e = {
                        FCcolor: {
                            color: u + "," + u + "," + e,
                            ratio: "0,70,30",
                            angle: 270,
                ...
                for (n = 0; n < a.length; n++)
                    for (c = l.getColorObj(a[n].config.value).code, d = 0; d < g.length; d++)
                        if (g[d].config.code ==
                        c) {
            ...
            legendInteractivity: function(a, d) {
                ...
                b ? (g.legendItemSymbol && g.legendItemSymbol.attr({
                    fill: h,
                    stroke: h
                }), g.legendItemText && g.legendItemText.attr({
                    fill: h
                }), g.legendIconLine && g.legendIconLine.attr({
                    stroke: h
                })) : (g.legendItemSymbol && g.legendItemSymbol.attr({
                    fill: m,
                    stroke: e
                }), g.legendItemText && g.legendItemText.attr({
                    fill: c
            ...
            hide: function(a) {
                var d = this.components.data,
                    c = this.chart.get(e, ba),
                    b = c.animType,
                    f = c.animObj,
                    g = c.dummyObj,
                    c = c.duration,
                    h = this.components.colorRange,
                    m,
                    l,
                    n,
                    r,
                ...
                for (l = d.length; m < l; m++)
                    v = h.getColorObj(d[m].config.value).code, n = d[m].config, r === v && (d[m].graphics.element && d[m].graphics.element.animateWith(g, f, {
                        "fill-opacity": 0,
                        "stroke-width": 0
            ...
            show: function(a) {
                ...
                z = a.config.code;
                r = 0;
                for (v = d.length; r < v; r++)
                    m = d[r].config, l = m.plotFillAlpha / 100, w = n.getColorObj(d[r].config.value).code, z === w && (d[r].graphics.element && d[r].graphics.element.attr({
                        visibility: R
                    }).animateWith(h, g, {
                        "fill-opacity": l,
            ...
            updatePlot: function(a, d) {
                var c = this.config,
                    ...
                    z;
                r = 0;
                for (v = n.length; r < v; r++)
                    m = n[r].config, l = m.plotFillAlpha / 100, z = n[r].config.value, z < a || z > d ? m.visible && (n[r].graphics.element && n[r].graphics.element.animateWith(h, g, {
                        "fill-opacity": 0,
                        "stroke-width": 0
                    }, b, f),
            ...
            _checkPointObj: function(a, d, c, b) {
                var f = this.components.plotGrid,
                    e = this.chart.config,
                    g = e.viewPortConfig,
                    h = g.x,
                    m = g.scaleX,
                    g = e.plotborderthickness,
                    e = e.showplotborder;
                a = f[d] && f[d][a];
                g =
                e ? g : 0;
                ...
                if (a && a.config && a.config.visible && (c = c - (a._xPos - h * m) + d, b = b - a._yPos + d, b = 0 <= c && c <= a._width + g && 0 <= b && b <= a._height + g))
                    return {
                        pointIndex: a._index,
                        hovered: b,
                        pointObj: a
            ...
            _getHoveredPlot: function(a, d) {
                var b = this.chart,
                    c = b.config,
                    f = b.components.xAxis[0],
                    e = b.components.canvas.config,
                    e = Math.max(e.canvasPaddingLeft, e.canvasPadding),
                    g = c.canvasLeft,
            ...
            draw: function() {
                var d = this.config,
                    ...
                    m = this.chart,
                    l = m.getJobList(),
                    r = m.components.paper,
                    v = m.components.xAxis[0],
                    z = m.components.yAxis[0],
                    w =
                ...
                T = 0;
                var Fa = d.showShadow,
                    wa = d.plotBorderThickness,
                    oa = d.plotRadius,
                    qa = this.graphics.container;
                H = this.graphics.dataLabelContainer;
                var la = this.graphics.shadowContainer;
                va = D.datalabelsGroup;
                var ia,
                    D = m.components.legend.config.isActive,
                    ea = this.components.plotGrid,
                    sa,
                    fa,
                    ha,
                    ca = [],
                    Aa = (this.components.removeDataArr || []).length,
                    ya = d.showHoverEffect,
                    Y;
                w && w.enabled && (w.resetLegend(), w.clearListeners());
                w.notifyWhenUpdate(this.updatePlot, this);
                qa || (qa = this.graphics.container = r.group(S, b), qa.attr({
                    "clip-rect": g
                }), h || qa.hide());
                ...
                for (g = 0; g < b; g++)
                    if (J = Q[g], Y = J.trackerConfig = {}, va = J && J.config, f = va.setValue, w && w.enabled && !D && (va.visible = !0), fa = v.getCategoryFromId(c[g].columnid.toLowerCase()), ha = z.getCategoryFromId(c[g].rowid.toLowerCase()), fa.catObj && ha.catObj && va.value !== n)
                        if (d.mapByCategory || null !== f) {
                            ...
                            J.graphics.element && J.graphics.element.hide(), J.graphics.hotElement && J.graphics.hotElement.hide();
            ...
            drawLabel: function() {
                var a = this.chart,
                    d = a.config,
                    c = a.graphics,
                    b = a.components.paper,
                    f = a.linkedItems.smartLabel,
                    g = a.config.dataLabelStyle,
                    h = this.config,
                    m = this.JSONData.data.length,
                    ...
                    E,
                    K,
                    V = this.graphics.dataLabelContainer,
                    L = this.graphics.tlLabelContainer,
                    I = this.graphics.blLabelContainer,
                    U = this.graphics.trLabelContainer,
                    P = this.graphics.brLabelContainer,
                    H,
                    N,
                    Z,
                    T,
                ...
                P.css(T);
                for (z = 0; z < m; z++)
                    if (d = r[z], void 0 !== d && (y = d.graphics))
                        if (y = d && d.config, Z = y.setValue,
                        h.mapByCategory || null !== Z) {
                            if (w = y.displayValue, Z = d.graphics.element)
                                Z = d._width, T = d._height, J = d._xPos, W = d._yPos, f.setStyle(g), ga(w) && w !== Q && y.showValue ? (S = f.getSmartText(w, Z, T, !1), w = S.text, D = W + .5 * T, E = J + .5 * Z, d.graphics.valEle ? (d.graphics.valEle.animateWith(sa, ea, {
                                    x: E,
                                    y: D
                            ...
                            d.graphics.valEle && d.graphics.valEle.hide(),
            ...
            remove: function() {
                var a = this.components,
                    ...
                    m;
                for (m = 0; m < b; m++)
                    if (f = d[0], d.splice(0, 1), f && f.graphics) {
                        h = f.graphics;
                        for (g in h)
                            h[g].stop(), h[g].hide();
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-kagi", function() {
        ...
        J.register("component", ["dataset", "Kagi", {
            ...
            _parseShadowOptions: function() {
                var a = this.config;
                return {
                    opacity: D(this.chart.jsonData.chart.showshadow, 1) ? a.alpha / 100 : 0
                }
            },
            configure: function() {
                var c,
                ...
                for (F = 0; F < v.length; F += 1)
                    v[F].config.__nullCount = h, null === v[F].config.setValue && (e.push(v.splice(F, 1)[0]), h++, --F);
                if (v.length) {
                    ...
                    z.lineDashed = {
                        ...
                        0),
                        "false": D(m.declinedashed, m.linedashed, 0)
                    };
                    ...
                    y = function(a, d) {
                        for (var c, b = 1, f = v[0].config.setValue; b < a;)
                            c = v[b].config.setValue, d ? c <= f && (v[b].config.isDefined = !1) : c >= f && (v[b].config.isDefined = !1), b += 1;
                        v[0].config.vAlign = d ? X : B;
                        v[0].config.align =
                        "center"
                    };
                    A = g.length;
                    for (C = F = 0; C < A; C += 1, F += 1)
                        if (t = g[C], !t || !t.vline)
                            if (e = v[F] && v[F].config, I && (I = !1), e && (e.isDefined = !0), t.tooltext || this.JSONData.plottooltext || m.plottooltext || e && (e.toolText += e.displayValue), F && e) {
                                e.isShift = void 0;
                                x = v[F - 1].config;
                                e.vAlign = "middle";
                                e.align = f;
                                ...
                                if (x && x.isShift)
                                    for (J ? (H = k, S = X) : J || (M = k, S = B), x = F; 1 < x; --x)
                                        if (v[x].y == k) {
                                            v[x].vAlign = S;
                                            v[x].align = "center";
                                            v[x].showLabel = !0;
            ...
            _appendCategory: function(a, c, b, f) {
                var e,
                    l,
                    n,
                    r = this.JSONData.catData;
                if (a < r.length)
                    for (e = a; e < r.length; e += 1, a = e) {
                        l = r[e];
                        n = l.data;
                        l = l.index - (e + 1);
                        if (l < c)
                            n.lineposition = D(n.lineposition, f);
                        else if (l > c)
                            break;
                        b.push(n)
                    }
            ...
            _getHoveredPlot: function(a, c) {
                for (var b = this.chart, f = b.components.xAxis[0], e = this.config, l = e.trackIndex, n = this.components.data, r = b.components.canvas.config, r = a - b.config.canvasLeft - Math.max(r.canvasPaddingLeft, r.canvasPadding),
                    g, b = Math.floor(Math.max(f.getValue(r - e.maxRadius))), f = Math.ceil(Math.min(f.getValue(r + e.maxRadius))); f >= b; f--)
                    for (r = (e = l[f]) && e.length; 0 <= r; r--)
                        if (g = e[r], g = this.isWithinShape(n[g], g, a, c))
                            return g
            },
            draw: function() {
                var b,
                ...
                var w = b.getJobList(),
                    ...
                    Va = !0,
                    Da = q.getAxisPosition(0),
                    Ia = q.getAxisPosition(1) - Da,
                    va = {
                        "clip-rect": [n(0, g.canvasLeft), n(0, g.canvasTop), n(1, g.canvasWidth), n(1, g.canvasHeight)]
                    },
                    Fa = {
                        "clip-rect": [n(0, g.canvasLeft), n(0, g.canvasTop), 1, n(1, g.canvasHeight)]
                    },
                    g = y.rallyThickness,
                    wa = y.declineThickness,
                    oa = {
                        stroke: v({
                            color: y.rallyColor,
                            alpha: y.rallyAlpha
                    ...
                    qa = {
                        stroke: v({
                            color: y.declineColor,
                            alpha: y.declineAlpha
                        }),
                        "stroke-linecap": I,
                        "stroke-linejoin": I,
                        "stroke-width": wa,
                ...
                if (d.length) {
                    ...
                    Q(J, C);
                    if (d[0].config.setValue)
                        Y = d[0].config.plotY;
                    else
                        for (b = 1; b < C; b += 1)
                            if (u = d[b].config.setValue) {
                                Y = d[b].config.plotY;
                                break
                            }
                    ...
                    F(d, function(a, b) {
                        ...
                        Ua++) : (ja && ja.hide(), (p = m.element) ? (p.animateWith(ra, Ba, {
                            polypath: [pa[1] || 2, k, t, Ta.radius, Ta.startAngle, 0]
                        }, Ma, Ja), Va && Ra(), Va = !1) : (p = Ga.element && Ga.element.length ? m.element = Ga.element.shift() : m.element = h.polypath(ta.anchorGroup), p.attr({
                            polypath: [pa[1] || 2, k, t, Ta.radius, Ta.startAngle, 0]
                        })), p.attr({
                            fill: v({
                                color: Ta.bgColor,
                        ...
                        Ta.radius).data("anchorHoverRadius", Qa.anchorRadius).data("hoverEnabled", Qa.enabled).data("eventArgs", R), xc = n(Ta.radius, Qa && Qa.anchorRadius || 0, z) + Ta.borderThickness / 2, f.trackerRadius = xc), Qa.enabled && (fc = {
                            ...
                            fill: v({
                                color: Qa.anchorColor,
                                alpha: Qa.anchorBgAlpha
                            }),
                            stroke: v({
                                color: Qa.anchorBorderColor,
                                alpha: Qa.anchorBorderAlpha
                            }),
                    ...
                    za || (sa || (za = sa = r.rallyElem = h.path(ta.lineGroup)), sa.animateWith(ra, Ba, {
                        path: ia
                    }, Va ? 0 : Ma, Ja).attr(oa).shadow(g && D, ta.lineShadowGroup), fa || (za = fa = r.declineElem = h.path(ta.lineGroup)),
                    fa.animateWith(ra, Ba, {
                        path: ea
                    }, Va ? 0 : Ma, Ja).attr(qa).shadow(wa && D, ta.lineShadowGroup));
                    Ma && Va || (Va = !1);
            ...
            hidingPosition: function() {
                return function(a) {
                    ...
                    return {
                        polypath: (a && a.attr("polypath"))[3] = 0,
                        r: 0,
                        text: R
                    }
                }
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragnode", function() {
        ...
        J.register("component", ["datasetGroup", "Dragnode", {
            ...
            addConnectors: function(a, c) {
                ...
                a.groupManager = this;
                b || (this.connectorSet[c] = {
                    connectors: a
                })
            },
            showNodeAddUI: function() {
                var a = this.chart,
                    c = a.components.dataset,
                    b = B,
                    e,
                    m,
                    l;
                for (l = 0; l < c.length; l++)
                    m = c[l] || {}, e = m.config, m = m.plotType, "dragnode" === m && (b += '<option value="' + e.id + '">' + (e.name !== I && void 0 !== e.name && e.name + Q + " " || I) +
                    e.id + "</option>");
                this.showNodeUpdateUI(a, {
                    dataset: {
                        innerHTML: b
                    }
                })
            ...
            showConnectorAddUI: function() {
                var a = this.chart,
                    ...
                    m;
                for (m in c)
                    e = c[m], e = e.config, e = e.id, b += '<option value="' + e + '">' + e + "</option>";
                this.showConnectorUpdateUI(a, {
                    fromid: {
                        innerHTML: b
                    },
                    toid: {
            ...
            draw: function() {
                ...
                for (l = a.length; b < l; b++)
                    e = a[b].dataset, e.draw();
                b = 0;
                for (l = c.length; b < l; b++)
                    a = c[b].connectors, a.draw();
                b = 0;
                for (l =
                m.length; b < l; b++)
                    c = m[b].labels, c.draw();
            ...
            getJSONData: function() {
                ...
                for (l = a.length; m < l; m++)
                    n = a[m] && a[m].dataset, e.dataset[m] || (e.dataset[m] = R({}, n.JSONData)), e.dataset[m].data = n.getJSONData();
                m = 0;
                for (l = b.length; m < l; m++)
                    n = b[m] && b[m].connectors, e.connectors[m] || (e.connectors[m] = R({}, n.JSONData)), e.connectors[m].connector = n.getJSONData();
                m = 0;
                for (l = c.length; m < l; m++)
                    n = c[m] && c[m].labels,
                    e.labels[m] || (e.labels[m] = {
                        label: []
                    }), e.labels[m].label = n.getJSONData();
                return e
            },
            ...
            createHtmlDialog: function(a, b, c, l, m, n, v) {
                var A = a.components.paper,
                    w = a.config.style.inCanvasStyle || {},
                    B = a.config.width,
                    g = a.config.height,
                    y = a.get(W, S).transposeAnimDuration,
                    E = {
                        color: D(w.color),
                        textAlign: "center",
                        paddingTop: "1px",
                ...
                C.veil ? y ? C.veil.animate({
                    width: B,
                    height: g
                }, y, "normal") : C.veil.attr({
                    width: B,
                    height: g
                }) : C.veil = A.html("div", {
                    fill: ba,
            ...
            updateUIvisuals: function() {
                var a = this.graphics.cacheConnectorUpdateUI,
                    b = this.chart,
                    c = this.graphics.cacheLabelUpdateUI,
                    e = this.graphics.cacheLabelDeleteUI,
                    m = this.graphics.cacheUpdateUI;
            ...
            showConnectorUpdateUI: function(a, b, c) {
                var e = a.components.paper,
                    m = this.cacheConnectorUpdateUI,
                    l = {
                        border: "1px solid #cccccc",
                        fontSize: "10px",
                        lineHeight: "15px",
                ...
                m ? (m.attr({
                    ...
                    }, b.from ? b.to ? b.from != b.to ? (c ? a.editConnector(b) : a.addConnector(b), m.enableFields(), m.hide(), m.clearFields()) : (m.error.attr({
                        text: "Connector cannot start and end at the same node!"
                    }), d.fromid.focus()) : (m.error.attr({
                        text: "Please select a valid connector end."
                    }), d.toid.focus()) : (m.error.attr({
                ...
                (m.enableFields = function() {
                    for (var a in b)
                        b[a] && b[a].disabled && r[a] && r[a].element.removeAttribute("disabled")
                });
                m.clearFields || (m.clearFields = function() {
                    var a,
                        b = m.fields;
                    for (a in b)
                        b[a].element.disabled || (b[a].element.value = B)
                });
                v(this.connectorUpdateUIDefinition, function(a) {
                    var c = a.key,
                        v = b[c] || {};
                    w[c] || (w[c] = e.html("label", {
                        x: a.x,
                        y: a.y,
                    ...
                    if (!a.noInput) {
                        if (!(g = r[c])) {
                            g = r[c] = e.html(a.inputType || "input", {
                                ...
                                x: a.labelWidth && a.labelWidth +
                                5 || 50,
                                width: a.inputWidth || 50,
                                name: c || B
                            }, l);
                            if ("select" !== a.inputType)
                                g.attr({
                                    type: a.type || "text"
                                }).on("keyup", m.handleKeyPress);
                            g.add(w[c])
                        }
                        (A = X(v.innerHTML, a.innerHTML)) && g.attr({
                            innerHTML: A
                        });
            ...
            showLabelUpdateUI: function(a, b) {
                var c = a.components.paper,
                    e = this.graphics.cacheLabelUpdateUI,
                    m = {
                        border: "1px solid #cccccc",
                        fontSize: "10px",
                        lineHeight: "15px",
                ...
                e || (e = this.graphics.cacheLabelUpdateUI = this.createHtmlDialog(a, 315, 205, function() {
                    ...
                    }, c.text ? (a.addLabel && a.addLabel(c), e.hide()) : (e.error.attr({
            ...
            showLabelDeleteUI: function(a) {
                var b = this.chart,
                    c = b.get(W, S).duration,
                    e = b.components.paper,
            ...
            showNodeUpdateUI: function() {
                var c = function() {
                        for (var a = this.graphics.cacheUpdateUI, b = a.fields.shape, c = ["rectWidth", "rectHeight", "circPolyRadius", "polySides"], e = c.length, f; e--;)
                            f = c[e], /rect|poly|circ/ig.test(f) && (a.labels[f].hide(), a.fields[f].hide()), (new RegExp(X(b.val(), "rect"), "ig")).test(f) && (a.labels[f].show(), a.fields[f].show())
                    },
                    e = function() {
                        var a = this.graphics.cacheUpdateUI.fields,
                            c = b(a.color.val());
                        c && a.colorOut.css({
                            background: n(c)
                        })
                    ...
                    l = function(b, c) {
                        var e = this.graphics.cacheUpdateUI,
                            f = b.config.height,
                            l = e.fields.image.val(),
                            n = c ? 300 : 0,
                            r = ["imgWidth", "imgHeight", "imgAlign", "imgUrl"],
                            g,
                            v,
                            z;
                        g = l ? 250 : 215;
                        ...
                        e.error.hide();
                        for (v = r.length; !l && v--;)
                            z = r[v], e.labels[z].hide(), e.fields[z].hide();
                        a.danimate.animate(e.dialog.element, {
                            top: (f - g) / 2,
                            height: g
                        }, n, "linear", function() {
                            for (v = r.length; v-- && l;)
                                z = r[v], e.labels[z].show(), e.fields[z].show();
                            e.ok.attr({
                                y: g - 23 - 5
                            }).show();
                            e.cancel.attr({
                ...
                return function(a, b, n) {
                        ...
                        g = function() {
                            ...
                            if (a) {
                                ...
                                if (f && void 0 === b)
                                    ...
                                    a = e.datasetId;
                                    if (a !== B || b)
                                        b ? c.updateNode(e) : c.addNode(e), w.hide(), w.visible = !1;
                                    return
                                }
                            }
                            w.enableFields()
                    ...
                    w.enableFields || (w.enableFields = function() {
                        for (var a in b)
                            b[a] && b[a].disabled && H[a] && H[a].element.removeAttribute("disabled")
                    });
                    ...
                    v(this.nodeUpdateUIDefinition, function(g) {
                        ...
                        if (!g.noInput) {
                            ...
                            if (!k) {
                                ...
                                if ("select" !== g.inputType)
                                    k.attr({
                                        type: g.type || "text"
                                    }).on("keyup", w.handleKeyPress);
                                k.add(J[n])
                            }
            ...
            getDataLimits: function() {
                var a = this.datasets,
                    ...
                    r;
                for (b = 0; b < a.length; b++)
                    r = a[b].dataset.config, e = C(e, r.yMax), c = l(c, r.yMin), m = C(m, r.xMax), n = l(n, r.xMin);
                return {
                    max: e,
                    min: c,
                    xMax: m,
    ...
    function() {
        ...
        J.register("component", ["datasetGroup", "DragColumn", {
            getJSONData: function() {
                var a = this.chart,
                    E = a.components.dataset,
                    a = a.jsonData && a.jsonData.dataset,
                    J = [],
                    S,
                    I,
                    B,
                    X = E.length;
                for (B = 0; B < X; B++)
                    S = E[B], I = c({}, a[B]), delete I.data, S = S.getJSONData(), J.push(c(I, S));
                return J
            },
            _decidePlotableData: function(a, c, J, S) {
                var I = this.stackSumValue && this.stackSumValue[0],
                    B,
                    X,
                    M,
                    R;
                ...
                for (A = X = B = M = 0; M < v && J; M += c, B++, X++) {
                    ...
                    n = b = void 0;
                    for (R = M + c; R >= M + 1; R--)
                        D = a[R].config, r = I && I[R] || D.setValue, F && delete a[R].dragged, a[R].dragged || (D.labelSkip = !0, D.isSkipped = !0), 0 <= r ? (n || (n = r, 0 === l && delete D.labelSkip, H = R, delete D.isSkipped), n < r && (n = r, H = R, delete D.isSkipped)) : (b || (b = r, 0 === l && delete D.labelSkip, Q = R, delete D.isSkipped), b > r && (b = r, Q = R, delete D.isSkipped));
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragarea", function() {
        var a = this.hcLib.extend2,
            c = Math.ceil;
        J.register("component", ["datasetGroup", "DragArea", {
            getJSONData: function() {
                var c = this.chart,
                    e = c.components.dataset,
                    c = c.jsonData && c.jsonData.dataset,
                    J = [],
                    W,
                    S,
                    I,
                    B = e.length;
                for (I = 0; I < B; I++)
                    W = e[I], S = a({}, c[I]), delete S.data, W = W.getJSONData(), J.push(a(S, W));
                return J
            },
            _decidePlotableData: function(a, e, J) {
                var W = this.chart.config,
                    S = W.isDataRestored,
                    I,
                    B,
                    X,
                    ...
                    l,
                    C,
                    H = c(1 / W.binSize * W.labelBinSize);
                for (l = I = W = B = 0; B < F && J; B += e, W++, I++) {
                    C = l % H;
                    l++;
                    r = D = v = A = void 0;
                    for (X = B + e; X >= B + 1; X--)
                        R = a[X].config, M = R.setValue, S && delete a[X].dragged, a[X].dragged || (R.labelSkip = !0, R.isSkipped = !0), v ? v < M && (r = X, v = M) : (r = X, v = M), A ? A > M && (D = X, A = M) : (D = X, A = M);
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-boxandwhisker2d", function() {
        ...
        J.register("component", ["datasetGroup", "boxandwhisker2d", {
            draw: function() {
                ...
                var M = M.datalabelsGroup,
                    R = S.get(E, e),
                    r = R.animType,
                    D = R.animObj,
                    v = R.dummyObj,
                    R = R.duration;
                S.fireInitialAnimation && (I.attr({
                    "clip-rect": X
                }), M.attr({
                    "clip-rect": X
                }));
                ...
                for (S = 0; S < J; S++)
                    for (I = a[S], B = I.length, this.manageClip = !0, I = 0; I < B; I++)
                        X = a[S][I].dataSet, X.draw()
            }
        }, a.column])
    }]);
    J.register("module",
